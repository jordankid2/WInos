...
public:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontNormal, m_xtpFontNormal, GetNormalFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontBold, m_xtpFontBold, GetBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontUnderline, m_xtpFontUnderline, GetUnderlineFontHandle);
...
protected:
	int  m_nItemsBorderHeight;       // Height in pixels of the horizontal border between PropertyGridItems.
...
//     class.  This represents a Office XP style theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPPropertyGridVisualStudio2015Theme : public CXTPPropertyGridVisualStudio2010Theme
{
public:
