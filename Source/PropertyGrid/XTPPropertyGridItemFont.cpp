...
CRect CXTPPropertyGridItemFont::GetValueRect()
{
	...
	if (m_clrValue != (COLORREF)-1) rcValue.left += XTP_DPI_X(25);
	return rcValue;
}
...
BEGIN_INTERFACE_MAP(CXTPPropertyGridItemFont, CXTPPropertyGridItem)
	INTERFACE_PART(CXTPPropertyGridItemFont, XTPDIID_IPropertyGridItemFont, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPPropertyGridItemFont, XTPDIID_IPropertyGridItemFont)
