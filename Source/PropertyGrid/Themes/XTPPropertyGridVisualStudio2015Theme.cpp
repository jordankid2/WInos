// XTPPropertyGridVisualStudio2015Theme.cpp : implementation of the CXTPPropertyGridVisualStudio2015Theme class.
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPPropertyGridVisualStudio2015Theme

CXTPPropertyGridVisualStudio2015Theme::CXTPPropertyGridVisualStudio2015Theme(CXTPPropertyGrid* pGrid)
...
void CXTPPropertyGridVisualStudio2015Theme::RefreshMetrics()
{
	CXTPPropertyGridPaintManager::RefreshMetrics();

	// Default colors found in VISUALSTUDIO2015BLUE_INI.
	...
	m_clrHighlight               .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("BackHighlight"), RGB( 51, 153, 255)));
	...
	m_pMetrics->m_clrFore        .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("Text"),          RGB(  0,   0, 0)));
	// color for description pane text.
	m_pMetrics->m_clrHelpFore    .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("TextHelp"),      RGB(  0,   0, 0)));
	// Color ot text in Verb pane
	m_pMetrics->m_clrVerbFace    .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("TextVerb"),      RGB(  0,   0, 0)));
	// color of the text groups.
	m_pMetrics->m_clrCategoryFore.SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("TextCategory"),  RGB(  0,   0, 0)));
	// color of the text of the disabled items.
	m_pMetrics->m_clrReadOnlyFore.SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("TextReadOnly"),  RGB(109, 109, 109)));
	...
	m_pMetrics->m_clrLine        .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("Grid"),          RGB(238, 238, 242)));
	...
	m_clrCategorySeparator       .SetStandardValue(XTPIniColor(_T("PropertyGrid"), _T("Separator"),     RGB(238, 238, 242)));
	...
	{
		SetControlsTheme(xtpControlThemeVisualStudio2015);
	}
#endif
}
