...
BEGIN_INTERFACE_MAP(CXTPPropertyGridItemDouble, CXTPPropertyGridItem)
	INTERFACE_PART(CXTPPropertyGridItemDouble, XTPDIID_IPropertyGridItemDouble, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPPropertyGridItemDouble, XTPDIID_IPropertyGridItemDouble)
