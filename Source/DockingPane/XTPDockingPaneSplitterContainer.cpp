...
CXTPDockingPaneSplitterWnd::CXTPDockingPaneSplitterWnd()
{
	...
	m_pManager = 0;
	m_bHoriz = FALSE;
	m_iDirection = xtpPaneDockUndefined;
}
...
void CXTPDockingPaneSplitterWnd::Create(CXTPDockingPaneSplitterContainer* pContainer, CXTPDockingPaneBase* pFirst, CXTPDockingPaneBase* pSecond)
{
	...
	if (pFirst->GetType() != xtpPaneTypeClient)
	{
		m_iDirection = m_pManager->GetPaneDirection(pFirst);
	}
	else if (pSecond->GetType() != xtpPaneTypeClient)
	{
		m_iDirection = m_pManager->GetPaneDirection(pSecond);
	}
...
CXTPDockingPaneBase* CXTPDockingPaneSplitterWnd::GetPaneBase(BOOL bFirst /*=TRUE*/)
{
	if (bFirst)
	{
		return m_pFirst;
...
BEGIN_DISPATCH_MAP(CXTPDockingPaneSplitterContainer, CXTPCmdTarget)
	DISP_FUNCTION_ID(CXTPDockingPaneSplitterContainer, "Count", 1, OleGetItemCount, VT_I4, VTS_NONE)
	DISP_FUNCTION_ID(CXTPDockingPaneSplitterContainer, "Pane", DISPID_VALUE, OleGetPane, VT_DISPATCH, VTS_I4)
	DISP_FUNCTION_ID(CXTPDockingPaneSplitterContainer, "_NewEnum", DISPID_NEWENUM, OleNewEnum, VT_UNKNOWN, VTS_NONE)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneSplitterContainer, "ParentContainer", 20, OleGetContainer, SetNotSupported, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneSplitterContainer, "Type", 21, OleGetType, SetNotSupported, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneSplitterContainer, "hWnd", DISPID_HWND, OleGetHwnd, SetNotSupported, VT_HANDLE)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneSplitterContainer, "IsEmpty", 22, OleIsEmpty, SetNotSupported, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneSplitterContainer, "Position", 23, OleGetPosition, SetNotSupported, VT_I4)
END_DISPATCH_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneSplitterContainer, XTPDIID_IPaneContainer)

BEGIN_INTERFACE_MAP(CXTPDockingPaneSplitterContainer, CXTPCmdTarget)
	INTERFACE_PART(CXTPDockingPaneSplitterContainer, XTPDIID_IPaneContainer, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_ENUM_VARIANT(CXTPDockingPaneSplitterContainer);

LPDISPATCH CXTPDockingPaneSplitterContainer::OleGetContainer()
{
	return m_pParentContainer ? m_pParentContainer->OleGetDispatch(TRUE) : NULL;
}

int CXTPDockingPaneSplitterContainer::OleGetPosition()
{
	return GetDockingPaneManager()->GetPaneDirection(this);
}

int CXTPDockingPaneSplitterContainer::OleGetType()
{
	return m_type;
}

BOOL CXTPDockingPaneSplitterContainer::OleIsEmpty()
{
	return IsEmpty();
}

int CXTPDockingPaneSplitterContainer::OleGetItemCount()
{
	return static_cast<int>(m_lstPanes.GetCount());
}

LPDISPATCH CXTPDockingPaneSplitterContainer::OleGetPane(int nIndex)
{
	return OleGetItem(nIndex - 1);
}

HWND CXTPDockingPaneSplitterContainer::OleGetHwnd()
{
	return 0;
}

LPDISPATCH CXTPDockingPaneSplitterContainer::OleGetItem(int nIndex)
{
...
LPDISPATCH CXTPDockingPaneSplitterContainer::OleGetDispatch(BOOL bAddRef)
{
