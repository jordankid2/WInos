...
BEGIN_DISPATCH_MAP(CXTPDockingPaneClientContainer, CXTPCmdTarget)
...
IMPLEMENT_OLETYPELIB_EX(CXTPDockingPaneClientContainer, XTPDIID_IPaneContainer)

BEGIN_INTERFACE_MAP(CXTPDockingPaneClientContainer, CXTPCmdTarget)
	INTERFACE_PART(CXTPDockingPaneClientContainer, XTPDIID_IPaneContainer, Dispatch)
END_INTERFACE_MAP()
