...
void CXTPDockingPaneManager::SetTheme(XTPDockingPanePaintTheme paintTheme)
{
	...
	case xtpPaneThemeVisualStudio2012:      m_pPaintManager = new CXTPDockingPaneVisualStudio2012Theme(); break;
	case xtpPaneThemeVisualStudio2015:      m_pPaintManager = new CXTPDockingPaneVisualStudio2015Theme(); break;
	// Visio
...
BOOL CXTPDockingPaneManager::OnWndMsg(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
	...
	if (message == WM_SYSCOMMAND && ((wParam & 0xFFF0) == SC_NEXTWINDOW || (wParam & 0xFFF0) == SC_PREVWINDOW))
	{
