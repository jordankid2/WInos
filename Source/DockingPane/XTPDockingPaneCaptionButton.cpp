...
void AFX_CDECL CXTPDockingPaneCaptionButton::DrawPinnButton(CDC* pDC, CPoint pt, 
	BOOL bPinned, COLORREF clr /*= COLORREF_NULL*/)
{
	...
	DrawPinnButton(pDC, rc, bPinned, clr);
}

void AFX_CDECL CXTPDockingPaneCaptionButton::DrawPinnButton(CDC* pDC, CRect rc, 
	BOOL bPinned, COLORREF clr /*= COLORREF_NULL*/)
{
	clr = NormalizeButtonColor(pDC, clr);
	XTPPrimitiveDrawer()->DrawSymbol(pDC, bPinned
		? xtpPrimitiveSymbolPinLeft : xtpPrimitiveSymbolPinDown,
		rc, clr);
}

void AFX_CDECL CXTPDockingPaneCaptionButton::DrawMaximizeRestoreButton(CDC* pDC, CPoint pt, 
	BOOL bMaximize, COLORREF clr /*= COLORREF_NULL*/)
{
	clr = NormalizeButtonColor(pDC, clr);
...
void AFX_CDECL CXTPDockingPaneCaptionButton::DrawMaximizeRestoreButton(CDC* pDC, CRect rc, 
	BOOL bMaximize, COLORREF clr /*= COLORREF_NULL*/)
{
	clr = NormalizeButtonColor(pDC, clr);
	XTPPrimitiveDrawer()->DrawSymbol(pDC, bMaximize
		? xtpPrimitiveSymbolMaximize : xtpPrimitiveSymbolRestore,
		rc, clr);
}

void AFX_CDECL CXTPDockingPaneCaptionButton::DrawCloseButton(CDC* pDC, 
	CRect rc, COLORREF clr /*= COLORREF_NULL*/)
{
	clr = NormalizeButtonColor(pDC, clr);
	XTPPrimitiveDrawer()->DrawSymbol(pDC, xtpPrimitiveSymbolClose, rc, clr);
}

void AFX_CDECL CXTPDockingPaneCaptionButton::DrawMenuButton(CDC* pDC, 
	CRect rc, COLORREF clr /*= COLORREF_NULL*/)
{
	clr = NormalizeButtonColor(pDC, clr);
