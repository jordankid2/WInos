// XTPDockingPaneTabColorSet2013.cpp
//
...
CXTPDockingPaneTabColorSet2013::CXTPDockingPaneTabColorSet2013()
	: CXTPTabPaintManagerColorSet()
{
}

void CXTPDockingPaneTabColorSet2013::RefreshMetrics()
{
...
COLORREF CXTPDockingPaneTabColorSet2013::GetItemColor(CXTPTabManagerItem *pItem)
{
	if (!pItem)
	{
		ASSERT(0);
...
void CXTPDockingPaneTabColorSet2013::FillHeader(CDC* pDC, CRect rc, CXTPTabManager* pTabManager)
{
