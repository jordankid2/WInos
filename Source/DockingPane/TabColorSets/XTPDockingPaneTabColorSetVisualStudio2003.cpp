...
void CXTPDockingPaneTabColorSetVisualStudio2003::FillFramePartRect(CDC* pDC, CRect rc, CWnd* pWnd, CWnd* pSite)
{
...
{
	FillFramePartRect(pDC, rc, (CXTPDockingPaneTabbedContainer*)pTabManager, ((CXTPDockingPaneTabbedContainer*)pTabManager)->GetDockingSite());
}
