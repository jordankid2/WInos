...
void CXTPDockingPaneTabTheme2013::RefreshMetrics()
{
	...
	m_rcHeaderMargin = XTP_DPI(XTPIniRect(_T("DockingPane.Tabs"), _T("HeaderMargin"), CRect(0,0,0,0)));
}
...
void CXTPDockingPaneTabTheme2013::DrawSingleButton(CDC *pDC, CXTPTabManagerItem *pItem)
{
	...
	switch (pItem->GetTabManager()->GetPosition())
	{
		case xtpTabPositionTop:
			if (pItem->IsSelected())
			{
				pDC->FillSolidRect(rcItem.left - XTP_DPI_X(1),
					rcItem.top,
					XTP_DPI_X(1),
					rcItem.Height(),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.right - XTP_DPI_X(1),
					rcItem.top,
					XTP_DPI_X(1),
					rcItem.Height(),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.left - XTP_DPI_X(1),
					...
					rcItem.Width(),
					XTP_DPI_Y(2),
					pColorSet->m_clrTextSelected);
			}
			else
			{
				pDC->FillSolidRect(rcItem.left,
					rcItem.bottom - XTP_DPI_Y(1),
					rcItem.Width(),
					XTP_DPI_Y(1),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.right - XTP_DPI_X(1),
					rcItem.top + XTP_DPI_Y(3),
					XTP_DPI_X(1),
					rcItem.Height() - XTP_DPI_Y(8),
					pColorSet->m_clrButtonBorder);
			}
			break;
		...
		case xtpTabPositionLeft:
			...
			{
				pDC->FillSolidRect(rcItem.right - XTP_DPI_Y(1),
					rcItem.top,
					XTP_DPI_Y(1),
					rcItem.Height(),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.left + XTP_DPI_X(5),
					rcItem.bottom - XTP_DPI_Y(1),
					rcItem.Width() - XTP_DPI_X(8),
					XTP_DPI_Y(1),
					pColorSet->m_clrButtonBorder);
			}
			break;
		case xtpTabPositionRight:
			if (pItem->IsSelected())
			{
				...
				pDC->FillSolidRect(rcItem.left,
					...
					XTP_DPI_Y(1),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.right - XTP_DPI_X(2),
					rcItem.top - XTP_DPI_Y(1),
					XTP_DPI_X(2),
					rcItem.Height(),
					pColorSet->m_clrTextSelected);
			...
			{
				pDC->FillSolidRect(rcItem.left + XTP_DPI_Y(1),
					rcItem.top,
					XTP_DPI_X(1),
					rcItem.Height(),
					pColorSet->m_clrButtonBorder);
				pDC->FillSolidRect(rcItem.left + XTP_DPI_Y(5),
					rcItem.bottom - XTP_DPI_X(1),
					rcItem.Width() - XTP_DPI_Y(8),
					XTP_DPI_X(1),
					pColorSet->m_clrButtonBorder);
			}
			break;
