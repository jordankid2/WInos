...
#if !defined(__XTPDOCKINGPANETABTHEME2015_H__)
#define __XTPDOCKINGPANETABTHEME2015_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
class _XTP_EXT_CLASS CXTPDockingPaneTabTheme2015 : public CXTPDockingPaneTabTheme2012
{
public:
    //-----------------------------------------------------------------------
    // Summary: Default class constructor.
    //-----------------------------------------------------------------------
	CXTPDockingPaneTabTheme2015();
...
#endif // !defined(__XTPDOCKINGPANETABTHEME2015_H__)
