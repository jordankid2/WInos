...
_XTP_EXT_CLASS void AFX_CDECL XTPDeflateRectDirection(CRect& rc, int left, int top, int right, int bottom, BOOL bVertical);

_XTP_EXT_CLASS int AFX_CDECL XTPGetRectDirectionHeight(const CRect& rc, BOOL bVertical);

_XTP_EXT_CLASS void AFX_CDECL XTPFillFramePartRect(CDC* pDC, CRect rc, CWnd* pWnd, CWnd* pParentFrame, const CXTPPaintManagerColorGradient& clrHeaderFace, BOOL bHoriz);
...
protected:
	...
	//-----------------------------------------------------------------------
	virtual void DrawCaptionButtonEntry(CDC* pDC, CXTPDockingPaneCaptionButton* pButton, COLORREF clrButton, CSize szOffset);
	virtual void DrawCaptionButtonEntry(CDC* pDC, CXTPDockingPaneCaptionButton* pButton, CPoint pt, COLORREF clrButton); // <combine DrawCaptionButtonEntry@CDC*@CXTPDockingPaneCaptionButton*@COLORREF>
...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntTitleVertical, m_xtpFontTitleVertical, GetVerticalTitleFontHandle);
