// XTPDockingPaneThemeOffice2007.cpp : implementation of the CXTPDockingPaneOffice2007Theme class.
//
...
CXTPDockingPaneOffice2007Theme::CXTPDockingPaneOffice2007Theme()
{
	...
	m_pPanelPaintManager->m_rcButtonMargin.SetRect(XTP_DPI_X(2), XTP_DPI_Y(1), XTP_DPI_X(2), XTP_DPI_Y(1));
	m_pTabPaintManager->m_rcButtonMargin.SetRect(XTP_DPI_X(2), XTP_DPI_Y(1), XTP_DPI_X(2), XTP_DPI_Y(1));
