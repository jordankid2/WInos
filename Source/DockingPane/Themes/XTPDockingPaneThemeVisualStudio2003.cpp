// XTPDockingPaneThemeVisualStudio2003.cpp : implementation of the CXTPDockingPaneVisualStudio2003Theme class.
//
...
void CXTPDockingPaneVisualStudio2003Theme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
	...
	DrawCaptionButtons(pDC, pPane->GetCaptionButtons(), rcCaption, clrButton, m_nCaptionButtonSize, XTP_DPI_X(2), bVertical);
