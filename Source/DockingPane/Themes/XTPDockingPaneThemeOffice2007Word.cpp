// XTPDockingPaneThemeOffice2007Word.cpp : implementation of the CXTPDockingPaneOffice2007WordTheme class.
//
...
void CXTPDockingPaneOffice2007WordTheme::DrawCaptionPart(CDC* pDC, CXTPDockingPaneBase* pPane, CRect rcCaption, const CString& strTitle, BOOL bActive, BOOL bVertical)
{
	...
	DrawCaptionButtons(pDC, pPane->GetCaptionButtons(), rcCaption, clrText, XTP_DPI_X(16), 0, bVertical);
...
void CXTPDockingPaneOffice2007WordTheme::DrawPane(CDC* pDC, CXTPDockingPaneTabbedContainer* pPane, CRect rc)
{
	...
	else
	{
		if (PaneHasBorders(pPane))
		{
			...
			pDC->FillSolidRect(rc.left + XTP_DPI_X(3), rc.top + XTP_DPI_Y(2), rc.Width() - XTP_DPI_X(6), XTP_DPI_Y(1), m_arrColor[XPCOLOR_TOOLBAR_GRIPPER]);
			pDC->FillSolidRect(rc.left + XTP_DPI_X(2), rc.top + XTP_DPI_Y(3), XTP_DPI_X(1), rc.Height() - XTP_DPI_Y(5), m_arrColor[XPCOLOR_TOOLBAR_GRIPPER]);
			pDC->FillSolidRect(rc.right - XTP_DPI_X(3), rc.top + XTP_DPI_Y(3), XTP_DPI_X(1), rc.Height() - XTP_DPI_Y(5), m_arrColor[XPCOLOR_TOOLBAR_GRIPPER]);
			pDC->FillSolidRect(rc.left + XTP_DPI_X(2), rc.bottom - XTP_DPI_Y(3), rc.Width() - XTP_DPI_X(4), XTP_DPI_Y(1), m_arrColor[XPCOLOR_TOOLBAR_GRIPPER]);
