...
//{{AFX_CODEJOCK_PRIVATE
#define xtpPaneThemeOffice          xtpPaneThemeVisualStudio2003 // obsolete names, for backward compatibility only.
...
//{{AFX_CODEJOCK_PRIVATE
#define xtpPaneStickerStyleWhidbey xtpPaneStickerStyleVisualStudio2005Beta // obsolete name, for backward compatibility only.
//}}AFX_CODEJOCK_PRIVATE
