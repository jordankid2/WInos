...
{
	CXTPFlowGraphNode* pNodeFrom = DYNAMIC_DOWNCAST(CXTPFlowGraphNode, 
		CXTPFlowGraphNode::FromIDispatchSafe(lpDispFrom));
	CXTPFlowGraphNode* pNodeTo = DYNAMIC_DOWNCAST(CXTPFlowGraphNode, 
		CXTPFlowGraphNode::FromIDispatchSafe(lpDispTo));
