...
void CXTPFlowGraphSelectionRect::Draw(CXTPFlowGraphDrawContext* pDC, const CRect &rc)
{
	...
	{
		// draw rectangles
		pDC->FillSolidRect(smallRects[i].left, smallRects[i].top, 1, smallRects[i].Height(), COLOR_1);
		pDC->FillSolidRect(smallRects[i].left + 1, smallRects[i].top, smallRects[i].Width() - 2, 1, COLOR_1);
			
		pDC->FillSolidRect(smallRects[i].right - 1, smallRects[i].top, 1, smallRects[i].Height(), COLOR_2);
		pDC->FillSolidRect(smallRects[i].left + 1, smallRects[i].bottom - 1, smallRects[i].Width() - 2, 1, COLOR_2);

		pDC->FillSolidRect(smallRects[i].left + 1, smallRects[i].top + 1, 1, smallRects[i].Height() - 2, COLOR_3);
		pDC->FillSolidRect(smallRects[i].left + 2, smallRects[i].top + 1, smallRects[i].Width() - 3, 1, COLOR_3);
			
		pDC->FillSolidRect(smallRects[i].left + 2, smallRects[i].top + 2, smallRects[i].Width() - 3 , smallRects[i].Height() - 3, COLOR_4);
...
SelectionRectHitTest AFX_CDECL CXTPFlowGraphSelectionRect::HitTest(const CRect &rc, const CPoint &point)
{
	CRect smallRects[8];
	GetSizingRects(rc, smallRects);
...
void AFX_CDECL CXTPFlowGraphSelectionRect::ResizeRect(CRect &rcRect, CSize szMinSize, CPoint ptOffset, SelectionRectHitTest hitPoint)
{
	switch (hitPoint)
	{
