...
BEGIN_DISPATCH_MAP(CXTPFlowGraphUndoManager, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPFlowGraphUndoManager, CXTPCmdTarget)
	INTERFACE_PART(CXTPFlowGraphUndoManager, XTPDIID_FlowGraphUndoManager, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPFlowGraphUndoManager, XTPDIID_FlowGraphUndoManager)
