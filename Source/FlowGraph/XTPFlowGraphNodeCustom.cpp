...
BEGIN_INTERFACE_MAP(CXTPFlowGraphNodeCustom, CXTPFlowGraphNode)
	INTERFACE_PART(CXTPFlowGraphNodeCustom, XTPDIID_FlowGraphNodeCustom, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPFlowGraphNodeCustom, XTPDIID_FlowGraphNodeCustom)
