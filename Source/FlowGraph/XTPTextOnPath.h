...
protected:
	...
	static CCArray<Gdiplus::PointF> AFX_CDECL CleanPoints(CCArray<Gdiplus::PointF> points);
	static double AFX_CDECL GetAngle(Gdiplus::PointF point1, Gdiplus::PointF point2);
