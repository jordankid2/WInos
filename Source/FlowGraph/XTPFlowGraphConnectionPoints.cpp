...
BEGIN_DISPATCH_MAP(CXTPFlowGraphConnectionPoints, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPFlowGraphConnectionPoints, CXTPCmdTarget)
	INTERFACE_PART(CXTPFlowGraphConnectionPoints, XTPDIID_FlowGraphConnectionPoints, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPFlowGraphConnectionPoints, XTPDIID_FlowGraphConnectionPoints)
