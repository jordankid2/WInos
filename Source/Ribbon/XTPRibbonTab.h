...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get Customize dialog specific tab text
	// Returns:
	//     Customize dialog specific tab text
	// See Also: GetCaption, SetCaption
	//-----------------------------------------------------------------------
	CString GetCustomizeCaption() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set Customize dialog specific tab text
	// Parameters:
	...
	//     Call this method to set Customize dialog specific tab text
	// Parameters:
	//     nCustomizeCaption - new text to be set resource ID
	// See Also: GetCaption, SetCaption
	//-----------------------------------------------------------------------
...
protected:
	...
	CString m_strCustomizeCaption;                  // Caption used by Customize dialog. If empty, a default caption is displayed.
