...
BEGIN_DISPATCH_MAP(CXTPRibbonGroups, CXTPCmdTarget)
	DISP_FUNCTION_ID(CXTPRibbonGroups, "InsertGroup", 100, OleInsertGroup, VT_DISPATCH, VTS_I4 VTS_BSTR VTS_I4)
	DISP_PROPERTY_EX_ID(CXTPRibbonGroups, "GroupCount", 101, OleGetItemCount, SetNotSupported, VT_I4)
	...
	DISP_PROPERTY_EX_ID(CXTPRibbonGroups, "RibbonTab", 105, OleGetRibbonTab, SetNotSupported, VT_DISPATCH)
END_DISPATCH_MAP()
