...
BEGIN_DISPATCH_MAP(CXTPRibbonTab, CXTPTabManagerItem)
	DISP_PROPERTY_EX_ID(CXTPRibbonTab, "RibbonBar", 100, OleGetRibbonBar, SetNotSupported, VT_DISPATCH)
	...
	DISP_FUNCTION_ID(CXTPRibbonTab, "GetRect", 110, OleGetRect, VT_EMPTY, VTS_PI4 VTS_PI4 VTS_PI4 VTS_PI4)
