	...
	: CXTPMarkupStaticExtension(L"Theme")
{
	...
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedHighlightedDarkBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedHighlightedDarkBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedHighlightedLightBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedHighlightedLightBrush"), RGB(243, 243, 243))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedFocusedDarkBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedFocusedDarkBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedFocusedLightBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedFocusedLightBrush"), RGB(243, 243, 243))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedDarkBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedDarkBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabSelectedLightBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabSelectedLightBrush"), RGB(243, 243, 243))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"TabNormalBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("TabNormalBrush"), RGB(255, 0, 0))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupRectBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupRectBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupToolbarBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupToolbarBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupSelectedBorderBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupSelectedBorderBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupSelectedBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupSelectedBackBrush"), RGB(243, 243, 243))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupPopupedBorderBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupPopupedBorderBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupPopupedBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupPopupedBackBrush"), RGB(243, 243, 243))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupPopupNormalBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupPopupNormalBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupNormalBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupNormalBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"GroupHighlightedBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("GroupHighlightedBrush"), RGB(171, 171, 171))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuSelectedBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuSelectedBackBrush"), RGB(42, 138, 212))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuSelectedTextBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuSelectedTextBrush"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuPopupedBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuPopupedBackBrush"), RGB(42, 141, 212))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuPopupedTextBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuPopupedTextBrush"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuNormalBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuNormalBackBrush"), RGB(51, 51, 51))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameSystemMenuNormalTextBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameSystemMenuNormalTextBrush"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameContextHeaderBackBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameContextHeaderBackBrush"), RGB(230, 243, 230))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameContextHeaderBorderBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameContextHeaderBorderBrush"), RGB(73, 163, 73))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameContextHeaderTextBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Xaml"), _T("FrameContextHeaderTextBrush"), RGB(73, 163, 73))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameCaptionInactiveBackBrush",
		XTPIniColor(_T("CommandBars.Frame"), _T("InactiveCaptionColor"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameCaptionActiveBackBrush",
		XTPIniColor(_T("CommandBars.Frame"), _T("ActiveCaptionColor"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameCaptionBackstageLeftBrush",
		XTPIniColor(_T("CommandBars.Ribbon.Backstage"), _T("ButtonBackNormal"), RGB(255, 255, 255))));
	pColors->Extend(new CXTPMarkupStaticExtensionBrushProperty(L"FrameCaptionBackstageRightBrush",
	...
	, m_nBackImage(XTPNone)
{
	...
	if (m_pMarkupContext)
	{
		...
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.TabSelectedHighlightedDarkBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.TabSelectedHighlightedLightBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.TabSelectedFocusedDarkBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.TabSelectedFocusedLightBrush"));
		...
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.GroupPopupSelectedBorderBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.GroupPopupSelectedBackBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.GroupPopupPopupedBorderBrush"));
		...
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuSelectedBackBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuSelectedTextBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuPopupedBackBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuPopupedTextBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuNormalBackBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameSystemMenuNormalTextBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameContextHeaderBackBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameContextHeaderBorderBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameContextHeaderTextBrush"));
		ASSERT(NULL != pThemeStaticExtension->FindExtension(L"Colors.FrameCaptionInactiveBackBrush"));
...
{
	CString strBuffer;
	strBuffer.Format(_T("%i %i %i"), GetRValue(clr), GetGValue(clr), GetBValue(clr));
	return strBuffer;
}
...
void CXTPRibbonOffice2013Theme::RefreshMetrics()
{
    ...
    m_clrRibbonBorder                = XTPIniColor(_T("CommandBars.Ribbon"), _T("RibbonBorder"),                RGB(171, 171, 171));
    m_clrRibbonInactiveFace          = XTPIniColor(_T("CommandBars.Ribbon"), _T("RibbonInactiveFace"),          RGB(222, 222, 222));
	m_clrRibbonInactiveFaceState     = XTPIniColor(_T("CommandBars.Ribbon"), _T("RibbonInactiveFaceState"),     RGB(222, 222, 222));
    m_clrMinimizedFrameEdgeShadow    = XTPIniColor(_T("CommandBars.Ribbon"), _T("MinimizedFrameEdgeShadow"),    RGB(243, 243, 243));
    m_clrMinimizedFrameEdgeHighLight = XTPIniColor(_T("CommandBars.Ribbon"), _T("MinimizedFrameEdgeHighLight"), RGB(243, 243, 243));
    m_clrControlGroupOption          = XTPIniColor(_T("CommandBars.Ribbon"), _T("ControlGroupOption"),          RGB(119, 119, 119));
    m_clrGroupCaption                = XTPIniColor(_T("CommandBars.Ribbon"), _T("GroupCaption"),                RGB(119, 119, 119));
	m_clrTabBackInactiveState        = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabBackInactiveState"),        RGB(255, 255, 255));
	m_clrQuickAccessBelow			 = XTPIniColor(_T("CommandBars.Toolbar"), _T("ButtonText"),					RGB(38, 38, 38));
	m_clrQuickAccess				 = XTPIniColor(_T("CommandBars.Frame"), _T("ActiveFontColor"),				RGB(38, 38, 38));
	m_clrQuickAccessDisabled		 = XTPIniColor(_T("CommandBars.Frame"), _T("InactiveFontColor"),			RGB(38, 38, 38));
	m_clrQuickAccessButtonHotBack = XTPIniColor(_T("CommandBars.Frame"), _T("CaptionButtonHotBackgroundColor"), RGB(255, 255, 255));
	m_clrQuickAccessButtonPressedBack = XTPIniColor(_T("CommandBars.Frame"), _T("CaptionButtonPressedBackgroundColor"), RGB(255, 255, 255));
	m_clrTabBackackstageLeft = XTPIniColor(_T("CommandBars.Ribbon.Backstage"), _T("ButtonBackNormal"), RGB(255, 255, 255));
	m_clrTabBackackstageRight = XTPIniColor(_T("CommandBars.Ribbon.Backstage"), _T("PageBackground"), RGB(255, 255, 255));
	m_clrBackstageSysButtonBack2013Normal = XTPIniColor(_T("CommandBars.Ribbon.Backstage"), _T("ButtonBackNormal"), RGB(255, 255, 255));
	m_clrBackstageSysButtonBack2013Highlighted = XTPIniColor(_T("CommandBars.Ribbon.Backstage"), _T("ButtonBackHighlighted"), RGB(255, 255, 255));
	m_strHighlightedPrefix = XTPIniString(_T("CommandBars.Ribbon.Backstage"), _T("ButtonImagePrefixHighlighted"), _T(""));
	m_strNormalPrefix = XTPIniString(_T("CommandBars.Ribbon.Backstage"), _T("ButtonImagePrefixNormal"), _T(""));

	CXTPTabPaintManagerColorSet* pColorSet = m_pTabPaintManager->GetColorSet();
	if (pColorSet)
	{
		pColorSet->m_clrButtonNormal      = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabBackInactive"),    RGB(255, 255, 255));
		pColorSet->m_clrButtonHighlighted = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabBackHighlighted"), RGB(255, 255, 255));
		pColorSet->m_clrTextNormal        = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabTextInactive"),    RGB( 38,  38,  38));
		pColorSet->m_clrTextHighlight     = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabTextHighlighted"), RGB(  0, 114, 198));
		pColorSet->m_clrTextSelected      = XTPIniColor(_T("CommandBars.Ribbon"), _T("TabTextSelected"),    RGB(  0, 114, 198));
	}

    m_clrHeader[0].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorNoneBorder"),   RGB(243, 243, 243));
    m_clrHeader[0].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorNoneBack"),     RGB(243, 243, 243));
    m_clrHeader[0].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorNoneText"),     RGB(102, 102, 102));
    m_clrHeader[1].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorBlueBorder"),   RGB( 43,  87, 154));
    m_clrHeader[1].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorBlueBack"),     RGB(213, 225, 242));
    m_clrHeader[1].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorBlueText"),     RGB( 62, 109, 181));
    m_clrHeader[2].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorYellowBorder"), RGB(242, 203,  29));
    m_clrHeader[2].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorYellowBack"),   RGB(255, 251, 230));
    m_clrHeader[2].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorYellowText"),   RGB(152, 119,  21));
    m_clrHeader[3].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorGreenBorder"),  RGB( 73, 163,  73));
    m_clrHeader[3].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorGreenBack"),    RGB(230, 243, 230));
    m_clrHeader[3].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorGreenText"),    RGB( 73, 138,  73));
    m_clrHeader[4].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorRedBorder"),    RGB(226, 101, 102));
    m_clrHeader[4].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorRedBack"),      RGB(248, 212, 212));
    m_clrHeader[4].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorRedText"),      RGB(202,  90,  92));
    m_clrHeader[5].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorPurpleBorder"), RGB(201,  89, 156));
    m_clrHeader[5].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorPurpleBack"),   RGB(252, 240, 247));
    m_clrHeader[5].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorPurpleText"),   RGB(161,  64, 122));
    m_clrHeader[6].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorCyanBorder"),   RGB(153, 200, 233));
    m_clrHeader[6].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorCyanBack"),     RGB(205, 230, 247));
    m_clrHeader[6].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorCyanText"),     RGB(  1,  89, 138));
    m_clrHeader[7].clrEdge = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorOrangeBorder"), RGB(255, 157,   0));
    m_clrHeader[7].clrBack = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorOrangeBack"),   RGB(255, 248, 237));
    m_clrHeader[7].clrText = XTPIniColor(_T("CommandBars.Ribbon.TabContext"), _T("ColorOrangeText"),   RGB(207,  92,  10));

	// If System button is popped up the text color of inactive (normal) button is used as the color of text for selected button
	// Let's find out will such text be visible. If it's not we'll set the appropriate flag.
...
void CXTPRibbonOffice2013Theme::DrawRibbonTab(CDC *pDC, CXTPRibbonTab *pItem)
{
	...
	else
	{
		...
		if (pRibbon->IsActive())
		{
			...
			{			
				pDC->FillSolidRect(r, XTP_SAFE_GET2(
					m_pTabPaintManager, GetColorSet(), m_clrButtonHighlighted, tabColor));
			}
			else
			{
				pDC->FillSolidRect(r, XTP_SAFE_GET2(
					m_pTabPaintManager, GetColorSet(), m_clrButtonNormal, tabColor));
			}
		}
		else
		{
...
void CXTPRibbonOffice2013Theme::DrawRibbonFrameContextHeaders(CDC *pDC, CXTPRibbonBar *pRibbonBar, CXTPRibbonTabContextHeaders *pContextHeaders)
{
	...
	for (int i = 0; i < nCount; i++)
	{
		...
		if (LAYOUT_RTL == pDC->GetLayout())
		{
			...
			rcHeader.left = rcClient.Width() - (ptWindowTopLeft.x - ptHeaderTopLeft.x) - nWidth - XTP_DPI_X(1);
		...
		else
		{
			...
			pDC->FillSolidRect(rcBorder, m_clrHeader[color].clrEdge);
			pDC->FillSolidRect(rcBackground, m_clrHeader[color].clrBack);
			pDC->SetTextColor(m_clrHeader[color].clrText);
...
void CXTPRibbonOffice2013Theme::FillRibbonBar(CDC *pDC, CXTPRibbonBar *pRibbonBar)
{
	...
	CRect rcTabs(rcClient.left, rcClient.top, rcClient.right, rcClient.top + m_nTabsHeight + XTP_DPI_Y(1));
	if (m_pPaintManager->IsCaptionbarInBackstageMode())
	{
		CRect rc(rcTabs);
		rc.bottom = XTP_DPI_Y(m_pPaintManager->GetBackstageSysButtonBottom());
		rc.right = m_pPaintManager->GetBackstageModeMenuWidth();
		pDC->FillSolidRect(rc, m_clrTabBackackstageLeft);
		rc.left = m_pPaintManager->GetBackstageModeMenuWidth();
	...
	{
		m_pPaintManager->HorizontalLine(pDC, rcClient.left, rcClient.bottom - XTP_DPI_Y(2), rcClient.right, m_clrMinimizedFrameEdgeShadow);
		m_pPaintManager->HorizontalLine(pDC, rcClient.left, rcClient.bottom - XTP_DPI_Y(1), rcClient.right, m_clrMinimizedFrameEdgeHighLight);
	}
}
...
void CXTPRibbonOffice2013Theme::DrawBackImage(CDC *pDC, CXTPRibbonBar *pRibbonBar)
{
	...
	if (pImage)
	{
		...
		float fCoef = float(rcClient.Height()) / float(rcSource.Height());	//for proportional image streching
		CRect rcImage(rcClient.right - int(rcSource.Width() * fCoef), rcClient.top, rcClient.right, rcClient.bottom);

		pImage->DrawImage(pDC, rcImage, rcSource);
	}
}
void CXTPRibbonOffice2013Theme::DrawRibbonFrameCaptionBar(CDC *pDC, CXTPRibbonBar *pRibbonBar, BOOL bActive)
{
	ASSERT_VALID(pDC);
	ASSERT_VALID(pRibbonBar);

	if (!pRibbonBar->IsDwmEnabled() && m_pPaintManager->IsCaptionbarInBackstageMode())
	{
...
void CXTPRibbonOffice2013Theme::DrawRibbonFrameCaption(CDC *pDC, CXTPRibbonBar *pRibbonBar, BOOL bActive)
{
	CRect rcCaption = pRibbonBar->GetCaptionRect();
	...
	if ((pContextHeaders->GetCount() != 0) && (!m_pPaintManager->IsCaptionbarInBackstageMode()))
	{
...
void CXTPRibbonOffice2013Theme::DrawRibbonFrameSystemButton(CDC *pDC, CXTPRibbonControlSystemButton *pControl, CRect rc)
{
	ASSERT_VALID(pDC);
	ASSERT_VALID(pControl);
