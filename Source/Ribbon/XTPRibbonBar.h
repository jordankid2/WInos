...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to give chance the backstage view to process the keyboard input if it is active
	// Parameters:
...
protected:
	...
	virtual void MergeToolBar(CXTPCommandBar* pCommandBar, BOOL bSilent, int nDefaultConfirmationChoice);
