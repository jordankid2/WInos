...
void CXTPRibbonBackstagePaintManager::DrawKeyboardTip(CDC *pDC, CXTPPaintManager *pPaintManager, CXTPControl *pControl)
{
	ASSERT(pDC);
	...
	pDC->SetTextColor(GetXtremeColor(pControl->GetEnabled() ? COLOR_INFOTEXT : COLOR_GRAYTEXT));
