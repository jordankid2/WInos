...
void CXTPRibbonBackstagePageRecent::SetTheme(XTPControlTheme nTheme)
{
	...
	if (m_wndList.GetPaintManager())
	{
		...
		case xtpControlThemeVisualStudio2012Light:	paintTheme = xtpThemeVisualStudio2012Light; break;
		case xtpControlThemeVisualStudio2012Dark:	paintTheme = xtpThemeVisualStudio2012Dark; break;
