...
CXTPRibbonBackstageViewThemeOffice2013::CXTPRibbonBackstageViewThemeOffice2013()
{
	...
	m_clrButtonBackNormal		= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonBackNormal"),		RGB( 43,  87, 154));
	m_clrButtonBackSelected		= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonBackSelected"),		RGB( 62, 109, 181));
	m_clrButtonBackHighlighted	= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonBackHighlighted"),	RGB( 25,  71, 138));
	m_clrButtonTextNormal		= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonTextNormal"),		RGB(255, 255, 255));
	m_clrButtonTextDisabled		= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonTextDisabled"),		RGB( 62, 109, 181));
	m_clrButtonTextSelected		= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonTextSelected"),		RGB(255, 255, 255));
	m_clrButtonTextHighlighted	= XTPIniColor(_T("CommandBars.Ribbon.Backstage"),_T("ButtonTextHighlighted"),	RGB(255, 255, 255));
}
...
void CXTPRibbonBackstageViewThemeOffice2013::DrawControl(CDC *pDC, CXTPRibbonBackstageView *pView, CXTPControl *pControl)
{
	...
	if (pView->GetBackstageStyle() > xtpRibbonBackstageOffice2010Style)
		...
		rcText.DeflateRect(GetMenuItemTextGap() + GetMenuItemCommandGapX(), XTP_DPI_Y(2), XTP_DPI_X(2), XTP_DPI_Y(2));
