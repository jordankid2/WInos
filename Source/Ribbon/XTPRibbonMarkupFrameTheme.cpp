...
void CXTPRibbonMarkupFrameTheme::DrawFrame(CDC *pDC, CXTPCommandBarsFrameHook *pFrameHook)
{
	...
	case xtpThemeOffice2013:
		{
			if (strCompat != _T("Office2013")) return;
			break;
		}
	...
	case xtpThemeVisualStudio2012Dark:
		{
			if (strCompat != _T("VisualStudio2012")) return;
			break;
		}
	case xtpThemeVisualStudio2015:
		{
			if (strCompat != _T("VisualStudio2015")) return;
			break;
		}
	}
	...
	else
	{
		...
		CRgn rgnCaption;
		rgnCaption.CreateRectRgn(rcCaption.left, rcCaption.top,
