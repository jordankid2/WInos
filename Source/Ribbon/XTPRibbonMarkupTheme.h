...
protected:
	...
	COLORREF m_clrBackstageSysButtonBack2013Normal; // The color of "back" button in backstage if the button is not selected
	COLORREF m_clrBackstageSysButtonBack2013Highlighted; // The color of "back" button in backstage if the button is selected

	CString m_strHighlightedPrefix; // The prfix of file name for backstage "back" button image using for selected button
	CString m_strNormalPrefix; // The prfix of file name for backstage "back" button image using for not selected button
