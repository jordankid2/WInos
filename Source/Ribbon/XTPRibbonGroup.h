...
enum XTPRibbonGroupReductionLevels
{
	...
	xtpRibbonGroupReduceCaptionDontHide = 3, // Hide captions but don't allow hiding all when reduced
...
public:
	...
	// Parameters:
	//     nAllowReduceLevel - Reduce Level to allow. One of XTPRibbonGroupReductionLevels constants.
