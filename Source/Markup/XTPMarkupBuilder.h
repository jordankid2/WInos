...
public:
	...
	CXTPMarkupObject* CreateObject(LPCWSTR lpszTag, XTPXML::IXMLDOMElement* pElement, CXTPMarkupObject* pParent = NULL);
...
public:
	...
	static CXTPMarkupObject* AFX_CDECL ConvertTextDecorations(
		CXTPMarkupBuilder* pBuilder,
		CXTPMarkupObject* pObject,
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertFontWeight(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertFontStyle(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertLength(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertVerticalAlignment(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertHorizontalAlignment(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertTextWrapping(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertTextTrimming(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertTextAlignment(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertOrientation(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertBaselineAlignment(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertCursor(
		CXTPMarkupBuilder* pBuilder,
		CXTPMarkupObject* pObject,
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertVisibility(
		CXTPMarkupBuilder* pBuilder,
		CXTPMarkupObject* pObject,
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertFontQuality(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertContent(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertScrollBarVisibility(
		CXTPMarkupBuilder* pBuilder, 
		CXTPMarkupObject* pObject, 
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
	static CXTPMarkupObject* AFX_CDECL ConvertStretch(
		CXTPMarkupBuilder* pBuilder,
		CXTPMarkupObject* pObject,
		CXTPMarkupDependencyProperty* pAssociatedProperty = NULL);
...
public:
	...
	static BOOL AFX_CDECL ConvertDouble(LPCWSTR& lpszValue, double& dValue, TCHAR cStop = 0, BOOL bCheckTail = TRUE);


private:
	BOOL NeedPreserveXmlNodeWhitespaces(XTPXML::IXMLDOMNode* pNode) const;
	void LoadMarkupObjectTextContent(CXTPMarkupObject* pObject, XTPXML::IXMLDOMNode* pContent, BOOL bPreformatted);
