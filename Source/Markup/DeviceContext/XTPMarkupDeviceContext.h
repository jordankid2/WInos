...
public:
	...
	virtual XTPMarkupSmoothingMode SetSmoothingMode(XTPMarkupSmoothingMode smoothingMode, BOOL bUseTextSmoothing);
	...
	virtual CXTPMarkupDeviceDependentImage* CreateDeviceDependentImage(
