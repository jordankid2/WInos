...
void CXTPMarkupUIElement::RegisterMarkupClass()
{
	...
	m_pRenderTransformProperty = CXTPMarkupDependencyProperty::Register(L"RenderTransform",
		MARKUP_TYPE(CXTPMarkupRenderTransform), MARKUP_TYPE(CXTPMarkupUIElement));
}
...
CXTPMarkupVisual::TransformationMatrices CXTPMarkupUIElement::ApplyRenderTransform(
	CXTPMarkupDrawingContext* pContext)
{
...
BEGIN_DISPATCH_MAP(CXTPMarkupUIElement, CXTPMarkupVisual)
	...
	DISP_PROPERTY_EX_ID(CXTPMarkupUIElement, "Focusable", 302, OleGetFocusable, OleSetFocusable, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPMarkupUIElement, "IsEnabled", 303, OleGetIsEnabled, OleSetIsEnabled, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPMarkupUIElement, "RenderTransform", 304, OleGetRenderTransform, SetNotSupported, VT_DISPATCH)
END_DISPATCH_MAP()
