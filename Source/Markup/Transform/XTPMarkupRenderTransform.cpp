...
void CXTPMarkupRenderTransform::RegisterMarkupClass()
{
	...
	m_pPropertyScaleTransform = CXTPMarkupDependencyProperty::Register(L"ScaleTransform",
		MARKUP_TYPE(CXTPMarkupScaleTransform), MARKUP_TYPE(CXTPMarkupRenderTransform));

	m_pPropertyTranslateTransform = CXTPMarkupDependencyProperty::Register(L"TranslateTransform",
		MARKUP_TYPE(CXTPMarkupTranslateTransform), MARKUP_TYPE(CXTPMarkupRenderTransform));

	m_pPropertySkewTransform = CXTPMarkupDependencyProperty::Register(L"SkewTransform",
		MARKUP_TYPE(CXTPMarkupSkewTransform), MARKUP_TYPE(CXTPMarkupRenderTransform));
}

void CXTPMarkupRenderTransform::SetContentObject(
...
void CXTPMarkupRenderTransform::OnSetAsProperty(
