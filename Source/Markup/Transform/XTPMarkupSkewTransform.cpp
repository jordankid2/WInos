...
{
	m_pPropertyAngleX = CXTPMarkupDependencyProperty::Register(L"AngleX",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupSkewTransform));

	m_pPropertyAngleY = CXTPMarkupDependencyProperty::Register(L"AngleY",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupSkewTransform));
...
CXTPMarkupTransformationMatrix* CXTPMarkupSkewTransform::ApplyTransform(
