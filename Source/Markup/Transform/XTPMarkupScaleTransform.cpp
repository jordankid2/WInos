...
{
	m_pPropertyScaleX = CXTPMarkupDependencyProperty::Register(L"ScaleX",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupScaleTransform),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagHorzDpiSensible));

	m_pPropertyScaleY = CXTPMarkupDependencyProperty::Register(L"ScaleY",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupScaleTransform),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagVertDpiSensible));

	m_pPropertyCenterX = CXTPMarkupDependencyProperty::Register(L"CenterX",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupScaleTransform),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagHorzDpiSensible));

	m_pPropertyCenterY = CXTPMarkupDependencyProperty::Register(L"CenterY",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupScaleTransform),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagVertDpiSensible));
}
...
CXTPMarkupTransformationMatrix* CXTPMarkupScaleTransform::ApplyTransform(
