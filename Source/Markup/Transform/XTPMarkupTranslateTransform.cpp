...
{
	m_pPropertyX = CXTPMarkupDependencyProperty::Register(L"X",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupTranslateTransform),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagHorzDpiSensible));

	m_pPropertyY = CXTPMarkupDependencyProperty::Register(L"Y",
		MARKUP_TYPE(CXTPMarkupDouble), MARKUP_TYPE(CXTPMarkupTranslateTransform),
...
CXTPMarkupTransformationMatrix* CXTPMarkupTranslateTransform::ApplyTransform(
