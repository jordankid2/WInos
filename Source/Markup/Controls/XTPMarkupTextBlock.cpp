...
void CXTPMarkupTextBlock::RegisterMarkupClass()
{
	...
	m_pPaddingProperty = CXTPMarkupDependencyProperty::Register(L"Padding", MARKUP_TYPE(CXTPMarkupThickness), MARKUP_TYPE(CXTPMarkupTextBlock), 
		new CXTPMarkupPropertyMetadata(CXTPMarkupThickness::CreateValue(), CXTPMarkupPropertyMetadata::flagAffectsMeasure | CXTPMarkupPropertyMetadata::flagHorzDpiSensible | CXTPMarkupPropertyMetadata::flagVertDpiSensible));
...
void CXTPMarkupTextBlock::RenderTextDecorations(CXTPMarkupDrawingContext* pDC, CLinePart* part)
{
	...
	if (*pTextDecorations == 1) // Underline
	{
		int nLineTop = rc.bottom - part->nBaseline + nLineHeight;
		nTopDecoration = nLineTop + ((rc.bottom - nLineTop) % 2);
	}
	else if (*pTextDecorations == 2) // Strikethrough
	{
		nTopDecoration = rc.bottom - part->nBaseline - (part->fontMetrics.nAscent - part->fontMetrics.nDescent - nLineHeight) / 2;
	}

	CRect rcDecoration(rc.left, nTopDecoration, rc.right, nTopDecoration + nLineHeight);
...
BEGIN_DISPATCH_MAP(CXTPMarkupTextBlock, CXTPMarkupFrameworkElement)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "TextWrapping", 500, OleGetTextWrapping, OleSetTextWrapping, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "TextTrimming", 501, OleGetTextTrimming, OleSetTextTrimming, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "TextAlignment", 502, OleGetTextAlignment, OleSetTextAlignment, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "TextDecorations", 503, OleGetTextDecorations, OleSetTextDecorations, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "FontSize", 504, OleGetFontSize, OleSetFontSize, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "FontWeight", 505, OleGetFontWeight, OleSetFontWeight, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "FontFamily", 506, OleGetFontFamily, OleSetFontFamily, VT_BSTR)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "FontStyle", 507, OleGetFontStyle, OleSetFontStyle, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "Padding", 508, OleGetPadding, OleSetPadding, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "FontQuality", 509, OleGetFontQuality, OleSetFontQuality, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "Background", 510, OleGetBackground, OleSetBackground, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "Foreground", 511, OleGetForeground, OleSetForeground, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "Text", 512, OleGetText, OleSetText, VT_VARIANT)
	DISP_PROPERTY_EX_ID(CXTPMarkupTextBlock, "Inlines", 513, OleGetInlines, SetNotSupported, VT_DISPATCH)
END_DISPATCH_MAP()
...
{
	SetValue(m_pPaddingProperty, MARKUP_STATICCAST(CXTPMarkupThickness, FromDispatch(lpPaddingDisp)));
}
