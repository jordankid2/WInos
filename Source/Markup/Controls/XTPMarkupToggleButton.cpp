...
BEGIN_DISPATCH_MAP(CXTPMarkupToggleButton, CXTPMarkupButtonBase)
	DISP_PROPERTY_EX_ID(CXTPMarkupToggleButton, "IsChecked", 800, OleGetIsChecked, OleSetIsChecked, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupToggleButton, "IsThreeState", 801, OleGetIsThreeState, OleSetIsThreeState, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPMarkupToggleButton, "CheckedEvent", 802, OleGetCheckedEvent, SetNotSupported, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupToggleButton, "IndeterminateEvent", 803, OleGetIndeterminateEvent, SetNotSupported, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupToggleButton, "UncheckedEvent", 804, OleGetUncheckedEvent, SetNotSupported, VT_DISPATCH)
END_DISPATCH_MAP()
