...
CXTPMarkupObject* CXTPMarkupDockPanel::ConvertDock(
...
BEGIN_DISPATCH_MAP(CXTPMarkupDockPanel, CXTPMarkupPanel)
	DISP_PROPERTY_EX_ID(CXTPMarkupDockPanel, "LastChildFill", 600, OleGetLastChildFill, OleSetLastChildFill, VT_BOOL)
...
{
	SetDock(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)), (XTPMarkupDock)nValue);
}
