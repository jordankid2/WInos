...
BEGIN_DISPATCH_MAP(CXTPMarkupScrollViewer, CXTPMarkupContentControl)
	DISP_PROPERTY_EX_ID(CXTPMarkupScrollViewer, "VerticalOffset", 700, OleGetVerticalOffset, OleSetVerticalOffset, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupScrollViewer, "HorizontalOffset", 701, OleGetHorizontalOffset, OleSetHorizontalOffset, VT_I4)
END_DISPATCH_MAP()
