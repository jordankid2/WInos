...
void CXTPMarkupWrapPanel::RegisterMarkupClass()
{
	...
	m_pItemHeightProperty = CXTPMarkupDependencyProperty::Register(L"ItemHeight", MARKUP_TYPE(CXTPMarkupInt), MARKUP_TYPE(CXTPMarkupWrapPanel),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagAffectsMeasure | CXTPMarkupPropertyMetadata::flagVertDpiSensible));
	...
	m_pItemWidthProperty = CXTPMarkupDependencyProperty::Register(L"ItemWidth", MARKUP_TYPE(CXTPMarkupInt), MARKUP_TYPE(CXTPMarkupWrapPanel),
		new CXTPMarkupPropertyMetadata(NULL, CXTPMarkupPropertyMetadata::flagAffectsMeasure | CXTPMarkupPropertyMetadata::flagHorzDpiSensible));
}
...
BEGIN_DISPATCH_MAP(CXTPMarkupWrapPanel, CXTPMarkupPanel)
	DISP_PROPERTY_EX_ID(CXTPMarkupWrapPanel, "Orientation", 600, OleGetOrientation, OleSetOrientation, VT_I4)
END_DISPATCH_MAP()
