...
BEGIN_INTERFACE_MAP(CXTPMarkupDefinitionCollection, CXTPMarkupObject)
	INTERFACE_PART(CXTPMarkupDefinitionCollection, XTPDIID_MarkupDefinitionCollection, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupDefinitionCollection, XTPDIID_MarkupDefinitionCollection)
#endif
...
void CXTPMarkupGrid::SetPropertyObject(CXTPMarkupBuilder* pBuilder, CXTPMarkupDependencyProperty* pProperty, CXTPMarkupObject* pValue)
{
	if (pProperty == m_pColumnDefinitionsProperty)
	{
		...
		m_pColumnDefinitions->SetLogicalParent(this);
		MARKUP_ADDREF(m_pColumnDefinitions);
	}
	else if (pProperty == m_pRowDefinitionsProperty)
	{
		...
		m_pRowDefinitions->SetLogicalParent(this);
		MARKUP_ADDREF(m_pRowDefinitions);
	}
	else
	{
...
int AFX_CDECL CXTPMarkupGrid::DistributionOrderComparer(const void *arg1, const void *arg2)
{
...
int AFX_CDECL CXTPMarkupGrid::StarDistributionOrderComparer(const void *arg1, const void *arg2)
{
	CXTPMarkupDefinitionBase* base2 = *((CXTPMarkupDefinitionBase**)arg1);
	CXTPMarkupDefinitionBase* base3 = *((CXTPMarkupDefinitionBase**)arg2);
...
int AFX_CDECL CXTPMarkupGrid::SpanMaxDistributionOrderComparer(const void *arg1, const void *arg2)
{
	CXTPMarkupDefinitionBase* base2 = *((CXTPMarkupDefinitionBase**)arg1);
	CXTPMarkupDefinitionBase* base3 = *((CXTPMarkupDefinitionBase**)arg2);
...
int AFX_CDECL CXTPMarkupGrid::SpanPreferredDistributionOrderComparer(const void *arg1, const void *arg2)
{
	CXTPMarkupDefinitionBase* base2 = *((CXTPMarkupDefinitionBase**)arg1);
	CXTPMarkupDefinitionBase* base3 = *((CXTPMarkupDefinitionBase**)arg2);
...
BEGIN_DISPATCH_MAP(CXTPMarkupGrid, CXTPMarkupPanel)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "SetColumn", 600, OleSetColumn, VT_EMPTY, VTS_DISPATCH VTS_I4)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "SetColumnSpan", 601, OleSetColumnSpan, VT_EMPTY, VTS_DISPATCH VTS_I4)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "SetRow", 602, OleSetRow, VT_EMPTY, VTS_DISPATCH VTS_I4)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "SetRowSpan", 603, OleSetRowSpan, VT_EMPTY, VTS_DISPATCH VTS_I4)

	DISP_FUNCTION_ID(CXTPMarkupGrid, "GetColumn", 604, OleGetColumn, VT_I4, VTS_DISPATCH)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "GetColumnSpan", 605, OleGetColumnSpan, VT_I4, VTS_DISPATCH)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "GetRow", 606, OleGetRow, VT_I4, VTS_DISPATCH)
	DISP_FUNCTION_ID(CXTPMarkupGrid, "GetRowSpan", 607, OleGetRowSpan, VT_I4, VTS_DISPATCH)

	DISP_PROPERTY_EX_ID(CXTPMarkupGrid, "ColumnDefinitions", 608, OleGetColumnDefinitions, SetNotSupported, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupGrid, "RowDefinitions", 609, OleGetRowDefinitions, SetNotSupported, VT_DISPATCH)

END_DISPATCH_MAP()

#ifdef _XTP_ACTIVEX

BEGIN_INTERFACE_MAP(CXTPMarkupGrid, CXTPMarkupPanel)
	INTERFACE_PART(CXTPMarkupGrid, XTPDIID_MarkupGrid, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPMarkupGrid, XTPDIID_MarkupGrid)
#endif

int CXTPMarkupGrid::OleGetRow(LPDISPATCH lpElementDisp)
{
	return GetRow(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)));
}

void CXTPMarkupGrid::OleSetRow(LPDISPATCH lpElementDisp, int nValue)
{
	SetRow(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)), nValue);
}

int CXTPMarkupGrid::OleGetRowSpan(LPDISPATCH lpElementDisp)
{
	return GetRowSpan(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)));
}

void CXTPMarkupGrid::OleSetRowSpan(LPDISPATCH lpElementDisp, int nValue)
{
	SetRowSpan(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)), nValue);
}

int CXTPMarkupGrid::OleGetColumn(LPDISPATCH lpElementDisp)
{
	return GetColumn(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)));
}

void CXTPMarkupGrid::OleSetColumn(LPDISPATCH lpElementDisp, int nValue)
{
	SetColumn(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)), nValue);
}

int CXTPMarkupGrid::OleGetColumnSpan(LPDISPATCH lpElementDisp)
{
	return GetColumnSpan(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)));
}

void CXTPMarkupGrid::OleSetColumnSpan(LPDISPATCH lpElementDisp, int nValue)
{
	SetColumnSpan(MARKUP_STATICCAST(CXTPMarkupUIElement, FromDispatch(lpElementDisp, FALSE)), nValue);
}

LPDISPATCH CXTPMarkupGrid::OleGetColumnDefinitions()
{
	return XTPGetDispatch(m_pColumnDefinitions);
}

LPDISPATCH CXTPMarkupGrid::OleGetRowDefinitions()
{
	return XTPGetDispatch(m_pRowDefinitions);
}
