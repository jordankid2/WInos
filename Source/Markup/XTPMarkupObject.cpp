...
CXTPMarkupDependencyProperty* AFX_CDECL CXTPMarkupDependencyProperty::RegisterCommon(CXTPMarkupDependencyProperty* dp, LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, BOOL bAttached)
{
...
CXTPMarkupDependencyProperty* AFX_CDECL CXTPMarkupDependencyProperty::RegisterAttached(LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, CXTPMarkupPropertyMetadata* pMetadata)
{
...
CXTPMarkupDependencyProperty* AFX_CDECL CXTPMarkupDependencyProperty::Register(LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, CXTPMarkupPropertyMetadata* pMetadata)
{
...
void CXTPMarkupObject::OnSetAsProperty(CXTPMarkupDependencyProperty* pProperty, CXTPMarkupObject* pTargetObject)
{
...
CXTPMarkupExtension* CXTPMarkupObject::GetNextExtension(
	const CXTPMarkupType* pClass /*= NULL*/)
{
...
const CXTPMarkupExtension* CXTPMarkupObject::GetNextExtension(
	const CXTPMarkupType* pClass /*= NULL*/) const
{
...
CXTPMarkupObject* CXTPMarkupInt::ConvertFrom(
	...
	CXTPMarkupObject* pObject) const
{
	...
	if (IsStringObject(pObject))
	{
		...
		{
			if (0 != (m_pAssociatedProperty->GetFlags() & CXTPMarkupPropertyMetadata::flagHorzDpiSensible))
			{
				nValue = pBuilder->GetMarkupContext()->ScaleX(nValue);
			}
			else if (0 != (m_pAssociatedProperty->GetFlags() & CXTPMarkupPropertyMetadata::flagVertDpiSensible))
			{
...
CXTPMarkupObject* CXTPMarkupDouble::ConvertFrom(
	CXTPMarkupBuilder* pBuilder,
	CXTPMarkupObject* pObject) const
{
	ASSERT(NULL != pBuilder);
...
CXTPMarkupObject* CXTPMarkupObject::FromDispatch(LPDISPATCH lpElementDisp, BOOL bAddRef)
{
	...
	CXTPMarkupObject* pObject = DYNAMIC_DOWNCAST(CXTPMarkupObject, CXTPMarkupObject::FromIDispatchSafe(lpElementDisp));
	if (NULL == pObject)
	{
