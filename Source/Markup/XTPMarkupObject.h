...
#define  IMPLEMENT_MARKUPCLASS(class_tag, class_name, base_class_name) \
	...
	CXTPMarkupObject* AFX_CDECL class_name::CreateMarkupObject(CXTPMarkupContext* pContext) \
		{ class_name* obj = new class_name; if(obj) obj->m_pMarkupContext = pContext; return obj; } \
...
protected:
	...
	virtual void OnSetAsProperty(CXTPMarkupDependencyProperty* pProperty, CXTPMarkupObject* pTargetObject);
...
AFX_INLINE void CXTPMarkupObject::SetAssociatedProperty(CXTPMarkupDependencyProperty* pAssociatedProperty) {
...
public:
	static CXTPMarkupDependencyProperty* AFX_CDECL Register(LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, CXTPMarkupPropertyMetadata* pMetadata = NULL);
	static CXTPMarkupDependencyProperty* AFX_CDECL RegisterAttached(LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, CXTPMarkupPropertyMetadata* pMetadata = NULL);
...
protected:
	...
	static CXTPMarkupDependencyProperty* AFX_CDECL RegisterCommon(CXTPMarkupDependencyProperty* dp, LPCWSTR lpszName, CXTPMarkupType* pPropetyType, CXTPMarkupType* pOwnerType, BOOL bAttached);
...
public:
	CXTPMarkupColorKey(int nIndex = 0) : m_nIndex(nIndex)
	{}
