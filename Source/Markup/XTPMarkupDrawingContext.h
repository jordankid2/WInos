...
public:
	CXTPMarkupBrushKey(int nIndex = 0) : m_nIndex(nIndex)
	{}
...
protected:
	CXTPMarkupObject* ConvertFrom(CXTPMarkupBuilder* pBuilder, CXTPMarkupObject* pObject) const;
	static BOOL AFX_CDECL ConvertFromString(CXTPMarkupBuilder* pBuilder, LPCWSTR lpszValue, CPointArray& arr);
...
public:
	...
	XTPMarkupSmoothingMode SetSmoothingMode(XTPMarkupSmoothingMode smoothingMode, BOOL bUseTextSmoothing);

	void SetUseTextSmoothing(BOOL bUseTextSmoothing);
	BOOL GetUseTextSmoothing() const;

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATE("The method is deprecated and will be removed in future versions. Use 'SetUseTextSmoothing' instead.")
	void SetUseTextSmooting(BOOL bUseTextSmoothing);
	_XTP_DEPRECATE("The method is deprecated and will be removed in future versions. Use 'GetUseTextSmoothing' instead.")
