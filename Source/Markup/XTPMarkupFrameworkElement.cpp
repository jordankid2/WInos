...
void CXTPMarkupFrameworkElement::RegisterMarkupClass()
{
	...
	m_pWidthProperty = CXTPMarkupDependencyProperty::Register(L"Width", MARKUP_TYPE(CXTPMarkupInt), MARKUP_TYPE(CXTPMarkupFrameworkElement),
		new CXTPMarkupPropertyMetadata(NULL, &CXTPMarkupBuilder::ConvertLength, CXTPMarkupPropertyMetadata::flagAffectsMeasure | CXTPMarkupPropertyMetadata::flagHorzDpiSensible));
	...
	m_pHeightProperty = CXTPMarkupDependencyProperty::Register(L"Height", MARKUP_TYPE(CXTPMarkupInt), MARKUP_TYPE(CXTPMarkupFrameworkElement),
		new CXTPMarkupPropertyMetadata(NULL, &CXTPMarkupBuilder::ConvertLength, CXTPMarkupPropertyMetadata::flagAffectsMeasure | CXTPMarkupPropertyMetadata::flagVertDpiSensible));
...
BEGIN_DISPATCH_MAP(CXTPMarkupFrameworkElement, CXTPMarkupUIElement)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "MinWidth", 400, OleGetMinWidth, OleSetMinWidth, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "Width", 401, OleGetWidth, OleSetWidth, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "MaxWidth", 402, OleGetMaxWidth, OleSetMaxWidth, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "MinHeight", 403, OleGetMinHeight, OleSetMinHeight, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "Height", 404, OleGetHeight, OleSetHeight, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "MaxHeight", 405, OleGetMaxHeight, OleSetMaxHeight, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "Margin", 406, OleGetMargin, OleSetMargin, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "HorizontalAlignment", 407, OleGetHorizontalAlignment, OleSetHorizontalAlignment, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPMarkupFrameworkElement, "VerticalAlignment", 408, OleGetVerticalAlignment, OleSetVerticalAlignment, VT_I4)
