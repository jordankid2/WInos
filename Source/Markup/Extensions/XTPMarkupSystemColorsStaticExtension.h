// XTPMarkupSystemColorsStaticExtension.h: interface for the CXTPMarkupSystemColorsStaticExtension class.
//
...
//===========================================================================
// Summary: A property static extension object that represents a system color.
//===========================================================================
...
public:
	...
	//     nColorIndex - System color index. Refer to GetSysColor Win32 
	...
	//                   API function documentation for possible values.
	// Returns:
	//     A pointer to system color markup object. A caller is responsible for
	//     releasing an object.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary: A property static extension object that represents a system color key.
//===========================================================================
class _XTP_EXT_CLASS CXTPMarkupSystemColorKeyStaticExtension : public CXTPMarkupStaticExtensionProperty
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
//===========================================================================
// Summary: A property static extension object that represents a system brush.
//===========================================================================
...
//===========================================================================
// Summary: A property static extension object that represents a system brush key.
//===========================================================================
class _XTP_EXT_CLASS CXTPMarkupSystemBrushKeyStaticExtension : public CXTPMarkupStaticExtensionProperty
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
//===========================================================================
// Summary: A composite static extension object that represents system colors.
//==========================================================================
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a system colors extension object.
	//-----------------------------------------------------------------------
