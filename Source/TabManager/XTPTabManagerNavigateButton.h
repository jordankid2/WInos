...
public:
    ...
    //-----------------------------------------------------------------------
    // Summary: This member is called to determine if the owner tab button
	//          is currently selected.
    // Returns: TRUE if the owner tab button is currently selected.
    //-----------------------------------------------------------------------
    ...
    // Returns: TRUE if the owner tab button is currently highlighted.
    //-----------------------------------------------------------------------
	BOOL IsOwnerHighlighted() const;

    //-----------------------------------------------------------------------
    // Summary: This member is called to determine if the button is a common
	//          navigation item, or owned by a tab item.
    // Returns: TRUE if the button is a common navigation control, otherwise
	//          FALSE if the button is owned by a tab item.
    //-----------------------------------------------------------------------
	BOOL IsOwnerNull() const;

	//-----------------------------------------------------------------------
	// Summary: Call this member to determine if a group of tabs in the
	//		MDITabClient is active.  This only applies to groups of tabs
	//		in the TabWorkspace with grouping enabled.
	// Returns: TRUE if this group of tabs is active, FALSE otherwise.
	//-----------------------------------------------------------------------
	...
	//     clr - Button color.
	//     bEnabled - TRUE if button is enabled.
	//-----------------------------------------------------------------------
