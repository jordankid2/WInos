...
protected:
	...
	CXTPFont          m_xtpFontBold;                // Font used to display bold text in the tab buttons.  I.e. When a tab is selected and m_bBoldSelected = TRUE.
	CXTPFont          m_xtpFontVerticalNormal;      // Font used to display tab button caption when the tab position is vertical.
	CXTPFont          m_xtpFontVerticalBold;        // Font used to display bold text in the tab buttons when the tab position is vertical.  I.e. When a tab is selected and m_bBoldSelected = TRUE.
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntVerticalNormal, m_xtpFontVerticalNormal, GetVerticalNormalFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntVerticalBold, m_xtpFontVerticalBold, GetVerticalBoldFontHandle);
