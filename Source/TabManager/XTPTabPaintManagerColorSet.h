...
public:
	...
	CXTPPaintManagerColor         m_clrButtonHighlightedClose;    // Tab close button color on mouse over when hot tracking is enabled.

	CXTPPaintManagerColor         m_clrButtonSelected;            // Color of the currently selected tab.
	CXTPPaintManagerColor         m_clrButtonSelectedPressed;     // Color of the currently selected tab pressed.
	CXTPPaintManagerColor         m_clrButtonSelectedHighlighted; // Color of the currently selected tab highlighted.
	CXTPPaintManagerColor         m_clrButtonBorder;              // Tab button border (edge) color.
	CXTPPaintManagerColor         m_clrButtonBorderHot;           // Tab button highlight or pressed border (edge) color.
	...
	CXTPPaintManagerColor         m_clrTextPressed;             // Color of text in a "pressed" tab button.  The "pressed" tab button is the tab with focus, i.e. The tab becomes active when it is clicked.
	CXTPPaintManagerColor         m_clrTextHighlight;           // Color of text on mouse over when hot tracking is enabled.
	CXTPPaintManagerColor         m_clrTextHighlightClose;      // Color of close button text on mouse over when hot tracking is enabled.
	...
	CXTPPaintManagerColor         m_clrTextSelectedPressed;     // Color of text in a "pressed" tab button.  The "pressed" tab button is the tab with focus, i.e. The tab becomes active when it is clicked.
	CXTPPaintManagerColor         m_clrTextSelectedHighlighted; // Color of text for tabs in all non-active groups of tabs in MDITabClient.
	...
	CXTPPaintManagerColor         m_clrActiveFilesGlyphHighlighted; // Color of highlighted navigation button.
	CXTPPaintManagerColor         m_clrActiveFilesGlyphPressed;     // Color of selected navigation button.
	CXTPPaintManagerColor         m_clrActiveFilesBack;             // Color of highlighted navigation button background.
	CXTPPaintManagerColor         m_clrActiveFilesBackHighlighted;  // Color of navigation button background.
	CXTPPaintManagerColor         m_clrActiveFilesBackPressed;      // Color of selected navigation button background.
...
//{{AFX_CODEJOCK_PRIVATE
	__declspec(property(get=GetTextSelected, put=SetTextSelected))
	CXTPPaintManagerColor& m_clrSelectedText;
...
AFX_INLINE CXTPPaintManagerColor& CXTPTabPaintManagerColorSet::SetTextSelected(const CXTPPaintManagerColor& clr) {
