...
protected:
	CXTPBrush       m_xtpBrush;      // Handle to the current background brush
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED_(HBRUSH, HBRUSH, HBRUSH, m_hBrush, m_xtpBrush, GetBrushHandle);
