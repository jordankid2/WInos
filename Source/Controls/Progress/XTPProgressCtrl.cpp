...
void CXTPProgressCtrl::SetTheme(XTPControlTheme nTheme)
{
	...
	case xtpControlThemeFlat:
		SetTheme(new CXTPProgressCtrlThemeFlat);
		break;

	case xtpControlThemeOffice2000:
		SetTheme(new CXTPProgressCtrlThemeOffice2000);
		break;

	case xtpControlThemeOffice2003:
		SetTheme(new CXTPProgressCtrlThemeOffice2003);
		break;

	case xtpControlThemeResource:
		SetTheme(new CXTPProgressCtrlThemeResource);
		break;

	case xtpControlThemeOffice2013:
		SetTheme(new CXTPProgressCtrlThemeOffice2013);
		break;
