...
void CXTPSpinButtonCtrl::DrawArrowGlyph(CDC* pDC, CRect rcArrow, BOOL bHorz, BOOL bUpArrow, COLORREF clrArrow)
{
	ASSERT(pDC);
	...
	{
		XTPPrimitiveSymbol nSymbol = bHorz ? (!bUpArrow ? xtpPrimitiveSymbolPlayLeft : xtpPrimitiveSymbolPlayRight)
			: (bUpArrow ? xtpPrimitiveSymbolPlayUp : xtpPrimitiveSymbolPlayDown);
...
void CXTPSpinButtonCtrl::DrawFlatButton(CDC* pDC, UINT nButton)
{
	...
	if (m_nTheme != xtpControlThemeOffice2000)
	{
		...
		if (m_nTheme == xtpControlThemeFlat)
		{
			...
			pDC->Draw3dRect(rcBorder, GetXtremeColor(COLOR_3DHIGHLIGHT), GetXtremeColor(COLOR_3DHIGHLIGHT));
		}
	}
	else
	{
...
void CXTPSpinButtonCtrl::RefreshMetrics()
{
	...
	case xtpControlThemeUltraFlat:
		{
			...
			m_crBackHilite     = XTPColorManager()->LightColor(GetXtremeColor(COLOR_3DFACE),   GetXtremeColor(COLOR_WINDOW), 0x1E);
			m_crBackPushed     = XTPColorManager()->LightColor(GetXtremeColor(COLOR_3DSHADOW), GetXtremeColor(COLOR_3DFACE), 0x32);
			m_crBackDisabled   = m_crBack;
	...
	case xtpControlThemeVisualStudio2015:
		...
		m_crBackHilite     = XTPIniColor(_T("Controls.SpinButton"), _T("BackHilite"),     RGB(215, 225, 242));
		m_crBackPushed     = XTPIniColor(_T("Controls.SpinButton"), _T("BackPushed"),     RGB(163, 189, 227));
		m_crBackDisabled   = XTPIniColor(_T("Controls.SpinButton"), _T("BackDisabled"),   RGB(253, 253, 253));
		m_crBorder         = XTPIniColor(_T("Controls.SpinButton"), _T("Border"),         RGB(171, 171, 171));
		m_crBorderHilite   = XTPIniColor(_T("Controls.SpinButton"), _T("BorderHilite"),   RGB(163, 189, 227));
		m_crBorderPushed   = XTPIniColor(_T("Controls.SpinButton"), _T("BorderPushed"),   RGB( 43,  87, 154));
		m_crBorderDisabled = XTPIniColor(_T("Controls.SpinButton"), _T("BorderDisabled"), RGB(225, 225, 225));
		m_crArrowEnabled   = XTPIniColor(_T("Controls.SpinButton"), _T("Arrow"),          RGB(119, 119, 119));
		m_crArrowHilite    = XTPIniColor(_T("Controls.SpinButton"), _T("ArrowHilite"),    RGB( 68,  68,  68));
		m_crArrowPushed    = XTPIniColor(_T("Controls.SpinButton"), _T("ArrowPushed"),    RGB( 68,  68,  68));
		m_crArrowDisabled  = XTPIniColor(_T("Controls.SpinButton"), _T("ArrowDisabled"),  RGB(198, 198, 198));
		break;
...
void CXTPSpinButtonCtrl::SetTheme(XTPControlTheme nTheme)
{
	...
	m_bUseVisualStyle = (m_nTheme == xtpControlThemeDefault || m_nTheme == xtpControlThemeNativeWinXP);
