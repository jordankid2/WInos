...
COLORREF CXTPTreeTheme::GetItemBackColor(UINT uState, bool bTreeHasFocus, DWORD dwStyle, COLORREF crBackDef, CTreeCtrl* pTreeCtrl) const
{
	ASSERT(pTreeCtrl);
...
COLORREF CXTPTreeTheme::GetItemTextColor(UINT uState, bool bTreeHasFocus, DWORD dwStyle, COLORREF crTextDef, CTreeCtrl* pTreeCtrl) const
{
	ASSERT(pTreeCtrl);
...
{
	m_bDarkTheme = !bLight;
	m_nTheme = m_bDarkTheme ? xtpControlThemeVisualStudio2012Dark : xtpControlThemeVisualStudio2012Light;
...
void CXTPTreeOffice2013Theme::RefreshMetrics(CXTPTreeBase* pTreeBase)
{
    ...
    m_crTextSelectedInactive = XTPIniColor(_T("Controls.Tree"), _T("TextSelectedInactive"), m_crTextSelectedInactive);
    m_crTextSelectedDisabled = XTPIniColor(_T("Controls.Tree"), _T("TextSelectedDisabled"), m_crTextSelectedDisabled);
	...
	m_crBackSelectedInactive = XTPIniColor(_T("Controls.Tree"), _T("BackSelectedInactive"), m_crBackSelectedInactive);
    m_crBackSelectedDisabled = XTPIniColor(_T("Controls.Tree"), _T("BackSelectedDisabled"), m_crBackSelectedDisabled);
}
