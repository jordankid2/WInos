...
void CXTPPopupThemeOffice2003::DrawBackground(CDC* pDC, CXTPPopupControl* pControl, CRect rcClient)
{
	...
	for (int i = 0; i < 9; i++)
	{
		pDC->FillSolidRect(nRight, rcGripper.top + XTP_DPI_Y(1), XTP_DPI_X(2), XTP_DPI_Y(2), RGB(40, 50, 71));
		pDC->FillSolidRect(nRight + XTP_DPI_X(1), rcGripper.top + XTP_DPI_Y(2), XTP_DPI_X(2), XTP_DPI_Y(2), RGB(249, 249, 251));
		pDC->FillSolidRect(nRight + XTP_DPI_X(1), rcGripper.top + XTP_DPI_Y(2), XTP_DPI_X(1), XTP_DPI_Y(1), RGB(97, 116, 152));
