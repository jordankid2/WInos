...
#include "Themes/XTPPopupThemeOffice2000.h"
#include "Themes/XTPPopupThemeOfficeXP.h"
#include "Themes/XTPPopupThemeOffice2003.h"
#include "Themes/XTPPopupThemeOffice2013.h"
#include "Themes/XTPPopupThemeMSN.h"
#include "Themes/XTPPopupThemeResource.h"
...
: m_bAutoDelete(bAutoDelete), m_nID(0)
{
	...
	//popup pos&size init
	m_szPopup = XTP_DPI(CSize(170, 130));
...
{
	SAFE_DELETE (m_pPaintManager); //safe delete old theme object
...
void CXTPPopupControl::SetTheme(XTPPopupPaintTheme theme)
{
	...
	switch (theme)
	{
		...
		case xtpPopupThemeOffice2003:
			...
			break;
		case xtpPopupThemeOffice2013:
			SetTheme(new CXTPPopupThemeOffice2013());
			break;
...
BOOL CXTPPopupControl::Show(CWnd* pParent, int nID/*=0*/)
{
	//create popup wnd
	if (!Create(pParent))
		return FALSE;
...
BOOL CXTPPopupControl::ShowModal(CWnd* pParent, int nID/*=0*/)
{
