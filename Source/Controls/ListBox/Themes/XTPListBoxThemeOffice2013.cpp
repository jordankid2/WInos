...
void CXTPListBoxThemeOffice2013::RefreshMetrics()
{
	...
	m_clrItemTextSelected   = XTPIniColor(_T("Controls.ListBox"), _T("ItemTextSelected"),    RGB(255, 255, 255));
	m_clrItemTextHighlight  = XTPIniColor(_T("Controls.ListBox"), _T("ItemTextHighlight"),   RGB( 68,  68,  68));
	m_clrItemBack           = XTPIniColor(_T("Controls.ListBox"), _T("ItemBack"),            RGB(255, 255, 255));
	m_clrItemBackSelected   = XTPIniColor(_T("Controls.ListBox"), _T("ItemBackSelected"),    RGB( 43,  87, 154));
	m_clrItemBackHighlight  = XTPIniColor(_T("Controls.ListBox"), _T("ItemBackHighlight"),   RGB(213, 225, 242));
	m_clrItemBorder         = XTPIniColor(_T("Controls.ListBox"), _T("ItemBorder"),          RGB(255, 255, 255));
	m_clrItemBorderSelected = XTPIniColor(_T("Controls.ListBox"), _T("ItemBorderSelected"),  RGB( 43,  87, 154));
	m_clrItemBorderHighlight= XTPIniColor(_T("Controls.ListBox"), _T("ItemBorderHighlight"), RGB(163, 189, 227));
}
