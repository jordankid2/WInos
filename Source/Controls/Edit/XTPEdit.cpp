	...
	if (!IsPatternValid())
	{
		...
		if (rectClient.bottom - rect.bottom >= iIncrement + XTP_DPI_X(1))
		{
			...
			else
			{
				...
				size = memDC.GetTextExtent (strText.
					Mid(((CEdit*)this)->CharFromPos(CPoint(rect.left + XTP_DPI_X(1), rect.top))));
...
void CXTPEdit::SetTheme(XTPControlTheme nTheme)
{
	...
	case xtpControlThemeResource:
		m_pTheme = new CXTPEditThemeResource();
		break;

	case xtpControlThemeOffice2000:
		m_pTheme = new CXTPEditThemeOffice2000();
		break;

	case xtpControlThemeOfficeXP:
		m_pTheme = new CXTPEditThemeOfficeXP();
		break;

	case xtpControlThemeFlat:
		m_pTheme = new CXTPEditThemeFlat();
		break;

	case xtpControlThemeUltraFlat:
		m_pTheme = new CXTPEditThemeUltraFlat();
		break;

	case xtpControlThemeOffice2013:
		m_pTheme = new CXTPEditThemeOffice2013();
		break;

	case xtpControlThemeOffice2003:
		m_pTheme = new CXTPEditThemeOffice2003();
		break;

	case xtpControlThemeVisualStudio2010:
		m_pTheme = new CXTPEditThemeVisualStudio2010();
		break;
	...
	case xtpControlThemeVisualStudio2015:
		m_pTheme = new CXTPEditThemeVisualStudio2015();
		break;
	...
	default:
		m_pTheme = new CXTPEditThemeDefault();
		break;
	}
...
IMPLEMENT_DYNAMIC(CXTPEditor, CXTPEdit)

void CXTPEditor::RefreshMetrics()
{
