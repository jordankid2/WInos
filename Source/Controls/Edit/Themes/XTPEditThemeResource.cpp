...
void CXTPEditThemeResource::RefreshMetrics(CXTPEdit* pEdit)
{
	...
	m_clrBorder      .SetStandardValue(XTPIniColor(_T("Toolbar"), _T("ControlEditBorder"), ::GetSysColor(COLOR_3DSHADOW)));
	m_clrBorderHilite.SetStandardValue(XTPIniColor(_T("Toolbar"), _T("ControlEditBorder"), ::GetSysColor(COLOR_3DSHADOW)));
}
...
void CXTPEditThemeResource::DrawBuddyBorders(CWnd* pBuddy, CDC* pDC, CRect rc, int nAlignemnt, CXTPEdit* pEdit)
{
	ASSERT_VALID(pDC);
