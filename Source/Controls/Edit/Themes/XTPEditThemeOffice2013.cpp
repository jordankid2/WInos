...
void CXTPEditThemeOffice2013::RefreshMetrics(CXTPEdit* pEdit)
{
	...
	m_clrBackNonClient .SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("BackNonClient"),  RGB(246, 246, 246)));
	m_clrText          .SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("Text"),           RGB( 68,  68,  68)));
	m_clrTextReadOnly  .SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("TextReadOnly"),   RGB( 68,  68,  68)));
	m_clrBorder        .SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("Border"),         RGB(171, 171, 171)));
	m_clrBorderHilite  .SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("BorderHilite"),   RGB(163, 189, 227)));
	m_clrBorderDisabled.SetStandardValue(XTPIniColor(_T("Controls.Edit"), _T("BorderDisabled"), RGB(225, 225, 225)));
