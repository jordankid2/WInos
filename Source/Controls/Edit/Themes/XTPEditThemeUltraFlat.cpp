// XTPEditThemeUltraFlat.cpp: implementation of the CXTPEditThemeUltraFlat class.
//
...
CXTPEditThemeUltraFlat::CXTPEditThemeUltraFlat()
{
...
void CXTPEditThemeUltraFlat::RefreshMetrics(CXTPEdit* pEdit)
{
	CXTPEditThemeDefault::RefreshMetrics(pEdit);

	m_clrBorder        .SetStandardValue(GetXtremeColor(COLOR_3DSHADOW));
	m_clrBorderHilite  .SetStandardValue(GetXtremeColor(COLOR_3DSHADOW));
