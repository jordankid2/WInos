...
void CXTPEditThemeOffice2000::RefreshMetrics(CXTPEdit* pEdit)
{
	...
	m_clrBorder.SetStandardValue(GetXtremeColor(COLOR_BTNHIGHLIGHT), GetXtremeColor(COLOR_3DSHADOW));
}
...
void CXTPEditThemeOffice2000::DrawBuddyBorders(CWnd* pBuddy, CDC* pDC, CRect rc, int nAlignemnt, CXTPEdit* pEdit)
{
	ASSERT_VALID(pDC);
