...
void CXTPScrollBar::SetTheme(XTPControlTheme nTheme)
{
	...
	case xtpControlThemeDefault:
		CXTPScrollBarCtrl::SetTheme(m_bUseVisualStyle ? xtpScrollBarThemeWindowsDefault : xtpScrollBarThemeWindowsClassic);
		break;

	case xtpControlThemeFlat:
		CXTPScrollBarCtrl::SetTheme(xtpScrollBarThemeFlat);
		break;
	...
	case xtpControlThemeResource:
		CXTPScrollBarCtrl::SetTheme(xtpScrollBarThemeResource);
		break;
