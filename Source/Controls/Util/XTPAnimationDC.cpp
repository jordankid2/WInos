...
void AFX_CDECL CXTPAnimationDC::AlphaBlendU(PBYTE pDest, PBYTE pSrcBack, int cx, int cy, PBYTE pSrc, BYTE byAlpha)
{
...
void AFX_CDECL CXTPAnimationDC::SetCustomAnimation(LPFNANIMATION pCustom)
{
