...
public:
	...
	BOOL CreateSysFont(const CXTPLogFont& lf, CXTPFont& font, long lfWeight = -1, char lfUnderline = -1, long lfOrientation = -1, long lfEscapement = -1); // <combine CXTPAuxData@const CXTPLogFont&@CFont&@long@char@long@long>
...
public:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontVertBold, xtpFontVertBold, GetVertBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontIconTitle, xtpFontIconTitle, GetIconTitleFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontIconTitleBold, xtpFontIconTitleBold, GetIconTitleBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontMarlettIcon, xtpFontMarlettIcon, GetMarlettIconFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontStatus, xtpFontStatus, GetStatusFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, fontSmCaption, xtpFontSmCaption, GetSmCaptionFontHandle);
