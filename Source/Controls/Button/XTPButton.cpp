...
void CXTPButton::SetTextImageRelation(XTPButtonTextImageRelation realtion)
{
...
{
	return m_nPushButtonStyle == xtpButtonDropDown 
...
{
 	if (m_pTheme && 
		m_pTheme->GetThemeStyle() != xtpControlThemeUltraFlat &&
...
BOOL CXTPButton::SetTheme(XTPControlTheme eTheme)
{
	...
	m_bUseVisualStyle = (
		eTheme == xtpControlThemeDefault || 
		eTheme == xtpControlThemeNativeWinXP);
