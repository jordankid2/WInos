...
void CXTPButtonThemeOffice2013::RefreshMetrics(CXTPButton* pButton)
{
	...
	m_crBackHilite    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BackHilite"),     RGB(213, 225, 242)));
	m_crBackPushed    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BackPushed"),     RGB(163, 189, 227)));
	m_crBackDisabled  .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BackDisabled"),   RGB(253, 253, 253)));
	m_crBorder        .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("Border"),         RGB(171, 171, 171)));
	m_crBorderHilite  .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BorderHilite"),   RGB(163, 189, 227)));
	m_crBorderPushed  .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BorderPushed"),   RGB( 43,  87, 154)));
	m_crBorderDefault .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BorderDefault"),  RGB( 43,  87, 154)));
	m_crBorderDisabled.SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("BorderDisabled"), RGB(225, 225, 225)));
	m_crText          .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("Text"),           RGB( 68,  68,  68)));
	m_crTextCheck     .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("TextCheck"),      RGB( 68,  68,  68)));
	m_crTextHilite    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("TextHilite"),     RGB( 68,  68,  68)));
	m_crTextPushed    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("TextPushed"),     RGB( 68,  68,  68)));
	m_crTextDisabled  .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("TextDisabled"),   RGB(152, 152, 152)));
	m_crMark          .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("Mark"),           RGB(139, 139, 139)));
	m_crMarkHilite    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("MarkHilite"),     RGB( 67,  75,  80)));
	m_crMarkPushed    .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("MarkPushed"),     RGB( 15,  20,  24)));
	m_crMarkDisabled  .SetStandardValue(XTPIniColor(_T("Controls.Button"), _T("MarkDisabled"),   RGB(198, 198, 198)));
}
...
void CXTPButtonThemeOffice2013::DrawCheckBoxMark(CDC* pDC, CXTPButton* pButton)
{
	...
	case BST_CHECKED:
		{
			XTPPrimitiveDrawer()->DrawSymbol(pDC, CXTPDrawHelpers::IsContextRTL(pDC)?
				xtpPrimitiveSymbolCheckMarkRTL : xtpPrimitiveSymbolCheckMark, rc, clrCheck);
		}
		break;
...
void CXTPButtonThemeOffice2013::DrawRadioButtonMark(CDC* pDC, CXTPButton* pButton)
{
	...
	if (bChecked)
	{
		AlphaEllipse(pDC, CRect(rc.left + XTP_DPI_X(4), rc.top + XTP_DPI_Y(4), rc.left + XTP_DPI_X(9), rc.top + XTP_DPI_Y(9)), clrRadio, clrRadio);
	}
}
...
COLORREF CXTPButtonThemeOffice2013::GetTextColor(CXTPButton* pButton)
{
	...
	if (bStyle == BS_RADIOBUTTON ||
		...
		bStyle == BS_CHECKBOX ||
		bStyle == BS_AUTOCHECKBOX ||
		bStyle == BS_3STATE ||
		bStyle == BS_AUTO3STATE)
	{
...
void CXTPButtonThemeOffice2013::DrawPushButtonDropDown(CDC* pDC, CXTPButton* pButton)
{
	...
	switch (pButton->GetPushButtonStyle())
	{
		...
		{
			XTPPrimitiveDrawer()->DrawSymbol(pDC, xtpPrimitiveSymbolPlayDown, rcArrow, GetTextColor(pButton));
			break;
		}

		case xtpButtonDropDownRight:
		{
			XTPPrimitiveDrawer()->DrawSymbol(pDC, xtpPrimitiveSymbolPlayRight, rcArrow, GetTextColor(pButton));
			break;
		}
