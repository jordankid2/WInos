...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntIconBold, m_xtpFontIconBold, GetIconBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntIconHot, m_xtpFontIconHot, GetIconHotFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntIconHotBold, m_xtpFontIconHotBold, GetIconHotBoldFontHandle);
