// XTPTaskPanelAnimation.cpp : implementation file
//
...
CXTPTaskPanelAnimation::CAnimateInfo::CAnimateInfo()
{
	hbmSrc = 0;
	pSrcBits = 0;
	hbmSrcBack = 0;
...
CXTPTaskPanelAnimation::CXTPTaskPanelAnimation(CXTPTaskPanel* pTaskPanel)
{
	m_bInvalidate = FALSE;
	m_pParent = pTaskPanel;
	m_nTimer = 0;
...
CXTPTaskPanelAnimation::~CXTPTaskPanelAnimation()
{
	RemoveAnimations();
}

void CXTPTaskPanelAnimation::RemoveAnimations()
{
...
void CXTPTaskPanelAnimation::AlphaBlendU(PBYTE pDest, PBYTE pSrcBack, int cx, int cy, PBYTE pSrc, BYTE byAlpha)
{
...
BOOL CXTPTaskPanelAnimation::IsAnimationEnabled() const
{
	return m_bAnimation;
}

void CXTPTaskPanelAnimation::AnimateRect(CClientDC& dc, CAnimateInfo* pai)
{
...
void CXTPTaskPanelAnimation::OnAnimate()
{
...
void CXTPTaskPanelAnimation::RemoveIntersections(LPCRECT rcPaint, BOOL bAddExclude)
{
	for (int i = 0; i < m_arrAnimation.GetSize(); i++)
	{
...
void CXTPTaskPanelAnimation::AddAnimation(CClientDC& dc, CAnimateInfo* pai)
{
...
void CXTPTaskPanelAnimation::OnDestroy()
{
	m_bmpCache.DeleteObject();
	RemoveAnimations();
}

void CXTPTaskPanelAnimation::RedrawRect(LPCRECT lpRect, BOOL bAnimate)
{
	if (lpRect == NULL)
	{
		m_bmpCache.DeleteObject();
...
void CXTPTaskPanelAnimation::OnPaint(CPaintDC& paintDC)
{
	CXTPClientRect rc(m_pParent);
