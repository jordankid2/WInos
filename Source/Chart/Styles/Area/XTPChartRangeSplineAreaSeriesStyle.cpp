...
CXTPChartDeviceCommand* CXTPChartRangeSplineAreaSeriesView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand* pCommand = pSeriesCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dPolygonAntialiasingDeviceCommand());
	...
	if (nCount > 1)
	{
		...
		{
			CXTPChartDeviceCommand* pSolidSplineDeviceCommand = CXTPChartDrawingObjectFactory::Create2dSolidSplineDeviceCommand(arrPoints, clrBorder, pStyle->GetBorder()->GetThickness());
		...
		if (pStyle->GetBorder()->IsVisible())
		{
			CXTPChartDeviceCommand* pSolidSplineDeviceCommand = CXTPChartDrawingObjectFactory::Create2dSolidSplineDeviceCommand(arrBottomPoints, clrBorder, pStyle->GetBorder()->GetThickness());
			pCommand->AddChildCommand(pSolidSplineDeviceCommand);
		}
...
BEGIN_INTERFACE_MAP(CXTPChartRangeSplineAreaSeriesStyle, CXTPChartAreaSeriesStyle)
	INTERFACE_PART(CXTPChartRangeSplineAreaSeriesStyle, XTPDIID__DChartRangeSplineAreaSeriesStyle, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartRangeSplineAreaSeriesStyle, XTPDIID__DChartRangeSplineAreaSeriesStyle)

IMPLEMENT_OLECREATE_EX2_CLSID(CXTPChartRangeSplineAreaSeriesStyle, "Codejock.ChartRangeSplineAreaSeriesStyle." _XTP_AXLIB_VERSION,
