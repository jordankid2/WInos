...
BEGIN_INTERFACE_MAP(CXTPChartStackedSplineAreaSeriesStyle, CXTPChartStackedAreaSeriesStyle)
	INTERFACE_PART(CXTPChartStackedSplineAreaSeriesStyle, XTPDIID__DChartStackedSplineAreaSeriesStyle, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartStackedSplineAreaSeriesStyle, XTPDIID__DChartStackedSplineAreaSeriesStyle)

IMPLEMENT_OLECREATE_EX2_CLSID(CXTPChartStackedSplineAreaSeriesStyle, "Codejock.ChartStackedSplineAreaSeriesStyle." _XTP_AXLIB_VERSION,
