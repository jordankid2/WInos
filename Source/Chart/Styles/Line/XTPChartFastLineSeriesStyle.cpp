...
CXTPChartDeviceCommand* CXTPChartFastLineSeriesView::CreateDeviceCommand(CXTPChartDeviceContext* /*pDC*/)
{
	...
	CXTPChartDeviceCommand* pCommand = pSeriesCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dPolygonAntialiasingDeviceCommand(pStyle->GetAntialiasing()));
...
IMPLEMENT_OLECREATE_EX2_CLSID(CXTPChartFastLineSeriesStyle, "Codejock.ChartFastLineSeriesStyle." _XTP_AXLIB_VERSION,
