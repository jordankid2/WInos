...
BEGIN_INTERFACE_MAP(CXTPChartRadarSplineAreaSeriesStyle, CXTPChartRadarAreaSeriesStyle)
	INTERFACE_PART(CXTPChartRadarSplineAreaSeriesStyle, XTPDIID__DChartRadarSplineAreaSeriesStyle, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartRadarSplineAreaSeriesStyle, XTPDIID__DChartRadarSplineAreaSeriesStyle)

IMPLEMENT_OLECREATE_EX2_CLSID(CXTPChartRadarSplineAreaSeriesStyle, "Codejock.ChartRadarSplineAreaSeriesStyle." _XTP_AXLIB_VERSION,
