...
CXTPChartPieSeriesViewBase::CXTPChartPieSeriesViewBase(CXTPChartSeries* pSeries, CXTPChartDiagramView* pDiagramView)
...
CXTPChartDiagramDomain* CXTPChartPieSeriesViewBase::CreateDiagramDomain(CXTPChartDeviceContext* pDC, CRect rcBounds)
{
	m_rcBounds = rcBounds;
...
void CXTPChartPieSeriesViewBase::CalculateValues()
{
	...
	{
		CXTPChartPieSeriesPointViewBase* pPointView = (CXTPChartPieSeriesPointViewBase*)m_pPointsView->GetAt(0);
