...
BEGIN_DISPATCH_MAP(CXTPChartPieSeriesStyleBase, CXTPChartSeriesStyle)
	DISP_PROPERTY_NOTIFY_ID(CXTPChartPieSeriesStyleBase, "HolePercent", 100, m_nHolePercent, OleChartChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CXTPChartPieSeriesStyleBase, "ExplodedDistancePercent", 101, m_nExplodedDistancePercent, OleChartChanged, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CXTPChartPieSeriesStyleBase, "Rotation", 102, m_nRotation, OleChartChanged, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPChartPieSeriesStyleBase, "Border", 103, OleGetBorder, SetNotSupported, VT_DISPATCH)
END_DISPATCH_MAP()
