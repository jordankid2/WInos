...
CXTPChartPieSeriesLabelViewBase::CXTPChartPieSeriesLabelViewBase(CXTPChartSeriesLabel* pLabel, CXTPChartSeriesPointView* pPointView, CXTPChartElementView* pParentView)
...
BEGIN_DISPATCH_MAP(CXTPChartPieSeriesLabelBase, CXTPChartSeriesLabel)
	DISP_PROPERTY_NOTIFY_ID(CXTPChartPieSeriesLabelBase, "Position", 106, m_nPosition, OleChartChanged, VT_I4)
END_DISPATCH_MAP()
