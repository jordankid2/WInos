...
void CXTPChartPieDiagramBaseImpl::CalculateSeriesLayout(CXTPChartDeviceContext* pDC, CXTPChartDiagramView* pView)
{
	ASSERT_VALID(pView);
	...
	if (0 < pView->GetCount())
	{
		...
		{
			CXTPChartPieSeriesViewBase* pSeriesView = (CXTPChartPieSeriesViewBase*)pView->GetSeriesView()->GetAt(i);
