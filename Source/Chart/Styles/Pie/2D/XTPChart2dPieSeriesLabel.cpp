...
IMPLEMENT_SERIAL(CXTPChartPieSeriesLabel, CXTPChartPieSeriesLabelBase, VERSIONABLE_SCHEMA | _XTP_SCHEMA_CURRENT)
...
CXTPChartPointF CXTPChartPieSeriesLabel::CalculateAnchorPointAndAngles(CXTPChartPieSeriesPointViewBase* pPointView,
...
void CXTPChartPieSeriesLabelsView::ResolveOverlappingColumn(CArray<CXTPChartPieSeriesLabelView*, CXTPChartPieSeriesLabelView*>& arrColumn)
{
	...
	CXTPChartPieSeriesViewBase* pSeriesView = (CXTPChartPieSeriesViewBase*)arrColumn[0]->GetPointView()->GetSeriesView();
...
void CXTPChartPieSeriesLabelsView::ResolveOverlapping()
{
	...
	CXTPChartPieSeriesViewBase* pSeriesView = (CXTPChartPieSeriesViewBase*)((CXTPChartPieSeriesLabelView*)GetAt(0))->GetPointView()->GetSeriesView();
...
void CXTPChartPieSeriesLabelView::CalculateLayout(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartRectF realBounds(((CXTPChartPieSeriesPointViewBase*)m_pPointView)->GetPie()->GetBounds());
	...
	CXTPChartPointF anchorPoint = pLabel->CalculateAnchorPointAndAngles((CXTPChartPieSeriesPointViewBase*)m_pPointView,
	...
	{
		CXTPChartPieSeriesViewBase* pSeriesView = (CXTPChartPieSeriesViewBase*)m_pPointView->GetSeriesView();
		CXTPChartRectF rcInnerBounds = pSeriesView->GetInnerBounds();
...
CXTPChartDeviceCommand* CXTPChartPieSeriesLabelView::CreateConnectorDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	else if (position == xtpChartPieLabelTwoColumns)
	{
		...
		if (m_pLabel->GetShowLines())
		{
			...
			CXTPChartDeviceCommand* pContaier = CXTPChartDrawingObjectFactory::Create2dPolygonAntialiasingDeviceCommand();
			pContaier->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(startPoint, breakPoint, clrConnectorColor, 1));
			pContaier->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(breakPoint, finishPoint, clrConnectorColor, 1));
...
CXTPChartDeviceCommand* CXTPChartPieSeriesLabelView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	else if (position == xtpChartPieLabelRadial)
	{
		...
		CXTPChartDeviceCommand* pStateGraphicsCommand = pCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSaveStateDeviceCommand());
		pStateGraphicsCommand = pStateGraphicsCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dTranslateDeviceCommand(anchorPoint.X, anchorPoint.Y));
		pStateGraphicsCommand = pStateGraphicsCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dRotateDeviceCommand(fAngle));
		pStateGraphicsCommand = pStateGraphicsCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dPolygonAntialiasingDeviceCommand(TRUE));
...
CXTPChartDeviceCommand* CXTPChartPieSeriesLabelsView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	for (i = 0; i < m_arrChildren.GetSize(); i++)
	{
		CXTPChartPieSeriesLabelViewBase* pChildView = static_cast<CXTPChartPieSeriesLabelViewBase*>(m_arrChildren[i]);
