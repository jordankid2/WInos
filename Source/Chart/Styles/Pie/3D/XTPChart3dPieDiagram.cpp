...
IMPLEMENT_SERIAL(CXTPChart3dPieDiagram, CXTPChart3dDiagram, VERSIONABLE_SCHEMA | _XTP_SCHEMA_CURRENT)
...
CXTPChartDiagramView* CXTPChart3dPieDiagram::CreateView(CXTPChartDeviceContext* pDC, CXTPChartElementView* pParent)
{
...
BEGIN_DISPATCH_MAP(CXTPChart3dPieDiagram, CXTPChart3dPieDiagramBase)
END_DISPATCH_MAP()

BEGIN_INTERFACE_MAP(CXTPChart3dPieDiagram, CXTPChart3dPieDiagramBase)
...
IMPLEMENT_OLECREATE_EX2_CLSID(CXTPChart3dPieDiagram, "Codejock.Chart3dPieDiagram." _XTP_AXLIB_VERSION,
