// XTPChart3dPieDeviceCommandEvents.cpp
//
...
CXTPChart3dPieDeviceCommandEvents::CXTPChart3dPieDeviceCommandEvents()
{
}

void CXTPChart3dPieDeviceCommandEvents::OnSetConnectorPoints(
	CXTPChartDeviceCommand* pCommand,
	CXTPPoint3d ptShapeCenter,
	CXTPPoint3d ptOuterCenter)
{
	UNREFERENCED_PARAMETER(pCommand);
	UNREFERENCED_PARAMETER(ptShapeCenter);
	UNREFERENCED_PARAMETER(ptOuterCenter);
}
