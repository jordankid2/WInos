...
#if !defined(__XTPCHART3DPIEDIAGRAMVIEW_H__)
#define __XTPCHART3DPIEDIAGRAMVIEW_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
class _XTP_EXT_CLASS CXTPChart3dPieDiagramView : public CXTPChart3dDiagramView
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPChart3dPieDiagramView object.
	// Parameters:
	//     pDiagram - A pointer to pie diagram object.
	//     pParent  - A pointer to the parent view.
	// Remarks:
	//-----------------------------------------------------------------------
	CXTPChart3dPieDiagramView(CXTPChartDiagram* pDiagram, CXTPChartElementView* pParent);
...
#endif //#if !defined(__XTPCHART3DPIEDIAGRAMVIEW_H__)
