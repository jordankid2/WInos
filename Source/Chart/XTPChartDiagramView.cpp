...
{
	CXTPChartDeviceCommand* pCommand = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(m_pDiagram, m_rcBounds);
...
CXTPChart3dDiagramView::CXTPChart3dDiagramView(CXTPChartDiagram* pDiagram, CXTPChartElementView* pParentView)
...
CXTPChartDeviceCommand* CXTPChart3dDiagramView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	p3DDC->SetModelDistanceLimits(
		CXTPChart3dDiagram::m_fMinModelDistance,
