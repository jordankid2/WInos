...
BEGIN_DISPATCH_MAP(CXTPChartDiagram2D, CXTPChartDiagram)
	...
	DISP_FUNCTION_ID(CXTPChartDiagram2D,  "AxisXByIndex", 17, OleGetAxisXByIndex, VT_DISPATCH, VTS_I4)
	DISP_FUNCTION_ID(CXTPChartDiagram2D,  "AxisYByIndex", 18, OleGetAxisYByIndex, VT_DISPATCH, VTS_I4)
