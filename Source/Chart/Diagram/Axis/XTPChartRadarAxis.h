...
public:
	...
	// Returns:
	//     TRUE is default value and means clockwise direction.
	//     FALSE means counterclockwise direction.
	// See Also: SetDirectionClockwise
	//-------------------------------------------------------------------------
	BOOL IsDirectionClockwise() const;
	
	//-------------------------------------------------------------------------
	// Summary:
	//     This function set the direction of the axis.
	// Returns:
	//     bDirectionClockwise - A new value for axis direction. 
	//                         TRUE is default value and means clockwise direction.
	//                         FALSE means counterclockwise direction.
	// See Also: IsDirectionClockwise
	//-------------------------------------------------------------------------
...
protected:
	...
	BOOL	m_bDirectionClockwise;		//The direction of axis. Default is TRUE (clockwise).
};
