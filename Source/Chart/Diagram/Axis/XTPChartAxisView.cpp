...
CXTPChartDeviceCommand* CXTPChartDiagram2DAxisView::CreateTickMarksDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand* pCommands = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(m_pAxis, m_rcBounds);
	...
	for (int i = 0; i < m_arrTicks.GetSize(); i++)
	{
		...
		if (bVertical)
		{
			if (m_pAxis->GetAlignment() == xtpChartAxisNear)
				pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(m_rcBounds.right - nAxisThickness - nLength, nLeft),
					CXTPPoint3d(m_rcBounds.right - nAxisThickness + nExtraLength, nLeft), clrAxis, nThickness));
			else
				pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(m_rcBounds.left + nAxisThickness - nExtraLength, nLeft),
					CXTPPoint3d(m_rcBounds.left + nAxisThickness + nLength, nLeft), clrAxis, nThickness));
		}
		else
		{
			if (m_pAxis->GetAlignment() == xtpChartAxisNear)
				pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(nLeft, m_rcBounds.top + nAxisThickness - nExtraLength),
					CXTPPoint3d(nLeft, m_rcBounds.top + nAxisThickness + nLength), clrAxis, nThickness));
			else
				pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(nLeft, m_rcBounds.bottom - nAxisThickness - nLength),
	...
	if (bMinorVisible)
	{
		...
		for (int i = 0; i < m_arrMinorTicks.GetSize(); i++)
		{
			...
			if (bVertical)
			{
				if (m_pAxis->GetAlignment() == xtpChartAxisNear)
					pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(m_rcBounds.right - nAxisThickness  - nLength, nLeft),
					CXTPPoint3d(m_rcBounds.right - nAxisThickness + nExtra, nLeft), clrAxis, nMinorThickness));
				else
					pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(m_rcBounds.left + nAxisThickness  - nExtra, nLeft),
					CXTPPoint3d(m_rcBounds.left + nAxisThickness + nLength, nLeft), clrAxis, nMinorThickness));
			}
			else
			{
				if (m_pAxis->GetAlignment() == xtpChartAxisNear)
					pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(nLeft, m_rcBounds.top + nAxisThickness  - nExtra),
					CXTPPoint3d(nLeft, m_rcBounds.top + nAxisThickness + nLength), clrAxis, nMinorThickness));
				else
					pCommands->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(nLeft, m_rcBounds.bottom - nAxisThickness - nLength),
					CXTPPoint3d(nLeft, m_rcBounds.bottom - nAxisThickness + nExtra), clrAxis, nMinorThickness));
			}
		}
	}
	...
	float r2[4][2])
{
	...
	*/
	...
	return 
		// r1:B x r2:A
		DoLineSegmentsIntersect(r1[1][0], r1[1][1], r1[2][0], r1[2][1], r2[0][0], r2[0][1], r2[1][0], r2[1][1])
		||
		// r1:B x r2:C
		DoLineSegmentsIntersect(r1[1][0], r1[1][1], r1[2][0], r1[2][1], r2[2][0], r2[2][1], r2[3][0], r2[3][1])
		||
		// r1:D x r2:A
		DoLineSegmentsIntersect(r1[0][0], r1[0][1], r1[3][0], r1[3][1], r2[0][0], r2[0][1], r2[1][0], r2[1][1])
		||
		// r1:D x r2:C
		DoLineSegmentsIntersect(r1[0][0], r1[0][1], r1[3][0], r1[3][1], r2[2][0], r2[2][1], r2[3][0], r2[3][1])

		||
		// r2:B x r1:A
		DoLineSegmentsIntersect(r2[1][0], r2[1][1], r2[2][0], r2[2][1], r1[0][0], r1[0][1], r1[1][0], r1[1][1])
		||
		// r2:B x r1:C
		DoLineSegmentsIntersect(r2[1][0], r2[1][1], r2[2][0], r2[2][1], r1[2][0], r1[2][1], r1[3][0], r1[3][1])
		||
		// r2:D x r1:A
		DoLineSegmentsIntersect(r2[0][0], r2[0][1], r2[3][0], r2[3][1], r1[0][0], r1[0][1], r1[1][0], r1[1][1])
		||
		// r2:D x r1:C
		DoLineSegmentsIntersect(r2[0][0], r2[0][1], r2[3][0], r2[3][1], r1[2][0], r1[2][1], r1[3][0], r1[3][1]);
}
...
CXTPChartDeviceCommand* CXTPChartDiagram2DAxisView::CreateLabelsDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand* pLabelsCommand = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(m_pAxis->GetLabel(), m_rcBounds);
	CXTPChartColor clrAxis = m_pAxis->GetActualColor();
	...
	int nOffset = m_pAxis->GetThickness() + (m_pAxis->GetTickMarks()->IsVisible() ? (m_pAxis->GetTickMarks()->GetLength() > 0 ? m_pAxis->GetTickMarks()->GetLength() : MIN_SPACE_BETWEEN_AXIS_AND_LABEL) : 0)
	...
	for (int i = 0; i < m_arrTicks.GetSize(); i++)
	{
		...
		CXTPChartRotatedTextPainterNearLine painter(pDC, s, m_pAxis->GetLabel(), ptBase, position, (float)nAngle);
...
CXTPChartDeviceCommand* CXTPChartDiagram2DAxisView::CreateScrollBarDeviceCommand(CXTPChartDeviceContext* /*pDC*/)
{
	...
	pCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidRectangleDeviceCommand(rcBounds, CXTPChartColor::White));

	pCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dBoundedRectangleDeviceCommand(rcBounds, clrAxis, 1));
	...
	pCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidRectangleDeviceCommand(rcThumb, clrAxis));
...
CXTPChartDeviceCommand* CXTPChartDiagram2DAxisView::CreateTitleDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand* pCommand = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(pTitle, m_rcBounds);
...
CXTPChartDeviceCommand* CXTPChartDiagram2DAxisView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	if (m_pAxis->IsVisible())
	{
		if (IsVertical())
		{
			...
			pAxisCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(fPosition, (float)m_rcBounds.top),
		...
		else
		{
			...
			pAxisCommand->AddChildCommand(CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(CXTPPoint3d(m_rcBounds.left, fPosition),
...
void CXTPChartDiagram2DAxisView::CalcSize(CXTPChartDeviceContext* pDC, CRect rcDiagram)
{
	...
	{
		m_nSize += (pAxis->GetTickMarks()->GetLength() > 0) ? pAxis->GetTickMarks()->GetLength() : MIN_SPACE_BETWEEN_AXIS_AND_LABEL;
	}
