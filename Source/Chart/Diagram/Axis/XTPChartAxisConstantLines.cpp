...
BEGIN_INTERFACE_MAP(CXTPChartAxisConstantLine, CXTPChartElement)
	INTERFACE_PART(CXTPChartAxisConstantLine, XTPDIID_ChartAxisConstantLine, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartAxisConstantLine, XTPDIID_ChartAxisConstantLine)
...
BEGIN_INTERFACE_MAP(CXTPChartAxisConstantLines, CXTPChartElement)
	INTERFACE_PART(CXTPChartAxisConstantLines, XTPDIID_ChartAxisConstantLines, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartAxisConstantLines, XTPDIID_ChartAxisConstantLines)
