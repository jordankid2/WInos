...
enum XTPChartAxisAlignment
{
	...
	xtpChartAxisFar      //For Y axis, far means right side of the chart. For X axis it is the top side of the chart.
};
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to get index of the axis.
	// Returns:
	//     Returns an int value denoting the index of the axis.
	// Remarks:
	//-------------------------------------------------------------------------
	int GetIndex() const;
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to set the axis index.
	// Parameters:
	//     nIndex - The index of axis.
	// Remarks:
	//-------------------------------------------------------------------------
	...
	CXTPChartAxisView* GetAxisView() const;
...
//===========================================================================
// Summary:
//     CXTPChartAxisX specialized class from CXTPChartAxis class represents the X axis
//     of a chart.
...
AFX_INLINE int CXTPChartAxis::GetIndex() const {
	return m_nIndex;
}
AFX_INLINE void CXTPChartAxis::SetIndex(int nIndex) {
	m_nIndex = nIndex;
	OnChartChanged();
}

AFX_INLINE CXTPChartAxisView* CXTPChartAxis::GetAxisView() const {
	return m_pAxisView;
}
