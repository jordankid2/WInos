...
CXTPChartDeviceCommand* CXTPChartLegendView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand* pDeviceCommand = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(m_pLegend, m_rcBounds);
	...
	for (int nColumn = 0; nColumn < nColumnCount; nColumn++)
	{
		...
		for (int nRow = 0; nRow < nRowCount; nRow++)
		{
			...
			CXTPChartLegendItemView* pItem = m_arrItems[i];
...
void CXTPChartLegendView::AddItem(CXTPChartLegendItemView* pItem)
{
