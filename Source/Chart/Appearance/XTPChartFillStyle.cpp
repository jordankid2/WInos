...
CXTPChartDeviceCommand* CXTPChartFillStyle::CreateDeviceCommand(const CXTPChartRectF& bounds, const CXTPChartColor& color, const CXTPChartColor& color2)
{
	...
	{
		return CXTPChartDrawingObjectFactory::Create2dHatchRectangleDeviceCommand(bounds, color, color2, m_nHatchStyle);
	}
	...
	if (m_nFillMode == xtpChartFillGradient)
	{
		switch(m_nGradientAngle)
		{
			case xtpChartGradientAngle180:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color, color2, xtpChartLinearGradientModeVertical);

			case xtpChartGradientAngle0:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color2, color, xtpChartLinearGradientModeVertical);

			case xtpChartGradientAngle90:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color, color2, xtpChartLinearGradientModeHorizontal);

			case xtpChartGradientAngle270:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color2, color, xtpChartLinearGradientModeHorizontal);

			case xtpChartGradientAngle135:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color, color2, xtpChartLinearGradientModeForwardDiagonal);

			case xtpChartGradientAngle315:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color2, color, xtpChartLinearGradientModeForwardDiagonal);

			case xtpChartGradientAngle225:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color2, color, xtpChartLinearGradientModeBackwardDiagonal);

			case xtpChartGradientAngle45:
				return CXTPChartDrawingObjectFactory::Create2dGradientRectangleDeviceCommand(bounds, color, color2, xtpChartLinearGradientModeBackwardDiagonal);
		}
	}
...
CXTPChartDeviceCommand* CXTPChartFillStyle::CreateCircleDeviceCommand(const CXTPChartPointF& center, double radius, const CXTPChartColor& color, const CXTPChartColor& color2)
{
	if (m_nFillMode == xtpChartFillSolid)
	{
		return CXTPChartDrawingObjectFactory::Create2dSolidCircleDeviceCommand(center, radius, color);
	}

	if (m_nFillMode == xtpChartFillHatch)
	{
		return CXTPChartDrawingObjectFactory::Create2dHatchCircleDeviceCommand(center, radius, color, color2, m_nHatchStyle);
	}
	...
	if (m_nFillMode == xtpChartFillGradient)
	{
		...
		{
		case xtpChartGradientAngle180:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color, color2, xtpChartLinearGradientModeVertical);

		case xtpChartGradientAngle0:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color2, color, xtpChartLinearGradientModeVertical);

		case xtpChartGradientAngle90:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color, color2, xtpChartLinearGradientModeHorizontal);

		case xtpChartGradientAngle270:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color2, color, xtpChartLinearGradientModeHorizontal);

		case xtpChartGradientAngle135:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color, color2, xtpChartLinearGradientModeForwardDiagonal);

		case xtpChartGradientAngle315:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color2, color, xtpChartLinearGradientModeForwardDiagonal);

		case xtpChartGradientAngle225:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color2, color, xtpChartLinearGradientModeBackwardDiagonal);

		case xtpChartGradientAngle45:
			return CXTPChartDrawingObjectFactory::Create2dGradientCircleDeviceCommand(center, radius, color, color2, xtpChartLinearGradientModeBackwardDiagonal);
		}
	}
...
{
	return CXTPChartDrawingObjectFactory::Create2dSolidSplinePolygonDeviceCommand(arrPoints, color, bTwoSides);
}
...
CXTPChartDeviceCommand* CXTPChartFillStyle::CreateDeviceCommand(const CXTPChartPoints& arrPoints, const CXTPChartColor& color, const CXTPChartColor& color2)
{
	...
	if (m_nFillMode == xtpChartFillHatch)
	{
		return CXTPChartDrawingObjectFactory::Create2dHatchPolygonDeviceCommand(arrPoints, color, color2, m_nHatchStyle);
	}
	...
	if (m_nFillMode == xtpChartFillGradient)
	{
		...
		{
		case xtpChartGradientAngle180:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color, color2, xtpChartLinearGradientModeVertical);

		case xtpChartGradientAngle0:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color2, color, xtpChartLinearGradientModeVertical);

		case xtpChartGradientAngle90:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color, color2, xtpChartLinearGradientModeHorizontal);

		case xtpChartGradientAngle270:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color2, color, xtpChartLinearGradientModeHorizontal);

		case xtpChartGradientAngle135:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color, color2, xtpChartLinearGradientModeForwardDiagonal);

		case xtpChartGradientAngle315:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color2, color, xtpChartLinearGradientModeForwardDiagonal);

		case xtpChartGradientAngle225:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color2, color, xtpChartLinearGradientModeBackwardDiagonal);

		case xtpChartGradientAngle45:
			return CXTPChartDrawingObjectFactory::Create2dGradientPolygonDeviceCommand(arrPoints, color, color2, xtpChartLinearGradientModeBackwardDiagonal);
		}
	}
	return NULL;
}
		...
		if (strFillMode.CompareNoCase(_T("Gradient")) == 0)
		{
			...
			for (int i = 0; i < _countof(lpszGradientAngle); i++)
			{
				if (strGradientAngle.CompareNoCase(lpszGradientAngle[i]) == 0)
				{
					...
					case 4: m_nGradientAngle = xtpChartGradientAngle135;	break;  // TopLeftToBottomRight
					case 5: m_nGradientAngle = xtpChartGradientAngle315;	break;  // BottomRightToTopLeft
					case 6: m_nGradientAngle = xtpChartGradientAngle225;	break;  // TopRightToBottomLeft
					case 7: m_nGradientAngle = xtpChartGradientAngle45;		break;  // BottomLeftToTopRight
					default:
							m_nGradientAngle = xtpChartGradientAngle0;				// BottomToTop
					}
