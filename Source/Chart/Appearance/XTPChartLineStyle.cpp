...
CXTPChartDeviceCommand* CXTPChartLineStyle::CreateDeviceCommand(const CXTPChartPointF& point1, const CXTPChartPointF& point2, const CXTPChartColor& color)
{
	...
	if (m_nDashStyle == xtpChartDashStyleSolid)
		return CXTPChartDrawingObjectFactory::Create2dSolidLineDeviceCommand(point1, point2, color, m_nThickness);

	return CXTPChartDrawingObjectFactory::Create2dDashedLineDeviceCommand(point1, point2, color, m_nThickness, m_nDashStyle, m_arrDashArray);
}
...
CXTPChartDeviceCommand* CXTPChartLineStyle::CreateDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color)
{
	...
	if (m_nDashStyle == xtpChartDashStyleSolid)
		return CXTPChartDrawingObjectFactory::Create2dSolidPolylineDeviceCommand(points, color, m_nThickness);

	return CXTPChartDrawingObjectFactory::Create2dDashedPolylineDeviceCommand(points, color, m_nThickness, m_nDashStyle, m_arrDashArray);
}
...
CXTPChartDeviceCommand* CXTPChartLineStyle::CreateSplineDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color)
{
	...
	if (m_nDashStyle == xtpChartDashStyleSolid)
		return CXTPChartDrawingObjectFactory::Create2dSolidSplineDeviceCommand(points, color, m_nThickness);

	return CXTPChartDrawingObjectFactory::Create2dDashedSplineDeviceCommand(points, color, m_nThickness, m_nDashStyle, m_arrDashArray);
}
