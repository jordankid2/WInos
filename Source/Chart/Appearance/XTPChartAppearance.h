...
public:
	CXTPPoint3f LightPosition; // Light position vector, each component is a normalized value in range [0..1].
	...
	static const CXTPPoint3f DefaultLightPosition; // Default light position vector, each component is a normalized value in range [0..1].
	...
	static const float DefaultMaterialShininess; // Default material shininess factor in range [0..1].
};
...
protected:
	...
	CXTPChartDiagram3DAppearance* m_pDiagram3DAppearance;         // Pointer to chart diagram 3d appearance object.
