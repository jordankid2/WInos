...
CXTPChartPieDeviceCommandImpl::CXTPChartPieDeviceCommandImpl(const CXTPPoint3d& center, double dMajorSemiAxis, 
	double dMinorSemiAxis, double dStartAngle, double dSweepAngle, double depth, double nHolePercent)
{
	m_ptCenter = center;
...
CXTPChartPieDeviceCommand::CXTPChartPieDeviceCommand(const CXTPPoint3d& ptCenter, double dMajorSemiAxis,
	double dMinorSemiAxis, double dStartAngle, double dSweepAngle, double dDepth, double nHolePercent)
	: CXTPChartPieDeviceCommandImpl(ptCenter, dMajorSemiAxis,
		dMinorSemiAxis, dStartAngle, dSweepAngle, dDepth, nHolePercent)
{
}
...
CXTPChart3dPieDeviceCommand::CXTPChart3dPieDeviceCommand(XTPChart3dAntialiasingPolicy nAntialiasingPolicy,
	const CXTPPoint3d& ptCenter, double dMajorSemiAxis, double dMinorSemiAxis, double dStartAngle,
	double dSweepAngle, double dDepth, double nHolePercent)
