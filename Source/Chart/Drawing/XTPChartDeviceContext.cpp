...
CXTPChartDeviceContext::CXTPChartDeviceContext(CXTPChartContainer* pContainer, HDC hDC, BOOL bIs3D, CXTPChartDrawingObjectFactory* pDrawingObjectFactory)
...
CXTPChart3dDeviceContext::CXTPChart3dDeviceContext(CXTPChartContainer* pContainer, HDC hDC, 
...
void CXTPChart3dDeviceContext::OnUpdateCameraState(const CXTPPoint3f& ptPosition,
	const CXTPPoint3f& ptFocal, const CXTPPoint3f& ptUpVector)
{
