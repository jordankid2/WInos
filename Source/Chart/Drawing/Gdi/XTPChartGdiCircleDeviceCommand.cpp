...
CXTPChartGdiSolidCircleDeviceCommand::CXTPChartGdiSolidCircleDeviceCommand(const CXTPChartPointF& center, double radius, const CXTPChartColor& color)
...
void CXTPChartGdiSolidCircleDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipFillEllipse(pGdiDC->GetGraphics(), pGpBrush, (REAL)(m_center.X - m_radius), (REAL)(m_center.Y - m_radius), (REAL)(m_radius * 2), (REAL)(m_radius * 2));
...
CXTPChartGdiGradientCircleDeviceCommand::CXTPChartGdiGradientCircleDeviceCommand(const CXTPChartPointF& center, double radius, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartLinearGradientMode nMode)
	: CXTPChartCircleDeviceCommand(center, radius)
{
	m_color = color;
	m_color2 = color2;
...
CXTPChartGdiHatchCircleDeviceCommand::CXTPChartGdiHatchCircleDeviceCommand(const CXTPChartPointF& center, double radius, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartHatchStyle nStyle)
	: CXTPChartCircleDeviceCommand(center, radius)
{
	m_color = color;
	m_color2 = color2;
...
CXTPChartGdiBoundedCircleDeviceCommand::CXTPChartGdiBoundedCircleDeviceCommand(const CXTPChartPointF& center, double radius, const CXTPChartColor& color, int thickness)
...
void CXTPChartGdiBoundedCircleDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipDrawEllipse(pGdiDC->GetGraphics(), pGpPen, (REAL)(m_center.X - m_radius), (REAL)(m_center.Y - m_radius), (REAL)(m_radius * 2), (REAL)(m_radius * 2));
