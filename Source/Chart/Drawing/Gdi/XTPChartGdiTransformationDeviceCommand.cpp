...
CXTPChartGdiRotateDeviceCommand::CXTPChartGdiRotateDeviceCommand(float fAngle, const CXTPPoint3d& rotateVector)
...
void CXTPChartGdiTranslateDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipTranslateWorldTransform(pGdiDC->GetGraphics(), (float)m_dx, (float)m_dy, MatrixOrderPrepend);
}

CXTPChartElement* CXTPChartGdiTranslateDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
...
void CXTPChartGdiClipDeviceCommand::BeforeExecute(CXTPChartDeviceContext* pDC)
{
	...
	GdipSetClipRectI(pGdiDC->GetGraphics(), m_rcClip.left, m_rcClip.top, m_rcClip.Width(), m_rcClip.Height(), CombineModeIntersect);
}
...
void CXTPChartGdiClipDeviceCommand::AfterExecute(CXTPChartDeviceContext* pDC)
{
	...
	GdipSetClipRectI(pGdiDC->GetGraphics(), m_rcState.left, m_rcState.top, m_rcState.Width(), m_rcState.Width(), CombineModeReplace);
}

//////////////////////////////////////////////////////////////////////////
// CXTPChartGdiClipRegionDeviceCommand

CXTPChartGdiClipRegionDeviceCommand::CXTPChartGdiClipRegionDeviceCommand(const CXTPChartPoints& points)
{
	GpPath* pGpPath = NULL;
