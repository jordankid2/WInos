...
CXTPChartGdiSolidLineDeviceCommand::CXTPChartGdiSolidLineDeviceCommand(const CXTPPoint2f& p1, const CXTPPoint2f& p2, const CXTPChartColor& color, int thickness)
...
void CXTPChartGdiSolidLineDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipDrawLine(pGdiDC->GetGraphics(), pGpPen, (REAL)m_p1.X, (REAL)m_p1.Y, (REAL)m_p2.X, (REAL)m_p2.Y);
...
CXTPChartGdiDashedLineDeviceCommand::CXTPChartGdiDashedLineDeviceCommand(const CXTPPoint2f& p1, const CXTPPoint2f& p2,
...
CXTPChartGdiSolidPolylineDeviceCommand::CXTPChartGdiSolidPolylineDeviceCommand(const CXTPChartPoints& p, const CXTPChartColor& color, int thickness)
...
CXTPChartGdiDashedPolylineDeviceCommand::CXTPChartGdiDashedPolylineDeviceCommand(const CXTPChartPoints& p, const CXTPChartColor& color,
...
CXTPChartGdiSplineDeviceCommand::CXTPChartGdiSplineDeviceCommand(const CXTPChartPoints& p, int thickness)
	: CXTPChartSplineDeviceCommand(p, thickness)
{
}

CXTPChartElement* CXTPChartGdiSplineDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
	GpPath* pGpPath;
...
CXTPChartGdiSolidSplineDeviceCommand::CXTPChartGdiSolidSplineDeviceCommand(const CXTPChartPoints& p, const CXTPChartColor& color, int thickness)
	: CXTPChartSplineDeviceCommand(p, thickness)
{
	m_color = color;
}
...
CXTPChartGdiDashedSplineDeviceCommand::CXTPChartGdiDashedSplineDeviceCommand(const CXTPChartPoints& p, const CXTPChartColor& color,
	int thickness, XTPChartDashStyle nDashStyle, const CXTPChartLineDashArray& arrDashArray)
	: CXTPChartSplineDeviceCommand(p, thickness)
{
	m_color = color;
