...
CXTPChartGdiBoundedTextDeviceCommand::CXTPChartGdiBoundedTextDeviceCommand(const CXTPChartString& strText, CXTPChartFont* pFont, const CXTPChartColor& color, const CXTPChartRectF& rectangle)
...
void CXTPChartGdiBoundedTextDeviceCommand::ExecuteInternal(CXTPChartDeviceContext* pDC)
{
	...
	GdipDrawString(pGdiDC->GetGraphics(), XTP_CT2CW(m_strText), -1, pGpFont, (RectF*)&m_rect, pGpStringFormat, pGpBrush);
...
CXTPChartGdiTextAntialiasingDeviceCommand::CXTPChartGdiTextAntialiasingDeviceCommand(BOOL bAntialias /* = TRUE */)
...
void CXTPChartGdiTextAntialiasingDeviceCommand::BeforeExecute(CXTPChartDeviceContext* pDC)
{
	...
	GdipSetTextRenderingHint(pGdiDC->GetGraphics(), m_bAntiAlias ? TextRenderingHintAntiAlias : TextRenderingHintSystemDefault);
}
...
CXTPChartGdiMarkupElementDeviceCommand::CXTPChartGdiMarkupElementDeviceCommand(CXTPMarkupUIElement* pMarkupUIElement, CXTPChartFont* pFont, const CXTPChartColor& color, const CXTPChartRectF& rectangle)
...
CXTPChartElement* CXTPChartGdiMarkupElementDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
