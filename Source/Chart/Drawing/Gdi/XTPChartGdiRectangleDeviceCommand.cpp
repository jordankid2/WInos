...
CXTPChartGdiBoundedRectangleDeviceCommand::CXTPChartGdiBoundedRectangleDeviceCommand(const CXTPChartRectF& rect, const CXTPChartColor& color, int thickness)
...
void CXTPChartGdiBoundedRectangleDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipDrawRectangle(pGdiDC->GetGraphics(), pGpPen, m_rect.X, m_rect.Y, m_rect.Width, m_rect.Height);
...
CXTPChartGdiInnerBorderDeviceCommand::CXTPChartGdiInnerBorderDeviceCommand(const CXTPChartRectF& rect, const CXTPChartColor& color, int thickness)
...
CXTPChartGdiSolidRectangleDeviceCommand::CXTPChartGdiSolidRectangleDeviceCommand(const CXTPChartRectF& rect, const CXTPChartColor& color)
	: CXTPChartRectangleDeviceCommand(rect)
	, m_color(color)
{
}
...
void CXTPChartGdiSolidRectangleDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipFillRectangle(pGdiDC->GetGraphics(), pGpBrush, m_rect.X, m_rect.Y, m_rect.Width, m_rect.Height);
...
CXTPChartGdiGradientRectangleDeviceCommand::CXTPChartGdiGradientRectangleDeviceCommand(const CXTPChartRectF& rect, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartLinearGradientMode nMode)
	: CXTPChartRectangleDeviceCommand(rect)
	, m_color(color)
	, m_color2(color2)
	, m_nMode(nMode)
...
CXTPChartGdiHatchRectangleDeviceCommand::CXTPChartGdiHatchRectangleDeviceCommand(const CXTPChartRectF& rect, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartHatchStyle nStyle)
	: CXTPChartRectangleDeviceCommand(rect)
	, m_color(color)
	, m_color2(color2)
	, m_nStyle(nStyle)
