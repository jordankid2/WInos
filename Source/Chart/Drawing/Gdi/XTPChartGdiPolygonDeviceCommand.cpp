...
CXTPChartElement* CXTPChartGdiPolygonDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
...
CXTPChartGdiSolidPolygonDeviceCommand::CXTPChartGdiSolidPolygonDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color)
...
void CXTPChartGdiSolidPolygonDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipFillPolygon(pGdiDC->GetGraphics(), pGpBrush, (PointF*)m_points.GetData(), (int)m_points.GetSize(), FillModeAlternate);
...
CXTPChartGdiGradientPolygonDeviceCommand::CXTPChartGdiGradientPolygonDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartLinearGradientMode nMode)
	: CXTPChartGdiPolygonDeviceCommand(points)
{
	m_color = color;
	m_color2 = color2;
...
CXTPChartGdiHatchPolygonDeviceCommand::CXTPChartGdiHatchPolygonDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color, const CXTPChartColor& color2, XTPChartHatchStyle nStyle)
	: CXTPChartGdiPolygonDeviceCommand(points)
{
	m_color = color;
	m_color2 = color2;
...
CXTPChartGdiSolidSplinePolygonDeviceCommand::CXTPChartGdiSolidSplinePolygonDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color, BOOL bTwoSides)
...
CXTPChartElement* CXTPChartGdiSolidSplinePolygonDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
	BOOL bResult = FALSE;
...
CXTPChartGdiBoundedPolygonDeviceCommand::CXTPChartGdiBoundedPolygonDeviceCommand(const CXTPChartPoints& points, const CXTPChartColor& color, int thickness)
...
void CXTPChartGdiBoundedPolygonDeviceCommand::ExecuteOverride(CXTPChartDeviceContext* pDC)
{
	...
	GdipDrawPolygon(pGdiDC->GetGraphics(), pGpPen, (PointF*)m_points.GetData(), (int)m_points.GetSize());
...
CXTPChartGdiPolygonAntialiasingDeviceCommand::CXTPChartGdiPolygonAntialiasingDeviceCommand(BOOL bAntiAlias)
...
void CXTPChartGdiPolygonAntialiasingDeviceCommand::BeforeExecute(CXTPChartDeviceContext* pDC)
{
	...
	GdipSetSmoothingMode(pGdiDC->GetGraphics(), m_bAntiAlias ? SmoothingModeHighQuality : SmoothingModeDefault);
}
