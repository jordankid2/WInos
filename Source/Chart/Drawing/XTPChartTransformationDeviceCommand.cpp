...
CXTPChartElement* CXTPChart3dRotateDeviceCommand::HitTest(CPoint point, CXTPChartElement* pParent) const
{
...
CXTPChart3dTranslateDeviceCommand::CXTPChart3dTranslateDeviceCommand(double dx, double dy, double dz)
	: CXTPChart3dDeviceCommand(xtpChart3dAntialiasingPolicyDefault)
{
	m_dx = dx;
	m_dy = dy;
