...
CXTPChartOpenGLRotateDeviceCommand::CXTPChartOpenGLRotateDeviceCommand(const CXTPChart3dRotation& rotation)
...
CXTPChartOpenGLTranslateDeviceCommand::CXTPChartOpenGLTranslateDeviceCommand(double dx, double dy, double dz)
