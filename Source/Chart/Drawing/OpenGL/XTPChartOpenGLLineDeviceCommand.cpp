...
CXTPChartOpenGLSolidLineDeviceCommand::CXTPChartOpenGLSolidLineDeviceCommand(const CXTPPoint3d& p1, const CXTPPoint3d& p2, const CXTPChartColor& color, int thickness)
