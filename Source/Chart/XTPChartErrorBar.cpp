...
CXTPChartDeviceCommand* CXTPChartErrorBarView::CreateDeviceCommand(CXTPChartDeviceContext* pDC)
{
	...
	CXTPChartDeviceCommand *pCommand = CXTPChartDrawingObjectFactory::Create2dHitTestElementCommand(m_pErrorBar);

	CXTPChartDiagram2DSeriesView *pSeriesView =
		static_cast<CXTPChartDiagram2DSeriesView*>(m_pPointView->GetSeriesView());

	CXTPChartDiagram2D *pDiagram =
		static_cast<CXTPChartDiagram2D*>(pSeriesView->GetDiagram());
...
double CXTPChartErrorBarView::GetAnchorAngle(XTPChartErrorBarPosition position) const
{
	...
	CXTPChartDiagram2D *pDiagram =
		static_cast<CXTPChartDiagram2D*>(pView->GetDiagram());
