...
CXTPChart3dPie::CXTPChart3dPie(double dStartAngle, double dFinishAngle, const CXTPChartEllipse& ellipse, int nDepthPercent, int nHolePercent)
...
CXTPChartDeviceCommand* CXTPChart3dPie::CreatePieDeviceCommand(const CXTPChartColor& color, const CXTPChartColor& color2, const CXTPChartPointF& basePoint)
{
	...
	return CXTPChartDrawingObjectFactory::Create3dGradientPieDeviceCommand(center, m_ellipse.m_dMajorSemiaxis,
...
CXTPChartDeviceCommand* CXTPChart3dPie::CreateBoundedPieDeviceCommand(const CXTPChartColor& color, int nThickness, const CXTPChartPointF& basePoint)
{
	// Not supported in 3D.
