...
INTERFACE_PART(CXTPChartTitle, XTPDIID_ChartTitle, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartTitle, XTPDIID_ChartTitle)
...
INTERFACE_PART(CXTPChartTitleCollection, XTPDIID_ChartTitleCollection, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPChartTitleCollection, XTPDIID_ChartTitleCollection)
