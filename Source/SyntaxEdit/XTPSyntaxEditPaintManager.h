...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontLineNumber, m_xtpFontLineNumber, GetLineNumberFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontToolTip, m_xtpFontToolTip, GetToolTipFontHandle);
