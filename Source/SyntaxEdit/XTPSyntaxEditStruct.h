...
struct _XTP_EXT_CLASS XTP_EDIT_LINECOL
{
	...
	//----------------------------------------------------------------------
	static const XTP_EDIT_LINECOL AFX_CDECL min2(const XTP_EDIT_LINECOL& pos1, const XTP_EDIT_LINECOL& pos2);
	static const XTP_EDIT_LINECOL AFX_CDECL max2(const XTP_EDIT_LINECOL& pos1, const XTP_EDIT_LINECOL& pos2); // <COMBINE XTP_EDIT_LINECOL::min2@const XTP_EDIT_LINECOL&@const XTP_EDIT_LINECOL&>
