...
const XTP_EDIT_LINECOL AFX_CDECL XTP_EDIT_LINECOL::MakeLineCol(int nParamLine, int nParamCol)
{
...
const XTP_EDIT_LINECOL AFX_CDECL XTP_EDIT_LINECOL::min2(const XTP_EDIT_LINECOL& pos1, const XTP_EDIT_LINECOL& pos2)
{
...
const XTP_EDIT_LINECOL AFX_CDECL XTP_EDIT_LINECOL::max2(const XTP_EDIT_LINECOL& pos1, const XTP_EDIT_LINECOL& pos2)
{
	XTP_EDIT_LINECOL lcPos;
