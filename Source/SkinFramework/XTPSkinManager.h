...
public:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntCaption, m_xtpFontCaption, GetCaptionFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntMenu, m_xtpFontMenu, GetMenuFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntSmCaption, m_xtpFontSmCaption, GetSmCaptionFontHandle);
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED_(HBRUSH, HBRUSH, HBRUSH, m_brushDialog, m_xtpBrushDialog, GetDialogBrushHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED_(HBRUSH, HBRUSH, HBRUSH, m_brushTabControl, m_xtpBrushTabControl, GetTabControlBrushHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED_(HBRUSH, HBRUSH, HBRUSH, m_brushWindow, m_xtpBrushWindow, GetWindowBrushHandle);
...
{
	friend class CXTPSingleton<CXTPSkinManager, CXTPSingletonDependencies<
...
protected:
	...
	CXTPRWCriticalSection m_csPersistentModuleCache; // Synchronization primitive for persistent module info cache access.
	...
	CArray<PERSISTENT_IMPORT_INFO, PERSISTENT_IMPORT_INFO&> m_arPersistentModuleCache; // Persistent module info cache.
