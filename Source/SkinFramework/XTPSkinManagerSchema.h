...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves resource file object
	// Returns:
	//     Pointer to CXTPSkinManagerResourceFile object
	//-----------------------------------------------------------------------
	CXTPSkinManagerResourceFile* GetResourceFile() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves metrics object
	// Returns:
	//     Pointer to CXTPSkinManagerMetrics object
	//-----------------------------------------------------------------------
...
//{{AFX_CODEJOCK_PRIVATE
	...
	CXTPSkinManagerClass* GetClassFromThemeHandle(HTHEME hTheme);
