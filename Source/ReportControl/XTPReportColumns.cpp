...
BEGIN_DISPATCH_MAP(CXTPReportColumns, CXTPCmdTarget)
	DISP_FUNCTION_ID(CXTPReportColumns, "Count", dispidCount, OleGetItemCount, VT_I4, VTS_NONE)
	DISP_FUNCTION_ID(CXTPReportColumns, "Column", DISPID_VALUE, OleGetItem, VT_DISPATCH, VTS_I4)
	DISP_FUNCTION_ID(CXTPReportColumns, "_NewEnum", DISPID_NEWENUM, OleNewEnum, VT_UNKNOWN, VTS_NONE)
	DISP_FUNCTION_ID(CXTPReportColumns, "Add", dispidAdd, OleAdd, VT_DISPATCH, VTS_I4 VTS_BSTR VTS_I4 VTS_BOOL)
	DISP_FUNCTION_ID(CXTPReportColumns, "AddEx", dispidAddEx, OleAddEx, VT_DISPATCH, VTS_I4 VTS_BSTR VTS_BSTR VTS_I4 VTS_BOOL)
	DISP_FUNCTION_ID(CXTPReportColumns, "Find", dispidFindColumn, OleFindColumn, VT_DISPATCH, VTS_I4)
	DISP_FUNCTION_ID(CXTPReportColumns, "DeleteAll", 5, Clear, VT_EMPTY, VTS_NONE)

END_DISPATCH_MAP()

BEGIN_INTERFACE_MAP(CXTPReportColumns, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportColumns, XTPDIID_IReportColumns, Dispatch)
	//INTERFACE_PART(CXTPReportColumns, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportColumns, XTPDIID_IReportColumns)


int CXTPReportColumns::OleGetItemCount()
{
	return GetCount();
}

LPDISPATCH CXTPReportColumns::OleGetItem(long nIndex)
{
	if (nIndex >= 0 && nIndex < GetCount())
	{
...
IMPLEMENT_ENUM_VARIANT(CXTPReportColumns)


LPDISPATCH CXTPReportColumns::OleAdd(long nId, LPCTSTR strCaption, int nWidth, BOOL bAutoSize)
{
	CXTPReportColumn* pColumn = new CXTPReportColumn(nId, strCaption, nWidth, bAutoSize);
	Add(pColumn);

	return pColumn->GetIDispatch(TRUE);
}

LPDISPATCH CXTPReportColumns::OleAddEx(long nId, LPCTSTR strCaption, LPCTSTR strInternalName, int nWidth, BOOL bAutoSize)
{
	CXTPReportColumn* pColumn = new CXTPReportColumn(nId, strCaption, strInternalName, nWidth, bAutoSize);
	Add(pColumn);

	return pColumn->GetIDispatch(TRUE);
}

LPDISPATCH CXTPReportColumns::OleFindColumn(long nId)
{
	CXTPReportColumn* pColumn = Find(nId);
	return pColumn ? pColumn->GetIDispatch(TRUE) : NULL;
}

//////////////////////////////////////////////////////////////////////////

BEGIN_DISPATCH_MAP(CXTPReportColumnOrder, CXTPCmdTarget)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "Count", dispidCount, OleGetItemCount, VT_I4, VTS_NONE)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "_NewEnum", DISPID_NEWENUM, OleNewEnum, VT_UNKNOWN, VTS_NONE)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "Column", DISPID_VALUE, OleGetItem, VT_DISPATCH, VTS_I4)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "Add", 2, OleAdd, VT_EMPTY, VTS_DISPATCH)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "DeleteAll", 5, Clear, VT_EMPTY, VTS_NONE)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "IndexOf", 6, OleIndexOf, VT_I4, VTS_DISPATCH)
	DISP_FUNCTION_ID(CXTPReportColumnOrder, "RemoveAt", 7, RemoveAt, VT_EMPTY, VTS_I4)
END_DISPATCH_MAP()

BEGIN_INTERFACE_MAP(CXTPReportColumnOrder, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportColumnOrder, XTPDIID_IReportColumnOrder, Dispatch)
	//INTERFACE_PART(CXTPReportColumnOrder, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportColumnOrder, XTPDIID_IReportColumnOrder)

int CXTPReportColumnOrder::OleGetItemCount()
{
	return GetCount();
}

LPDISPATCH CXTPReportColumnOrder::OleGetItem(long nIndex)
{
	if (nIndex >= 0 && nIndex < GetCount())
	{
		return GetAt(nIndex)->GetIDispatch(TRUE);
...
void CXTPReportColumnOrder::OleAdd(LPDISPATCH lpColumn)
{
	CXTPReportColumn* pColumn = CXTPReportColumn::FromDispatch(lpColumn);
...
int CXTPReportColumnOrder::OleIndexOf(LPDISPATCH lpColumn)
{
	CXTPReportColumn* pColumn = CXTPReportColumn::FromDispatch(lpColumn);
...
IMPLEMENT_ENUM_VARIANT(CXTPReportColumnOrder)
