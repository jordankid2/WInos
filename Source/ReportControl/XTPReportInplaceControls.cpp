...
BEGIN_INTERFACE_MAP(CXTPReportInplaceButton, CCmdTarget)
	INTERFACE_PART(CXTPReportInplaceButton, XTPDIID_IReportInplaceButton, Dispatch)
	XTP_DECLARE_CMDTARGETPROVIDER_INTERFACE_PART(CXTPReportInplaceButton)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportInplaceButton, XTPDIID_IReportInplaceButton)
XTP_IMPLEMENT_CMDTARGETPROVIDER_INTERFACE(CXTPReportInplaceButton)
