...
class _XTP_EXT_CLASS CXTPReportRecordMergeItems 
	: public CMap<CXTPReportRecordItem*, CXTPReportRecordItem*, CXTPReportRecordMergeItem, CXTPReportRecordMergeItem&>
{
