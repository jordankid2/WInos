...
BEGIN_DISPATCH_MAP(CXTPReportNavigator, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPReportNavigator, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportNavigator, XTPDIID_IReportNavigator, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportNavigator, XTPDIID_IReportNavigator)
