...
public:
	...
	//     bDeselectIfSelected - BOOL flag to deselected rows if all rows in new 
	//					selection [nIndexBegin:nIndexEnd] were selected before.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     ib  - First row index of block to be deselected.
	//     ie  - Last  row index of block to be deselected.
	//     bCollapsed - BOOL flag to note that rows was deleted or collapsed. 
	//                  If TRUE selection which below deselection should be moved upward.
	// See Also: CXTPReportSelectedRows overview, Add, Select, Clear, Contains, Remove
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get type of selected rows (i.e. body, header, or footer).
	// Returns:
	//     XTPReportRowType value. Type of selected rows.
	//-----------------------------------------------------------------------
...
AFX_INLINE XTPReportRowType CXTPReportSelectedRows::GetRowType() const
{
	return m_nRowType;
}
