...
struct XTP_REPORTRECORDITEM_METRICS : public CXTPCmdTarget
{
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntMetrics, m_xtpFontMetrics, GetMetricsFontHandle);
	//}}AFX_CODEJOCK_PRIVATE
#endif
...
//===========================================================================
class _XTP_EXT_CLASS CXTPReportRecordItem : public CXTPHeapObjectT<CXTPCmdTarget, CXTPReportDataAllocator>
{
...
public:
	...
	virtual int CompareGroupCaption(CXTPReportColumn* pColumn, CXTPReportGroupRow* pGroupRow); // <combine CXTPReportRecordItem::CompareGroupCaption@CXTPReportColumn* pColumn@CXTPReportRecordItem*>
