...
BEGIN_INTERFACE_MAP(CXTPReportBehaviorRowMouseButton, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportBehaviorRowMouseButton, XTPDIID_IReportBehaviorRowMouseButton, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportBehaviorRowMouseButton, XTPDIID_IReportBehaviorRowMouseButton)
