...
BEGIN_INTERFACE_MAP(CXTPReportBehaviorRowModifier, CXTPCmdTarget)
	INTERFACE_PART(CXTPReportBehaviorRowModifier, XTPDIID_IReportBehaviorRowModifier, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPReportBehaviorRowModifier, XTPDIID_IReportBehaviorRowModifier)
