...
enum  XTPReportElementRect
{
	...
	xtpReportElementRectHeaderRecordsDividerArea, // The area occupied by the header records divider.
	xtpReportElementRectFooterRecordsDividerArea, // The area occupied by the footer records divider.
};
...
public:
	...
	//                          The value must not be scaled to DPI and must be in the range 1-10000.
...
protected:
	...
	int m_nDragSensitivityX;                            // Horizontal sensitivity of Drag'n'Drop operation in pixels. Default value is 3. DPI aware.
	int m_nDragSensitivityY;                            // Vertical sensitivity of Drag'n'Drop operation in pixels. Default value is 3. DPI aware.
