...
BEGIN_DISPATCH_MAP(CXTPTrackUndoManager, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPTrackUndoManager, CXTPCmdTarget)
INTERFACE_PART(CXTPTrackUndoManager, XTPDIID_TrackUndoManager, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPTrackUndoManager, XTPDIID_TrackUndoManager)
