...
void CXTPTrackThemeOffice2013::RefreshMetrics()
{
    ...
    m_clrWorkArea				 = XTPIniColor(_T("ReportControl.TrackControl"), _T("WorkArea"),				RGB(250, 250, 250));
    m_clrTrackHeader			 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackHeader"),			    RGB(255, 255, 255));
    m_clrTrackTimeArea			 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackTimeArea"),		    RGB(255, 255, 255));
    m_clrTimeHeaderDarkDark		 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeHeaderDarkDark"),	    RGB(225, 225, 225));
    m_clrTimeHeaderDark			 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeHeaderDark"),		    RGB(243, 243, 243));
    m_clrTimeSliderBackground	 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeSliderBackground"),    RGB(243, 243, 243));
    m_clrTimeHeaderDivider		 = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeHeaderDivider"),	    RGB(225, 225, 225));
    ...
    m_clrMarker					 = XTPIniColor(_T("ReportControl.TrackControl"), _T("Marker"),				    RGB(247, 168, 171));
    m_clrSelectedArea			 = XTPIniColor(_T("ReportControl.TrackControl"), _T("SelectedArea"),			RGB( 43,  87, 154));
	m_clrTimeLineTick            = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeLineTick"),            RGB( 35,  35,  35));
	m_clrMarkerBorder            = XTPIniColor(_T("ReportControl.TrackControl"), _T("MarkerBorder"),            RGB( 43,  90, 127));
	m_clrMarkerBack              = XTPIniColor(_T("ReportControl.TrackControl"), _T("MarkerBack"),              RGB(153, 192, 231));
	m_clrTrackMarkerBorder       = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackMarkerBorder"),       RGB(  0,   0,   0));
	m_clrTrackMarkerText         = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackMarkerText"),         RGB(  0,   0,   0));
	m_clrTrackMarkerTextBack     = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackMarkerTextBack"),     RGB(255, 255, 255));
	m_clrTrackMarkerTextBorder   = XTPIniColor(_T("ReportControl.TrackControl"), _T("TrackMarkerTextBorder"),   RGB(123, 123, 123));
	m_clrTimeLinePosition        = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeLinePosition"),        RGB(205,   0,   0));
	m_clrTimeHeaderBorder        = XTPIniColor(_T("ReportControl.TrackControl"), _T("TimeHeaderBorder"),        RGB( 35,  35,  35));
	m_clrScrollBarBorderDark     = XTPIniColor(_T("ReportControl.TrackControl"), _T("ScrollBarBorderDark"),     RGB(  0,   0,   0));
	m_clrScrollBarBorderLight    = XTPIniColor(_T("ReportControl.TrackControl"), _T("ScrollBarBorderLight"),    RGB(155, 155, 155));
	m_clrWorkAreaScrollBarLight  = XTPIniColor(_T("ReportControl.TrackControl"), _T("WorkAreaScrollBarLight"),  RGB(153, 192, 231));
	m_clrWorkAreaScrollBarDark   = XTPIniColor(_T("ReportControl.TrackControl"), _T("WorkAreaScrollBarDark"),   RGB( 27, 102, 157));
	m_clrWorkAreaScrollBarBorder = XTPIniColor(_T("ReportControl.TrackControl"), _T("WorkAreaScrollBarBorder"), RGB( 43,  90, 127));
...
int CXTPTrackThemeOffice2013::DrawTrackBlock(CDC* pDC, CRect rc, BOOL bSelected, CXTPTrackBlock* pTrackBlock)
{
	if (!pTrackBlock)
		return 0;
	...
	else if (bSelected)
	{
		...
		CXTPDrawHelpers::DrawColorRect(
			pDC, CRect(x,y,x+XTP_DPI_X(6),y+XTP_DPI_Y(5)), m_clrTrackMarkerTextBack, m_clrSelectedBorder);
