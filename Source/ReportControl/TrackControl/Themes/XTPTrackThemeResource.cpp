...
void CXTPTrackThemeResource::DrawPlainColumnBackground(CDC* pDC, CRect rcColumn)
{
...
void CXTPTrackThemeResource::DrawColumnText(CDC* pDC, CRect rcText, CString strCaption, int nHeaderAlignment, BOOL bIsHeader, BOOL bColumnPressed)
{
