// XTPTrackThemeOffice2003Luna.cpp : implementation of the CXTPTrackPaintManager class.
//
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPTrackThemeOffice2003Luna
/////////////////////////////////////////////////////////////////////////////

CXTPTrackThemeOffice2003Luna::CXTPTrackThemeOffice2003Luna()
{
	m_columnStyle = xtpReportColumnOffice2003;
}

void CXTPTrackThemeOffice2003Luna::RefreshMetrics()
{
...
void CXTPTrackThemeOffice2003Luna::FillFooter(CDC* pDC, CRect rcFooter)
{
...
BOOL CXTPTrackThemeOffice2003Luna::IsColumHotTrackingEnabled() const
{
	return m_bHotTracking;
}

void CXTPTrackThemeOffice2003Luna::DrawColumnBackground(CDC* pDC, CXTPReportColumn* pColumn, CRect rcColumn, BOOL& bColumnPressed, BOOL& /*bDraggingFromHeader*/, CXTPReportHeader* pHeader)
{
	...
	if (!pPrevColumn || pPrevColumn->GetDrawHeaderDivider())
		DrawVerticalLine(pDC, rcColumn.left, rcColumn.top + XTP_DPI_Y(3), rcColumn.Height() - XTP_DPI_Y(2) - XTP_DPI_Y(4), m_clrControlLightLight);
...
void CXTPTrackThemeOffice2003Luna::DrawColumnFooterDivider(CDC* pDC, CXTPReportColumn* pColumn, CRect rcColumn)
{
...
void CXTPTrackThemeOffice2003Luna::DrawSectionDivider(
	...
	CXTPPaintManagerColor           clrDivider)
{
	if (dividerStyle == xtpReportFixedRowsDividerOutlook)
	{
		...
		DrawHorizontalLine(pDC, rc.left, rc.bottom - XTP_DPI_Y(1), rc.Width(), m_clrGradientColumnShadow);
	}
	else
	{
