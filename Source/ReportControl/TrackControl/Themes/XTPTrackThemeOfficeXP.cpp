// XTPTrackThemeOfficeXP.cpp : implementation of the CXTPTrackPaintManager class.
//
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPTrackThemeOfficeXP
/////////////////////////////////////////////////////////////////////////////

CXTPTrackThemeOfficeXP::CXTPTrackThemeOfficeXP()
{
	m_columnStyle = xtpReportColumnFlat;
}

void CXTPTrackThemeOfficeXP::DrawColumnBackground(CDC* pDC, CXTPReportColumn* pColumn, CRect rcColumn, BOOL& /*bColumnPressed*/, BOOL& /*bDraggingFromHeader*/, CXTPReportHeader* pHeader)
{
