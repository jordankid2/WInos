// XTPTrackThemeVisualStudio2012.cpp : implementation of the CXTPTrackThemeOffice2013 class.
//
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPTrackThemeVisualStudio2012Light
/////////////////////////////////////////////////////////////////////////////

CXTPTrackThemeVisualStudio2012Light::CXTPTrackThemeVisualStudio2012Light()
{
	m_bMakeUpper = FALSE;
	LoadGlyphs();
}

void CXTPTrackThemeVisualStudio2012Light::LoadGlyphs()
{
	CMDTARGET_RELEASE(m_pGlyphs);
	m_pGlyphs = new CXTPImageManager();

	int nBmpID = XTPDpiHelper()->SelectDpiSpecific(
		XTP_IDB_REPORT_GLYPHS_VS2012_LIGHT_12,
		XTP_IDB_REPORT_GLYPHS_VS2012_LIGHT_15,
		XTP_IDB_REPORT_GLYPHS_VS2012_LIGHT_18,
		XTP_IDB_REPORT_GLYPHS_VS2012_LIGHT_24);
	CBitmap bmp;
...
void CXTPTrackThemeVisualStudio2012Light::RefreshMetrics()
{
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPTrackThemeVisualStudio2012Dark
/////////////////////////////////////////////////////////////////////////////

CXTPTrackThemeVisualStudio2012Dark::CXTPTrackThemeVisualStudio2012Dark()
{
	m_bMakeUpper = FALSE;
	LoadGlyphs();
}

void CXTPTrackThemeVisualStudio2012Dark::LoadGlyphs()
{
	CMDTARGET_RELEASE(m_pGlyphs);
	m_pGlyphs = new CXTPImageManager();

	int nBmpID = XTPDpiHelper()->SelectDpiSpecific(
		XTP_IDB_REPORT_GLYPHS_VS2012_DARK_12,
		XTP_IDB_REPORT_GLYPHS_VS2012_DARK_15,
		XTP_IDB_REPORT_GLYPHS_VS2012_DARK_18,
		XTP_IDB_REPORT_GLYPHS_VS2012_DARK_24);
	CBitmap bmp;
	CXTPResourceManager::AssertValid(XTPResourceManager()->LoadBitmap(&bmp, nBmpID));
...
void CXTPTrackThemeVisualStudio2012Dark::RefreshMetrics()
{
	CMDTARGET_RELEASE(m_pHyperlinkStyle);
	...
	m_clrCaptionTextPressed.SetStandardValue(m_clrHighlightText);
	m_clrHeaderControl.SetStandardValue(m_clrItemShade);
	m_clrGroupShadeBorder.SetStandardValue(m_clrControlDark);
	m_clrGroupShadeBack.SetStandardValue(m_clrBtnFace);
	m_clrGroupShadeText.SetStandardValue(m_clrBtnText);
	m_clrGroupRowText.SetStandardValue(m_clrControlDark);
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPTrackThemeVisualStudio2012Blue
/////////////////////////////////////////////////////////////////////////////

CXTPTrackThemeVisualStudio2012Blue::CXTPTrackThemeVisualStudio2012Blue()
{
	m_bMakeUpper = FALSE;
	LoadGlyphs();
}

void CXTPTrackThemeVisualStudio2012Blue::LoadGlyphs()
{
	CMDTARGET_RELEASE(m_pGlyphs);
	m_pGlyphs = new CXTPImageManager();

	int nBmpID = XTPDpiHelper()->SelectDpiSpecific(
		XTP_IDB_REPORT_GLYPHS_VS2012_BLUE_12,
		XTP_IDB_REPORT_GLYPHS_VS2012_BLUE_15,
		XTP_IDB_REPORT_GLYPHS_VS2012_BLUE_18,
		XTP_IDB_REPORT_GLYPHS_VS2012_BLUE_24);
	CBitmap bmp;
	CXTPResourceManager::AssertValid(XTPResourceManager()->LoadBitmap(&bmp, nBmpID));
...
void CXTPTrackThemeVisualStudio2012Blue::RefreshMetrics()
{
	CMDTARGET_RELEASE(m_pHyperlinkStyle);
	m_pHyperlinkStyle = new CXTPReportHyperlinkStyle(RGB(19,100,196), xtpReportTextDecorationNone);
