...
//===========================================================================
class _XTP_EXT_CLASS CXTPReportRecords : public CXTPHeapObjectT<CXTPCmdTarget, CXTPReportDataAllocator>
{
...
public:
	...
	//-----------------------------------------------------------------------
	virtual void PrepareToDropping(CXTPReportRecord* pTargetRecord, CXTPReportRecords* pTargetRecords, BOOL bChangeParent);
