...
protected:
	...
	CXTPFont m_xtpFontFooter;           // Column Footer font. If Font handle is NULL - the default font is used.
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontFooter, m_xtpFontFooter, GetFooterFontHandle);
