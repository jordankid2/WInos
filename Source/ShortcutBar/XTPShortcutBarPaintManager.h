...
public:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntPaneCaption, m_xtpFontPaneCaption, GetPaneCaptionFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntPaneItemCaption, m_xtpFontPaneItemCaption, GetPaneItemCaptionFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntVerticalText, m_xtpFontVerticalText, GetVerticalTextFontHandle);
