// XTPShortcutBarOffice2003Theme.cpp : implementation of the CXTPShortcutBarOffice2003Theme class.
//
...
int CXTPShortcutBarOffice2003Theme::DrawGripper(CDC* pDC, CXTPShortcutBar* pShortcutBar, BOOL bDraw)
{
	if (bDraw)
	{
		...
		int nRight = max(XTP_DPI_X(2), (rc.Width() - XTP_DPI_X(4 * 9)) / 2);
		for (int i = 0; i < 9; i++)
		{
