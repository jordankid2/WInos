// XTPShortcutBarVisualStudio2015Theme.cpp
//
...
#include "ShortcutBar/Themes/XTPShortcutBarVisualStudio2015Theme.h"
...
CXTPShortcutBarVisualStudio2015Theme::CXTPShortcutBarVisualStudio2015Theme()
{
	EnableOfficeFont();
}
...
void CXTPShortcutBarVisualStudio2015Theme::RefreshMetrics()
{
	...
	m_clrPushedText        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextPushed"),            RGB( 68,  68,  68)));
	m_clrSelectedText      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextSelected"),          RGB( 68,  68,  68)));
	m_clrDisabledText      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextDisabled"),          RGB(152, 152, 152)));
	m_clrCaptionText       .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextCaption"),           RGB( 68,  68,  68)));
	m_clrItemCaptionText   .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextItemCaption"),       RGB( 68,  68,  68)));
	m_clrBack              .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("Back"),                  RGB(207, 214, 229)));
	m_clrBackHilite        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackHighlight"),         RGB(253, 244, 191)));
	m_clrBackPushed        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPushed"),            RGB(255, 232, 166)));
	m_clrBackPushedDark    .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPushedDark"),        RGB(255, 232, 166)));
	m_clrBackSelected      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackSelected"),          RGB(253, 244, 191)));
	m_clrBackHiliteSelected.SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackHighlightSelected"), RGB(255, 252, 244)));
	m_grcCaption           .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackCaption"),           RGB(207, 214, 229)));
	m_clrPopupBackground   .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPopup"),             RGB(207, 214, 229)));
	m_clrPopupFrame        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BorderPopup"),           RGB(133, 145, 162)));
	m_clrBorderHilite      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BorderHighlight"),       RGB(229, 195, 101)));
	m_clrGlyph             .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("Glyph"),                 RGB(131, 134, 136)));
	m_clrGlyphFill         .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("GlyphFill"),             RGB(255, 255, 255)));
	m_clrGlyphExpanded     .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("GlyphExpanded"),         RGB( 68,  68,  68)));
	m_clrGlyphPushed       .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("GlyphPushed"),           RGB( 68,  68,  68)));
	m_grcShortcutBarGripper.SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("Gripper"),               RGB(212, 212, 212)));
...
void CXTPShortcutBarVisualStudio2015Theme::DrawHiliteBorder(CDC* pDC, CRect rc)
{
	if (m_bHiliteBorders)
	{
...
void CXTPShortcutBarVisualStudio2015Theme::DrawPaneCaptionMinimizeButton(CDC* pDC, CXTPShortcutBarPane* pPane)
{
...
int CXTPShortcutBarVisualStudio2015Theme::DrawPaneItemCaption(CDC* pDC, CXTPShortcutBarPaneItem* pItem, BOOL bDraw)
{
	if (bDraw)
	{
...
void CXTPShortcutBarVisualStudio2015Theme::FillShortcutItemEntry(CDC* pDC, CXTPShortcutBarItem* pItem)
{
...
void CXTPShortcutBarVisualStudio2015Theme::FillNavigationItemEntry(CDC* pDC, CXTPShortcutBarItem* pItem)
{
	CRect rc = pItem->GetItemRect();
