...
void CXTPShortcutBarOffice2013Theme::RefreshMetrics()
{
	...
	m_clrDisabledText      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("TextDisabled"),       RGB(177, 177, 177)));
	...
	m_clrBackHilite        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackHighlight"),      RGB(213, 225, 242)));
	m_clrBackPushed        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPushed"),         RGB(163, 189, 227)));
	m_clrBackPushedDark    .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPushedDark"),     RGB( 43,  87, 154)));
	m_clrBackSelected      .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackSelected"),       RGB(194, 213, 242)));
	m_grcCaption           .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackCaption"),        RGB(255, 255, 255)));
	m_clrPopupBackground   .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BackPopup"),          RGB(255, 255, 255)));
	m_clrPopupFrame        .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("BorderPopup"),        RGB(171, 171, 171)));
	...
	m_clrGlyphPushed       .SetStandardValue(XTPIniColor(_T("ShortcutBar"), _T("GlyphPushed"),        RGB(255, 255, 255)));
...
void CXTPShortcutBarOffice2013Theme::DrawPaneCaptionMinimizeButton(CDC* pDC, CXTPShortcutBarPane* pPane)
{
...
int CXTPShortcutBarOffice2013Theme::DrawPaneItemCaption(CDC* pDC, CXTPShortcutBarPaneItem* pItem, BOOL bDraw)
{
	if (bDraw)
	{
