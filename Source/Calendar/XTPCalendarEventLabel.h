...
public:
	...
	//-----------------------------------------------------------------------
	CXTPCalendarEventCategory(UINT nID = 0, LPCTSTR pcszName = _T(""), COLORREF clrBorder = 0, COLORREF clrBkBase = 0);
...
//===========================================================================
class _XTP_EXT_CLASS CXTPCalendarEventCategories : public CXTPCalendarPtrCollectionT<CXTPCalendarEventCategory>
{
	//{{AFX_CODEJOCK_PRIVATE
