...
public:
	...
	//      TRUE - if successful, otherwise - FALSE.
	//-----------------------------------------------------------------------
	static BOOL AFX_CDECL GetRegTZI(HKEY hKey, LPCTSTR pcszValueName, REGISTRY_TIMEZONE_INFORMATION& rRegTZI);
...
#ifdef _XTP_ACTIVEX
//{{AFX_CODEJOCK_PRIVATE
class _XTP_EXT_CLASS CXTPCalendarSystemTime : public CXTPCmdTarget, public SYSTEMTIME
{
public:
