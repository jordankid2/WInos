...
CXTPCalendarEventColorDlg::CXTPCalendarEventColorDlg(BOOL bCategories, CXTPCalendarControl* pCalendarCtrl, CWnd* pParent /*=NULL*/)
	...
	, m_pCalendarCtrl(pCalendarCtrl)
{
	...
	InitModalIndirect(XTPResourceManager()->LoadDialogTemplate(CXTPCalendarEventColorDlg::IDD), pParent);
