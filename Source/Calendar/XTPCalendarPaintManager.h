...
public:
	...
	BEGIN_VIEW_PART(TimeLineViewPart, XTPCalendarTimeLineViewPart)
		...
		//      pViewEvent  - The event view.
		//-----------------------------------------------------------------------
		virtual void DrawEvent(CDC* pDC, const CRect& rcEvents, CXTPCalendarTimeLineViewEvent* pViewEvent);
...
//}}AFX_CODEJOCK_PRIVATE
	...
	virtual CXTPCalendarViewEventSubjectEditor* StartEditSubject(CXTPCalendarViewEvent* pViewEvent, CRect& rcEditor);
	virtual void SetEditFont(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewEventSubjectEditor* pEditor);
...
protected:
	...
	virtual void PartDraw(CDayViewEventPart* pViewPart, CDC* pDC, CXTPCalendarDayViewEvent* pViewEvent);
	virtual void PartDrawHourCell(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rc, CString strText, BOOL bFillBackground, BOOL bCurrentTime);
	virtual void PartDrawBigHourCell(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rc, CString strHour, CString strMin, int nRowPerHour, BOOL bFillBackground, BOOL bCurrentTime);
	virtual void PartDraw(CDayViewTimeScaleHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayView* pView, CRect rc, CString strText);
	virtual void PartDrawNowLine(CDayViewTimeScaleHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayView* pView, CRect rc, int y, BOOL bDrawBk);
	virtual void PartDraw(CDayViewCellPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, const XTP_CALENDAR_DAYVIEWCELL_PARAMS& cellParams);
	virtual void PartDraw(CDayViewAllDayEventsPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, BOOL bSelected);
	virtual void PartDraw(CDayViewHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayViewDay* pViewDay, CRect rc, CString strText);
	virtual void PartDraw(CDayViewAllDayEventScrollIconsPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, BOOL bDrawUp, BOOL bDrawDown, const CRect& rcIconUp, const CRect& rcIconDown, BOOL bHighlightUp, BOOL bHighlightDown);
	virtual void PartDraw(CDayViewGroupHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, CString strText);
	virtual void PartDrawDayHeader(CWeekViewPart* pViewPart, CDC* pDC, CRect rcDay, int nHeaderHeight, CString strHeader, BOOL bIsCurrent, BOOL bIsSelected);
	virtual void PartDraw(CWeekViewPart* pViewPart, CDC* pDC, CXTPCalendarWeekView* pWeekView);
	virtual void PartDrawBorder(CWeekViewEventPart* pViewPart, CDC* pDC, CRect rcView, CXTPCalendarWeekViewEvent* pWeekViewEvent);
	virtual int PartDrawTimes(CWeekViewEventPart* pViewPart, CDC* pDC, CXTPCalendarWeekViewEvent* pWeekViewEvent);
	virtual void PartDrawSubj(CWeekViewEventPart* pViewPart, CDC* pDC, CXTPCalendarWeekViewEvent* pWeekViewEvent);
	virtual void PartDraw(CWeekViewEventPart* pViewPart, CDC* pDC, CXTPCalendarWeekViewEvent* pWeekViewEvent);
	virtual void PartDrawGrid(CMonthViewGridPart* pViewPart, CDC* pDC, CXTPCalendarMonthView* pMonthView);
	virtual void PartDraw(CMonthViewHeaderPart* pViewPart, CDC* pDC, CXTPCalendarMonthView* pMonthView, CRect rc, int nCollIndex, CString strText);
	virtual void PartDrawDayDate(CMonthViewEventPart* pViewPart, CDC* pDC, CRect rc, BOOL bToday, BOOL bSelected, BOOL bFirstMonthDay, CString strText);
	virtual void PartDrawEvent(CMonthViewEventPart* pViewPart, CDC* pDC, CXTPCalendarMonthViewEvent* pViewEvent);
	virtual void PartDraw(CTimeLineViewTimeScalePart_Day* pViewPart, CDC* pDC, const CRect& rcRect, CXTPCalendarTimeLineView* pView);
	virtual void PartDraw(CTimeLineViewTimeScalePart_Week* pViewPart, CDC* pDC, const CRect& rcRect, CXTPCalendarTimeLineView* pView);
	virtual void PartDraw(CTimeLineViewTimeScalePart_Month* pViewPart, CDC* pDC, const CRect& rcRect, CXTPCalendarTimeLineView* pView);
	virtual void PartDraw(CTimeLineViewTimeScalePart_WorkWeek* pViewPart, CDC* pDC, const CRect& rcRect, CXTPCalendarTimeLineView* pView);
	virtual void PartDrawGroup(CTimeLineViewPart* pViewPart, CDC* pDC, const CRect& rcRect, CXTPCalendarTimeLineViewGroup* pGroup);
	virtual void PartDrawEvent(CTimeLineViewPart* pViewPart, CDC* pDC, const CRect& rcEvents, CXTPCalendarTimeLineViewEvent* pViewEvent);
	...
	virtual CFont& PartGetTextFont(CXTPCalendarViewPart* pViewPart, CXTPCalendarViewPartFontValue& fntText);
	virtual void PartGetParams(CDayViewCellPart* pViewPart, CXTPCalendarDayViewGroup* pViewGroup, XTP_CALENDAR_DAYVIEWCELL_PARAMS* rCellParams);

	//-- MISC PART METHODS
	virtual void PartCalcWidth(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, const CString& strHour, const CString& strMin, int nHourHeight, int& nWidth);
	virtual void PartAdjustTimeFont(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rcCell);
	virtual CSize PartCalcEventSize(CTimeLineViewPart* pViewPart, CDC* pDC, CXTPCalendarTimeLineViewEvent* pViewEvent);
...
public:
	...
	virtual void DrawHeader(CDC* pDC, CRect& rcHeader, BOOL bIsSelected, BOOL bIsCurrent, const CXTPPaintManagerColorGradient& grclr, COLORREF clrUnderLineHdr); // <combine CXTPCalendarPaintManager::DrawHeader@CDC*@CRect&@BOOL@BOOL>
...
public:
	...
	CXTPPaintManagerColor m_clrBorders[4];     // Stores border line color, left = 0, top = 1, right = 2, bottom = 3.
...
protected:
	...
	CBitmap     m_bmpElsewherePattern;  // Stores standard bitmap pattern to draw Elsewhere event busy status.

	CXTPBrush   m_xtpBrushElsewhere;       // Stores standard brush to draw Elsewhere event busy status.
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CBrush, m_brushElsewhere, m_xtpBrushElsewhere, GetBrushElsewhereHandle);
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CBrush, m_brushTentative, m_xtpBrushTentative, GetBrushTentativeHandle);
