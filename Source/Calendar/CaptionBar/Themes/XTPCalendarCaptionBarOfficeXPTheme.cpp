// XTPCalendarCaptionBarOfficeXPTheme.cpp : implementation of the CXTPCalendarCaptionBarOffice2000Theme class.
//
...
CXTPCalendarCaptionBarOfficeXPTheme::CXTPCalendarCaptionBarOfficeXPTheme(CXTPCalendarCaptionBarTheme* pTheme /*=NULL*/)
