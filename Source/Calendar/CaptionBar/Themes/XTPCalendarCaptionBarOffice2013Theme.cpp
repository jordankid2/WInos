// XTPCalendarCaptionBarOffice2013Theme.cpp : implementation of the CXTPCalendarCaptionBarOffice2003Theme class.
//
...
CXTPCalendarCaptionBarOffice2013Theme::CXTPCalendarCaptionBarOffice2013Theme(CXTPCalendarCaptionBarTheme* pTheme /*=NULL*/)
...
void CXTPCalendarCaptionBarOffice2013Theme::RefreshMetrics()
{
	...
	m_pTheme->m_nScrollDateButtonsMargin = XTP_DPI_X(XTPIniInt(_T("Calendar.CaptionBar"), _T("ScrollDateButtonsMargin"), 20));

	m_clrScrollDateBarBk      .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ScrollDateBarBack"),     RGB(255, 255, 255)));
	m_clrSwitchViewBarBk      .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("SwitchViewBarBack"),     RGB(255, 255, 255)));
	m_clrTextColor            .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("TextColor"),             RGB( 38,  38,  38)));
	m_clrBorders[0]           .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("BorderLeft"),            RGB(212, 212, 212)));
	m_clrBorders[1]           .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("BorderTop"),             RGB(212, 212, 212)));
	m_clrBorders[2]           .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("BorderRight"),           RGB(212, 212, 212)));
	m_clrBorders[3]           .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("BorderBottom"),          RGB(212, 212, 212)));
	m_clrScrollTriangleColor  .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ScrollTriangleColor"),   RGB(119, 119, 119)));
	m_clrButtonHighlight      .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonHighlight"),       RGB(205, 230, 247)));
	m_clrButtonHighlightText  .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonHighlightText"),   RGB(119, 119, 119)));
	m_clrButtonHighlightBorder.SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonHighlightBorder"), RGB(146, 194, 224)));
	m_clrButtonPressed        .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonPressed"),         RGB(177, 214, 240)));
	m_clrButtonPressedText    .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonPressedText"),     RGB(119, 119, 119)));
	m_clrButtonPressedBorder  .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonPressedBorder"),   RGB(146, 194, 224)));
	m_clrButtonChecked        .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonChecked"),         RGB(177, 214, 240)));
	m_clrButtonCheckedText    .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonCheckedText"),     RGB(119, 119, 119)));
	m_clrButtonCheckedBorder  .SetStandardValue(XTPIniColor(_T("Calendar.CaptionBar"), _T("ButtonCheckedBorder"),   RGB(146, 194, 224)));
...
{
	UNREFERENCED_PARAMETER(pBarPart);
}
...
void CXTPCalendarCaptionBarOffice2013Theme::PartDraw(CXTPScrollDateButtonPart* pBarPart, CDC* pDC)
{
	...
	PartDrawScrollTriangle(pBarPart, pDC, pBarPart->m_rcRect,
		(pBarPart->GetPartID() == xtpCalendarCaptionBar_ScrollPrevDate), clrScrollTriangle);
}
