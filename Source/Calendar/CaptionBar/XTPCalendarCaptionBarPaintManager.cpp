...
CXTPCalendarCaptionBarPaintManager::CXTPCalendarCaptionBarPaintManager(CXTPCalendarCaptionBarTheme* pTheme /*=NULL*/)
...
void CXTPCalendarCaptionBarPaintManager::DrawBorders(CDC* pDC, const CRect& rcRect, const CRect& rcBorders)
{
	ASSERT(pDC);
...
void CXTPCalendarCaptionBarPaintManager::DrawTriangle(CDC* pDC, CPoint pt0, CPoint pt1, CPoint pt2, COLORREF clrColor)
{
	ASSERT(pDC);
