...
void CXTPScrollDateButtonPart::DrawScrollTriangle(CDC* pDC, CRect rcRect, BOOL bLeftDirection, COLORREF clrColor)
{
	CXTPCalendarCaptionBarPaintManager* pPaintManager = GetPaintManager();
	ASSERT(pPaintManager);
...
void CXTPExpandButtonPart::DrawExpandTriangle(CDC* pDC, CRect rcRect, BOOL bDownDirection, COLORREF clrColor)
{
	CXTPCalendarCaptionBarPaintManager* pPaintManager = GetPaintManager();
	ASSERT(pPaintManager);
