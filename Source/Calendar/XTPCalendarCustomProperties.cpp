...
IMPLEMENT_DYNAMIC(CXTPCalendarCustomProperties, CXTPCmdTarget)
//////////////////////////////////////////////////////////////////////
...
void CXTPCalendarCustomProperties::_Save(CXTPPropExchange* pPX)
{
	...
	POSITION posStorage = pEnumerator->GetPosition(XTPToDWORDChecked(nPropsCount));
...
BEGIN_DISPATCH_MAP(CXTPCalendarCustomProperties, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPCalendarCustomProperties, CXTPCmdTarget)
	INTERFACE_PART(CXTPCalendarCustomProperties, XTPDIID_CalendarCustomProperties, Dispatch)
	//INTERFACE_PART(CXTPCalendarCustomProperties, IID_IEnumVARIANT, EnumVARIANT)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarCustomProperties, XTPDIID_CalendarCustomProperties)
