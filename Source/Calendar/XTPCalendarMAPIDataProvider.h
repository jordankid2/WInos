...
//private:
	...
	DWORD GetEventID(ULONG cbSearchKey, LPENTRYID lpSearchKey, 
		BOOL bAddNew = FALSE);
...
//private:
	...
	static LPSRestriction AFX_CDECL BuildBinaryRestriction(
	...
	CXTPCalendarEventPtr ImportEvent_FromCalendarFolderOnly(ULONG cbEntryID, 
		LPENTRYID lpEntryID);
	...
	public:
		...
		ULONG GetPropTagByID(LPMESSAGE pMessage,
	...
	protected:
		...
		ULONG _GetPropTagFromID_ex(LPMESSAGE pMessage, 
			const XTP_MAPI_PROP_NAME& propNameEx);
