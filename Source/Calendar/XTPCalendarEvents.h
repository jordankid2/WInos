...
public:
	...
	//-----------------------------------------------------------------------
	typedef int (AFX_CDECL* T_CompareFunc)(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2);
	...
	//-----------------------------------------------------------------------
	static int AFX_CDECL CompareEvents_ForView(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2);
	...
	// Example: See example for CXTPCalendarEvents::Sort method.
	//-----------------------------------------------------------------------
	static int AFX_CDECL CompareEvents_ForViewByStart(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2);
	...
	//-----------------------------------------------------------------------
	static int AFX_CDECL CompareEvents_ByID(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2);
