...
BEGIN_DISPATCH_MAP(CXTPCalendarReminder, CXTPCmdTarget)
	...
	DISP_FUNCTION_ID(CXTPCalendarReminder, "NextReminderTime", 2, OleGetNextReminderTime, VT_DATE, VTS_NONE)
	DISP_FUNCTION_ID(CXTPCalendarReminder, "MinutesBeforeStart", 3, OleGetMinutesBeforeStart, VT_I4, VTS_NONE)
...
BEGIN_DISPATCH_MAP(CXTPCalendarRemindersManager, CWnd)
	DISP_FUNCTION_ID(CXTPCalendarRemindersManager, "NewEnum", DISPID_NEWENUM, OleNewEnum, VT_DISPATCH, VTS_NONE)
	DISP_FUNCTION_ID(CXTPCalendarRemindersManager, "Count", 100, OleGetItemCount, VT_I4, VTS_NONE)
	DISP_FUNCTION_ID(CXTPCalendarRemindersManager, "Item", DISPID_VALUE, OleGetItem, VT_DISPATCH, VTS_I4)

	DISP_FUNCTION_ID(CXTPCalendarRemindersManager, "DismissAll", 1, OleDismissAll, VT_EMPTY, VTS_NONE)
END_DISPATCH_MAP()
