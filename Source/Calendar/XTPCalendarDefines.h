...
enum XTPCalendarTheme
{
	...
	xtpCalendarThemeOffice2016       =  xtpCalendarThemeOffice2013, // Office 2016 theme.
	xtpCalendarThemeResource         =  4,   // Resource theme.
	xtpCalendarThemeVisualStudio2015 =  5,   // VisualStudio 2015 theme.
...
enum XTPCalendarEventBusyStatus
{
	...
	xtpCalendarBusyStatusElsewhere      = 1,    // Working elsewhere event status.
	xtpCalendarBusyStatusTentative      = 2,    // Tentative event status.
	xtpCalendarBusyStatusBusy           = 3,    // Busy event status.
	xtpCalendarBusyStatusOutOfOffice    = 4     // OutOfOffice event status.
};
...
enum XTPCalendarEventCategories
{
	...
	xtpCalendarEventCategoryPurple  = 4,    // The Purple category ID.
	xtpCalendarEventCategoryOrange  = 5,    // The Orange category ID.
	xtpCalendarEventCategoryBlue    = 6     // The Blue category ID.
};

//{{AFX_CODEJOCK_PRIVATE
#define xtpCalendarEventCategoryPink xtpCalendarEventCategoryPurple
//}}AFX_CODEJOCK_PRIVATE
