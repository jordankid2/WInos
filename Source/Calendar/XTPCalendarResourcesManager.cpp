...
//////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC(CXTPCalendarResourceDescription, CXTPCmdTarget)
IMPLEMENT_DYNCREATE(CXTPCalendarResourcesManager, CXTPCmdTarget)
...
void CXTPCalendarResourcesManager::_Save(CXTPPropExchange* pPX)
{
	...
	POSITION posStorage = ptrEnumDPs->GetPosition(XTPToDWORDChecked(nDPCount));
	...
	posStorage = ptrEnumRCs->GetPosition(XTPToDWORDChecked(nRCCount));
	...
	for (int nRCNr = 0; nRCNr < nRCCount; nRCNr++)
	{
		...
		if (pRCdp)
		{
			...
			POSITION posSchID = ptrEnumSchIDs->GetPosition(XTPToDWORDChecked(nSchIdsCount));
...
#ifdef _XTP_ACTIVEX
//===========================================================================
BEGIN_DISPATCH_MAP(CXTPCalendarResourceDescription, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPCalendarResourceDescription, CXTPCmdTarget)
	INTERFACE_PART(CXTPCalendarResourceDescription, XTPDIID_CalendarResourceDescription, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarResourceDescription, XTPDIID_CalendarResourceDescription)
...
void CXTPCalendarResourceDescription::OleSetResource(LPDISPATCH pDispResource)
{
	...
	if (pDispResource)
	{
		pRes = DYNAMIC_DOWNCAST(CXTPCalendarResource, CXTPCalendarResource::FromIDispatchSafe(pDispResource));
		if (!pRes)
		{
...
//===========================================================================
BEGIN_DISPATCH_MAP(CXTPCalendarResourcesManager, CXTPCmdTarget)
...
BEGIN_INTERFACE_MAP(CXTPCalendarResourcesManager, CXTPCmdTarget)
	INTERFACE_PART(CXTPCalendarResourcesManager, XTPDIID_ICalendarResourcesManager, Dispatch)
END_INTERFACE_MAP()

IMPLEMENT_OLETYPELIB_EX(CXTPCalendarResourcesManager, XTPDIID_ICalendarResourcesManager)
