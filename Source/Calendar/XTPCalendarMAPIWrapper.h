...
TYPEDEF_WRAPPER_POINTER(2, HRESULT, MAPILogonEx)(ULONG, LPTSTR, LPTSTR, 
...
TYPEDEF_WRAPPER_PTR_NUM(6, HRESULT, HrQueryAllRows, 24)(
	...
	LPSPropTagArray,
	LPSRestriction,
	LPSSortOrderSet, LONG, 
	LPSRowSet FAR *);
TYPEDEF_WRAPPER_PTR_NUM(7, HRESULT, HrGetOneProp, 12)(
	LPMAPIPROP, ULONG, 
	LPSPropValue FAR *);
TYPEDEF_WRAPPER_PTR_NUM(8, HRESULT, HrSetOneProp, 8)(
	LPMAPIPROP,
	LPSPropValue);
...
public:
	...
	//-----------------------------------------------------------------------
	HRESULT MAPILogonEx(ULONG ulUIParam, LPTSTR lpszProfileName, LPTSTR lpszPassword, 
		FLAGS flFlags, 
	...
	HRESULT HrGetOneProp(
		LPMAPIPROP pmp, ULONG ulPropTag, 
	...
	//                        the specified interface.
	//-----------------------------------------------------------------------
	HRESULT HrSetOneProp(LPMAPIPROP pmp, 
		LPSPropValue pprop);
	...
	//     the expected value or values,else E_FAIL
	//-----------------------------------------------------------------------
	HRESULT HrAllocAdviseSink(LPNOTIFCALLBACK lpfnCallback, 
		LPVOID lpvContext, LPMAPIADVISESINK FAR * lppAdviseSink);
