...
int AFX_CDECL CXTPCalendarEvents::CompareEvents_ForView(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2)
{
...
int AFX_CDECL CXTPCalendarEvents::CompareEvents_ForViewByStart(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2)
{
	if (*ppEv1 == NULL || *ppEv2 == NULL)
	{
		ASSERT(FALSE);
...
int AFX_CDECL CXTPCalendarEvents::CompareEvents_ByID(const CXTPCalendarEvent** ppEv1, const CXTPCalendarEvent** ppEv2)
{
	if (*ppEv1 == NULL || *ppEv2 == NULL)
	{
		ASSERT(FALSE);
...
BEGIN_DISPATCH_MAP(CXTPCalendarEvents, CXTPCmdTarget)
	...
	DISP_FUNCTION_ID(CXTPCalendarEvents, "_NewEnum", DISPID_NEWENUM, OleNewEnum, VT_UNKNOWN, VTS_NONE)
...
void CXTPCalendarEvents::OleAdd(LPDISPATCH pEventDisp)
{
	CXTPCalendarEvent* pEvent = DYNAMIC_DOWNCAST(CXTPCalendarEvent, 
		CXTPCalendarEvent::FromIDispatchSafe(pEventDisp));
	if (!pEvent)
	{
