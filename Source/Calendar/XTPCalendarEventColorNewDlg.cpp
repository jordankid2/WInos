...
CXTPCalendarEventColorNewDlg::CXTPCalendarEventColorNewDlg(BOOL bCategories, CWnd* pParent /*=NULL*/)
	: m_bCategories(bCategories)
{
	InitModalIndirect(XTPResourceManager()->LoadDialogTemplate(CXTPCalendarEventColorNewDlg::IDD), pParent);
