// XTPDatePickerList.h: interface for the CXTPDatePickerList class.
//
...
private:
	static void AFX_CDECL ShiftMonthUp(int& nYear, int& nMonth, const int nCount);
	static void AFX_CDECL ShiftMonthDown(int& nYear, int& nMonth, const int nCount);
