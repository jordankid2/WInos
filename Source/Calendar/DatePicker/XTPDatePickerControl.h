...
private:
	CXTPFont m_xtpFontText;        // A CFont object that contains the item's text font.
...
public:
	...
	// Parameters:
	//     nEnable - Boolean value determines if the system-defined format 
	//               of year_month string are shown.
	// Remarks:
	//     String m_strYearMonthFormat can be defined proper only if 
	//     operating system is Windows 2000 or a later version.
	// See Also:
	//     SetMonthName, GetMonthName, m_strYearMonthFormat
	//-----------------------------------------------------------------------
