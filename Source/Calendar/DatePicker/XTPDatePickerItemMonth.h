...
private:
//{{AFX_CODEJOCK_PRIVATE
	static void AFX_CDECL Swap(COleDateTime& dtFirst, COleDateTime& dtSecond);
//}}AFX_CODEJOCK_PRIVATE
};
...
AFX_INLINE void AFX_CDECL CXTPDatePickerItemMonth::Swap(COleDateTime& dtFirst, COleDateTime& dtSecond) {
