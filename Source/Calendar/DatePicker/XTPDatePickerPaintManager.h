...
public:
	...
	CXTPPaintManagerColor m_clrMonthBorder;     // -------------------------------------------------------------
	                                            // This member variable is a COLORREF object that is used as the
	                                            // color of the border between day of month and week numbers or 
	                                            // days of week.
	                                            // -------------------------------------------------------------

	CXTPPaintManagerColor m_clrMonthHeaderButton; // -------------------------------------------------------------
	                                              // This member variable is a COLORREF object that is used as the
	                                              // color for the scroll's triangle button.
	                                              // -------------------------------------------------------------
...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontDayBold, m_xtpFontDayBold, GetDayBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontNonMonthDay, m_xtpFontNonMonthDay, GetNonMonthDayFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontHeader, m_xtpFontHeader, GetHeaderFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontDaysOfWeek, m_xtpFontDaysOfWeek, GetDaysOfWeekFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontWeekNumbers, m_xtpFontWeekNumbers, GetWeekNumbersFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontListControl, m_xtpFontListControl, GetListControlFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontButton, m_xtpFontButton, GetButtonFontHandle);
