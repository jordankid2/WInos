...
void CXTPCalendarOffice2013Theme::RefreshMetrics()
{
    ...
    m_clrHeaderBack                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HeaderBack"),                 RGB(225, 242, 250)));
    m_clrHeaderText                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HeaderText"),                 RGB( 68,  68,  68)));
    m_clrHeaderBackSelected        .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HeaderBackSelected"),         RGB(153, 200, 233)));
    m_clrHeaderTextSelected        .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HeaderTextSelected"),         RGB(255, 255, 255)));
    m_clrHighlight                 .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("Highlight"),                  RGB(  0, 114, 198)));
    m_clrBorders[0]                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("BorderLeft"),                 RGB(171, 171, 171)));
    m_clrBorders[1]                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("BorderTop"),                  RGB(171, 171, 171)));
    m_clrBorders[2]                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("BorderRight"),                RGB(171, 171, 171)));
    m_clrBorders[3]                .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("BorderBottom"),               RGB(171, 171, 171)));
    m_clrEventSelBorder            .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("EventSelBorder"),             RGB( 38,  38,  38)));
    m_clrBusyStatusOutOfOfficeBack .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("BusyStatusOutOfOfficeBack"),  RGB(129,  61,  95)));
    m_clrMultiDayArrow             .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("MultiDayArrow"),              RGB(114, 114, 114)));
    ...
    m_clrHourNowText               .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HourNowText"),                RGB( 42, 141, 212)));
	m_clrHourNowBack               .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("HourNowBack"),                RGB(255, 255, 255)));
    m_clrNowLine                   .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("NowLine"),                    RGB( 42, 141, 212)));
    m_clrNowLineShadow             .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("NowLineShadow"),              RGB(177, 214, 240)));
    ...
    m_clrNonWorkCellBack           .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("NonWorkCellBack"),            RGB(240, 240, 240)));
    m_clrGridLine                  .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("GridLine"),                   RGB(225, 225, 225)));
    m_clrMonthGridLine             .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("MonthGridLine"),              RGB(225, 225, 225)));
    m_clrMultiDayEventFrameColor   .SetStandardValue(XTPIniColor(_T("Calendar"),            _T("MultiDayEventFrameColor"),    RGB(205, 230, 247)));
    m_clrTLVEventBar               .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("EventBar"),                   RGB( 42, 141, 212)));
    m_clrTLVEventBarLine           .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("EventBarLine"),               RGB( 42, 141, 212)));
    m_clrTLVTimeScaleBackground    .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("TimeScaleBack"),              RGB(225, 242, 250)));
    m_clrTLVTimeScaleBorder        .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("TimeScaleBorder"),            RGB(255, 255, 255)));
    m_clrTLVTimeScaleHighlight     .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("TimeScaleHighlight"),         RGB(255, 255, 255)));
    m_clrTLVTimeScaleText          .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("TimeScaleText"),              RGB( 38,  38,  38)));
    m_clrTLVText                   .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("Text"),                       RGB( 38,  38,  38)));
    m_clrTLVBack                   .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("Back"),                       RGB(255, 255, 255)));
    m_clrTLVSelectedText           .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("TextSelected"),               RGB(255, 255, 255)));
    m_clrTLVSelectedBack           .SetStandardValue(XTPIniColor(_T("Calendar.TimeLine"),   _T("BackSelected"),               RGB(153, 200, 233)));
    m_clrEventLabelNone            .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("None"),                       RGB(205, 230, 247)));
    m_clrEventLabelImportant       .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Important"),                  RGB(217, 136, 137)));
    m_clrEventLabelBusiness        .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Business"),                   RGB(241, 157,  90)));
    m_clrEventLabelPersonal        .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Personal"),                   RGB(235, 202, 103)));
    m_clrEventLabelVacation        .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Vacation"),                   RGB(248, 242, 100)));
    m_clrEventLabelMustattend      .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Mustattend"),                 RGB(124, 206, 110)));
    m_clrEventLabelTravelrequired  .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Travelrequired"),             RGB(117, 202, 177)));
    m_clrEventLabelNeedspreparation.SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Needspreparation"),           RGB(171, 187, 141)));
    m_clrEventLabelBirthday        .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Birthday"),                   RGB(116, 153, 225)));
    m_clrEventLabelAnniversary     .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Anniversary"),                RGB(147, 123, 209)));
    m_clrEventLabelPhonecall       .SetStandardValue(XTPIniColor(_T("Calendar.EventLabel"), _T("Phonecall"),                  RGB(205, 141, 170)));
...
void CXTPCalendarOffice2013Theme::UpdateGlyphs()
{
	...
	if (bLoadGlyphs)
	{
		...
		VERIFY(m_ilGlyphs.Create(bmpInfo.bmWidth / glypsCount, bmpInfo.bmHeight, ILC_COLOR24 | ILC_MASK, 0, 1));
		m_ilGlyphs.Add(&bmpGlyphs, clrMask);
	}
}

void CXTPCalendarOffice2013Theme::DrawHeader(CDC* pDC, CRect& rcHeader, BOOL bIsSelected, BOOL bIsCurrent, const CXTPPaintManagerColorGradient& grclr, COLORREF clrUnderLineHdr)
{
	ASSERT(pDC);
	...
	if (bIsCurrent)
	{
		...
		pDC->FillSolidRect(rcHeader.left, rcHeader.bottom - XTP_DPI_Y(1) ,
			rcHeader.Width(), XTP_DPI_Y(1), clrUnderLineHdr);
	}
}
...
CXTPCalendarViewEventSubjectEditor* CXTPCalendarOffice2013Theme::StartEditSubject(CXTPCalendarViewEvent* pViewEvent, CRect& rcEditor)
{
	...
	CXTPCalendarViewEventSubjectEditor* pEditor = new CXTPCalendarViewEventSubjectEditorColored(m_pControl, pViewEvent, clrBack);
	if (pEditor)
	{
...
void CXTPCalendarOffice2013Theme::SetEditFont(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewEventSubjectEditor* pEditor)
{
...
void CXTPCalendarOffice2013Theme::CreateHeaderFont(CDC* pDC, CFont* pFont, CFont* pFontNew, BOOL bBoldFont)
{
...
void CXTPCalendarOffice2013Theme::PartRefresh(CTimeLineViewPart* pViewPart)
{
	...
	LPCTSTR lpResourceName = XTPDpiHelper()->SelectDpiSpecific(
		_T("TIMELINEVIEWAPPOINTMENTICON_100"),
		_T("TIMELINEVIEWAPPOINTMENTICON_125"),
		_T("TIMELINEVIEWAPPOINTMENTICON_150"),
		_T("TIMELINEVIEWAPPOINTMENTICON_200"));
...
void CXTPCalendarOffice2013Theme::PartDrawEventSelectedBorder(CDC* pDC, CRect rcBorder, int l, int t, int r, int b)
{
	ASSERT(pDC);
	...
	if ((l != 0) || (t != 0) || (r != 0) || (b !=0))
	{
		...
		if (l != 0)
		{
			...
			CXTPDrawHelpers::DrawColorRect(
				pDC, CRect(x, y, x + XTP_DPI_X(5), y + XTP_DPI_Y(5)), clrBack, clrFore);
		}
...
void CXTPCalendarOffice2013Theme::DrawCategories(CDC* pDC, CRect& rcEvent, CXTPCalendarEvent* pEvent)
{
	if (!pEvent)
		return;
	...
	for (int i = 1; i < pCategoryIDs->GetSize(); ++i)
	{
		...
		if (pCategory)
		{
			CXTPDrawHelpers::DrawColorRect(pDC, rBlock,
				pCategory->GetBackgroundColor(), pCategory->GetBorderColor());
...
void CXTPCalendarOffice2013Theme::PartDrawEventBusy(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewPart* pViewPart, CDC* pDC, CRect& rcEvent)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
...
void CXTPCalendarOffice2013Theme::DrawMultiDayEvent(CDayViewEventPart* pViewPart, CDC* pDC, CXTPCalendarDayViewEvent* pViewEvent, CRect& rcText)
{
	...
	BOOL bShowStartTime = (dwAdditionalOpt & xtpCalendarOptDayViewShowStartTimeAlways) ? TRUE : FALSE;
	...
	if (!pViewEvent->IsHideEventTime() && (bShowStartTime || bShowEndTime))
	{
		...
		if (nMDEFlags & xtpCalendarMultiDayFirst)
		{
			if (bShowStartTime && bTimeAsClocks)
			{
				...
				{
					DrawClock(pDC, dtStart,
						rcClockRect, clrBack, xtpCalendarClockAlignLeft);
				}
...
void CXTPCalendarOffice2013Theme::DrawSingleDayEvent(CDayViewEventPart* pViewPart, CDC* pDC, CXTPCalendarDayViewEvent* pViewEvent, CRect& rcText)
{
	BOOL bOutOfBorders = FALSE;
	...
	if (!bMarkupDrawn)
	{
		...
		DWORD dwFormat = XTPToDWORD(DT_LEFT | DT_EDITCONTROL | (bNoWordBreak ? (DT_WORD_ELLIPSIS | DT_SINGLELINE) : DT_WORDBREAK));
		...
		if (!pViewEvent->IsHideEventTime() && (bShowStartTime || bShowEndTime))
		{
			...
			if (bTimeAsClocks)
			{
				...
				if (bShowStartTime)
				{
					...
					{
						DrawClock(pDC, dtStart,
							rcClock, clrBack, xtpCalendarClockAlignLeft);
					}

					rcSub.top = rcClock.bottom + XTP_DPI_Y(m_nPadding);
				}
			...
			else
			{
				...
				if (!strTime.IsEmpty())
				{
					...
					if (pDC->DrawText(strTime, &rcTime, DT_CALCRECT | dwFormat))
					{
						...
						if (rcTime.bottom > rcEvent.bottom - XTP_DPI_Y(m_nPadding))
						{
							rcTime.bottom = rcEvent.bottom - XTP_DPI_Y(m_nPadding);
							bOutOfBorders = TRUE;
						}
		...
		// calc text size.
		int textHeight = (pDC->GetTextExtent(_T(" "))).cy;
		BOOL bDrawLoc = TRUE;

		if (pDC->DrawText(strSub, &rcSub, DT_CALCRECT | dwFormat))
		{
			if (rcSub.right > rcEvent.right - XTP_DPI_X(m_nPadding))
			{
				rcSub.right = rcEvent.right - XTP_DPI_X(m_nPadding);
				bOutOfBorders = TRUE;
			}

			if ((rcSub.bottom > rcEvent.bottom - XTP_DPI_Y(m_nPadding)) 
				|| (rcEvent.bottom - XTP_DPI_Y(m_nPadding) - rcSub.bottom < textHeight))
			{
				rcSub.bottom = rcEvent.bottom - XTP_DPI_Y(m_nPadding);
				bDrawLoc = FALSE;
				bOutOfBorders = TRUE;
			}
		...
		if (bDrawLoc)
		{
			...
			{
				if (rcLoc.right > rcEvent.right - XTP_DPI_X(m_nPadding))
				{
					rcLoc.right = rcEvent.right - XTP_DPI_X(m_nPadding);
					bOutOfBorders = TRUE;
				}

				if (rcLoc.bottom > rcEvent.bottom - XTP_DPI_Y(m_nPadding))
				{
					rcLoc.bottom = rcEvent.bottom - XTP_DPI_Y(m_nPadding);
					bOutOfBorders = TRUE;
				}
		...
		BOOL bDrawBody = TRUE;
		if ((rcLoc.bottom > rcEvent.bottom - XTP_DPI_Y(m_nPadding)) 
			|| (rcEvent.bottom - XTP_DPI_Y(m_nPadding) - rcLoc.bottom < textHeight))
		{
			rcLoc.bottom = rcEvent.bottom - XTP_DPI_Y(m_nPadding);
			bDrawBody = FALSE;
			bOutOfBorders = TRUE;
		...
		if (bDrawBody)
		{
			...
			{
				if (rcBody.right > rcEvent.right - XTP_DPI_X(m_nPadding))
				{
					rcBody.right = rcEvent.right - XTP_DPI_X(m_nPadding);
					bOutOfBorders = TRUE;
				}

				if (rcBody.bottom > rcEvent.bottom - XTP_DPI_Y(m_nPadding))
				{
					rcBody.bottom = rcEvent.bottom - XTP_DPI_Y(m_nPadding);
					bOutOfBorders = TRUE;
				}
...
void CXTPCalendarOffice2013Theme::PartDraw(CDayViewEventPart* pViewPart, CDC* pDC, CXTPCalendarDayViewEvent* pViewEvent)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
...
void CXTPCalendarOffice2013Theme::PartDrawHourCell(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rc, CString strText, BOOL bFillBackground, BOOL bCurrentTime)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	...
	if (pDC->GetSafeHdc() && pViewPart)
	{
		...
		pDC->FillSolidRect(rc.left, rc.bottom - XTP_DPI_Y(1), rc.Width(), XTP_DPI_Y(1), pViewPart->m_clrBorder);
	}
}

void CXTPCalendarOffice2013Theme::PartDrawBigHourCell(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rc, CString strHour, CString strMin, int nRowPerHour, BOOL bFillBackground, BOOL bCurrentTime)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	...
	if (pDC->GetSafeHdc() && pViewPart)
	{
		...
		if (strMin.CompareNoCase(_T("am")) == 0 || 
			strMin.CompareNoCase(_T("pm")) == 0)
		{
			// draw minutes text
		...
		if (nRowPerHour > 2)
		{
			...
			for (int i = 1; i < nRowPerHour; i++)
			{
				...
				pDC->FillSolidRect(rcMinutesText.left, y - XTP_DPI_Y(1), rcMinutesText.Width(), XTP_DPI_Y(1), pViewPart->m_clrBorder);
		...
		// draw line below
		CRect rcLine = rc;
		rcLine.DeflateRect(XTP_DPI_X(5), 0, 0, 0);
		pDC->FillSolidRect(rcLine.left, rcLine.bottom - XTP_DPI_Y(1), rcLine.Width(), XTP_DPI_Y(1), pViewPart->m_clrBorder);
	}
}

void CXTPCalendarOffice2013Theme::PartDraw(CDayViewTimeScaleHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayView* /*pView*/, CRect rc, CString strText)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
...
void CXTPCalendarOffice2013Theme::PartDrawNowLine(CDayViewTimeScaleHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayView* pView, CRect rc, int y, BOOL bDrawBk)
{
	...
	{
		int nHeight = 0; //CXTPCalendarUtils::GetTotalMinutes(pView->GetScaleInterval()) >= 60 ? 5 : 10
		...
		rcNowLine.bottom = rcNowLine.top + XTP_DPI_Y(3);
...
void CXTPCalendarOffice2013Theme::PartDraw(CDayViewCellPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, const XTP_CALENDAR_DAYVIEWCELL_PARAMS& cellParams)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewGroup);
	...
	if (pDC->GetSafeHdc() && pViewPart && pViewGroup)
	{
		...
		{
			COLORREF clrDottedLineColor = cellParams.bSelected ? m_clrCellBack : pViewPart->m_clrShadow;
...
void CXTPCalendarOffice2013Theme::PartDraw(CDayViewAllDayEventsPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, BOOL bSelected)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewGroup);
	...
	{
		pDC->FillSolidRect(rc, bSelected ? m_clrHighlight : pViewPart->GetBackgroundColor());
...
void CXTPCalendarOffice2013Theme::PartDraw(CDayViewHeaderPart* pViewPart, CDC* pDC, CXTPCalendarDayViewDay* pViewDay, CRect rc, CString strText)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewDay);
	...
	if (pDC->GetSafeHdc() && pViewPart && pViewDay && pViewDay->GetView())
	{
		...
		{
			CXTPFontDC fontDC(pDC, &font);
			pDC->DrawText(strText, rc, DT_VCENTER | DT_LEFT | DT_NOPREFIX | DT_SINGLELINE | DT_END_ELLIPSIS);
...
void CXTPCalendarOffice2013Theme::PartDrawDayHeader(CWeekViewPart* pViewPart, CDC* pDC, CRect rcDay, int nHeaderHeight, CString strHeader, BOOL bIsCurrent, BOOL bIsSelected)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
...
void CXTPCalendarOffice2013Theme::PartDrawEventBack(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewPart* pViewPart, CDC* pDC, CRect& rcEvent)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
...
void CXTPCalendarOffice2013Theme::PartDrawEventTime(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewPart* pViewPart, CDC* pDC, CRect& rcEvent, CRect& rcText, BOOL bTimeAsClock)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
	...
	if (pDC->GetSafeHdc() && pViewPart && pViewEvent && pViewEvent->GetEvent())
	{
		...
		CXTPCalendarView* pActiveView = XTP_SAFE_GET2(pViewEvent, GetCalendarControl(), GetActiveView(), FALSE);
		if (pActiveView)
		{
			if(pActiveView == XTP_SAFE_GET2(pViewEvent, GetCalendarControl(), GetWeekView(), FALSE))
				bShowEndTime = XTP_SAFE_GET2(pViewEvent, GetCalendarControl(), WeekView_IsShowEndDate(), TRUE);

			if(pActiveView == XTP_SAFE_GET2(pViewEvent, GetCalendarControl(), GetMonthView(), FALSE))
				bShowEndTime = XTP_SAFE_GET2(pViewEvent, GetCalendarControl(), MonthView_IsShowEndDate(), TRUE);
		}
		...
		if (bDrawStartTime || (bDrawEndTime && bShowEndTime))
		{
			if (bTimeAsClock)
			{
				...
				if (bDrawEndTime && bShowEndTime && bDrawStartTime &&!CXTPCalendarUtils::IsEqual(dtStart, dtEnd))
				{
			...
			else
			{
				...
				if (rcTime.right > rcTime.left)
				{
					...
					pDC->DrawText(strTime, &rcTime, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_END_ELLIPSIS);
...
BOOL CXTPCalendarOffice2013Theme::ShowMultiDayTime(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewPart* pViewPart)
{
	ASSERT(pViewEvent);
	...
	BOOL bHideTimes = XTP_SAFE_GET3(pViewEvent, GetCalendarControl(), GetCalendarOptions(), bMonthView_HideTimes, FALSE);
	if (XTP_SAFE_GET3(pViewEvent, GetCalendarControl(), GetActiveView(), GetViewType(), -1) == xtpCalendarMonthView && bHideTimes)
	{
		return FALSE;
	}
...
void CXTPCalendarOffice2013Theme::PartDrawEventText(CXTPCalendarViewEvent* pViewEvent, CXTPCalendarViewPart* pViewPart, CDC* pDC, CRect& rcEvent, CRect& rcText, int nViewDayIndex)
{
	...
	if (pDC->GetSafeHdc() && pViewPart && pViewEvent && pViewEvent->GetEvent())
	{
		...
		if (!bMultiDay)
		{
			...
			pDC->DrawText(strEvent, &rcText, DT_LEFT | DT_VCENTER | DT_SINGLELINE | DT_END_ELLIPSIS);
		}
		else
		{
			CFont fontBold;
...
void CXTPCalendarOffice2013Theme::PartDraw(CWeekViewEventPart* pViewPart, CDC* pDC, CXTPCalendarWeekViewEvent* pViewEvent)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
	...
	if (pDC->GetSafeHdc() && pViewPart && pViewEvent && pViewEvent->GetEvent())
	{
		...
		rcEvent.DeflateRect(XTP_DPI_X(m_nPadding) + XTP_DPI_X(1), 0, XTP_DPI_X(m_nPadding) + XTP_DPI_X(1), 0);
...
void CXTPCalendarOffice2013Theme::PartDrawGrid(CMonthViewGridPart* pViewPart, CDC* pDC, CXTPCalendarMonthView* pMonthView)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pMonthView);
	...
	if (pDC->GetSafeHdc() && pViewPart && pMonthView && pMonthView->GetGrid() && pMonthView->GetCalendarControl())
	{
		...
		for (int nWeek = 0; nWeek < nWeeksCount; nWeek++)
		{
			for (int nDayIdx = 0; nDayIdx < 7; nDayIdx++)
			{
				...
				{
					pDC->FillSolidRect(rcB.left, rcB.bottom, rcB.Width(), XTP_DPI_Y(1), clrGridLine);
				}
...
void CXTPCalendarOffice2013Theme::PartDraw(CMonthViewHeaderPart* pViewPart, CDC* pDC, CXTPCalendarMonthView* pMonthView, CRect rc, int nCollIndex, CString strText)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pMonthView);
...
void CXTPCalendarOffice2013Theme::PartDrawEvent(CMonthViewEventPart* pViewPart, CDC* pDC, CXTPCalendarMonthViewEvent* pViewEvent)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewEvent);
...
void CXTPCalendarOffice2013Theme::PartDrawDayDate(CMonthViewEventPart* pViewPart, CDC* pDC, CRect rc, BOOL bToday, BOOL bSelected, BOOL bFirstMonthDay, CString strText)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
...
void CXTPCalendarOffice2013Theme::PartAdjustTimeFont(CDayViewTimeScaleCellPart* pViewPart, CDC* pDC, CRect rcCell)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	...
	if (pDC->GetSafeHdc() && pViewPart)
	{
		...
		if (rcCell.Height() > XTP_DPI_Y(10))
			rcCell.DeflateRect(0, rcCell.Height()/2 - XTP_DPI_Y(2), 0, 0); // this will make the font smaller as required in Outlook 2013
