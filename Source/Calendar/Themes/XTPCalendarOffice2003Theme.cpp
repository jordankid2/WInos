...
void CXTPCalendarOffice2003Theme::PartDraw(CDayViewCellPart* pViewPart, CDC* pDC, CXTPCalendarDayViewGroup* pViewGroup, CRect rc, const XTP_CALENDAR_DAYVIEWCELL_PARAMS& cellParams)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
	ASSERT(pViewGroup);
...
void CXTPCalendarOffice2003Theme::PartDrawDayHeader(CWeekViewPart* pViewPart, CDC* pDC, CRect rcDay, int nHeaderHeight, CString strHeader, BOOL bIsCurrent, BOOL bIsSelected)
{
	ASSERT(pDC);
	ASSERT(pViewPart);
...
void CXTPCalendarOffice2003Theme::PartDrawDayDate(CMonthViewEventPart* pViewPart, CDC* pDC, CRect rc, BOOL bToday, BOOL bSelected, BOOL bFirstMonthDay, CString strText)
{
