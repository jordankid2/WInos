...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntStandardValue, m_xtpFontStandardValue, GetStandardFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fntCustomValue, m_xtpFontCustomValue, GetCustomFontHandle);
};
...
public:
	...
	//-----------------------------------------------------------------------
	void DrawText(CDC* pDC, const CString& str, LPRECT lpRect, UINT nFormat, COLORREF clrText = COLORREF_NULL, CFont* pFont = NULL);
