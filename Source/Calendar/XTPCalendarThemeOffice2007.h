// XTPCalendarThemeOffice2007.h: interface for the CXTPCalendarPaintManager class.
//
...
public:
	...
	static int AFX_CDECL DrawClock(CDC* pDC, COleDateTime dtClockTime, CRect rcView, COLORREF clrBackground, XTPCalendarClockAlignFlags cafAlign);
	//-----------------------------------------------------------------------
	// Summary:
