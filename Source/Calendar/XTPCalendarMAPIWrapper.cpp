...
HRESULT CXTPCalendarMAPIWrapper::MAPILogonEx(ULONG ulUIParam, LPTSTR lpszProfileName, 
...
HRESULT CXTPCalendarMAPIWrapper::HrQueryAllRows(LPMAPITABLE ptable, 
...
HRESULT CXTPCalendarMAPIWrapper::HrGetOneProp(LPMAPIPROP pmp, 
	ULONG ulPropTag, LPSPropValue FAR * ppprop)
{
...
HRESULT CXTPCalendarMAPIWrapper::HrSetOneProp(LPMAPIPROP pmp, 
											  LPSPropValue pprop)
{
...
HRESULT CXTPCalendarMAPIWrapper::HrThisThreadAdviseSink(
...
HRESULT CXTPCalendarMAPIWrapper::HrAllocAdviseSink(
