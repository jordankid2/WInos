...
public:
	...
	static BOOL m_bAutoScaleDpi; // TRUE by default. Enables scalling of ribbon gallery items (both inline and displayed in popup)
...
public:
	...
	virtual void DrawItem(CDC* pDC, CRect rcItem, BOOL bEnabled, BOOL bSelected, BOOL bPressed, BOOL bChecked, CXTPControlGalleryItem* pGalleryItem, CXTPControlGallery* pGallery);

	virtual void DrawItemBack(CDC* pDC, CRect rcItem, BOOL bEnabled, BOOL bSelected, BOOL bPressed, BOOL bChecked, XTPBarType barType);

	virtual COLORREF GetItemTextColor(BOOL bEnabled, BOOL bSelected, BOOL bPressed, BOOL bChecked, XTPBarType barType);
