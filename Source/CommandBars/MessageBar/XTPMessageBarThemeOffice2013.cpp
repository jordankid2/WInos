...
void CXTPMessageBarThemeOffice2013::RefreshMetrics()
{
	...
	m_clrText              .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("Text"),               RGB(119,119,119)));
	m_clrTextHilite        .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("TextHilite"),         RGB( 68, 68, 68)));
	m_clrBack              .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("Back"),               RGB(252,247,182)));
	m_clrBorder	           .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("Border"),             RGB(215,216,137)));
	m_clrButtonBack        .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBack"),         RGB(253,253,253)));
	m_clrButtonBackHilite  .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBackHilite"),   RGB(240,240,240)));
	m_clrButtonBackPushed  .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBackPushed"),   RGB(198,198,198)));
	m_clrButtonBorder      .SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBorder"),       RGB(171,171,171)));
	m_clrButtonBorderHilite.SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBorderHilite"), RGB(198,198,198)));
	m_clrButtonBorderPushed.SetStandardValue(XTPIniColor(_T("CommandBars.MessageBar"), _T("ButtonBorderPushed"), RGB(171,171,171)));
}
