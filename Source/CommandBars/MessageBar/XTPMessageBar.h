...
public:
	...
	//-----------------------------------------------------------------------
	// Summary: This member function obtains the height of the message bar.
	//          If custom value has been previously set by SetHeight that value
	//          is returned, otherwise it return paint manager specific value.
	// ----------------------------------------------------------------------
	int GetHeight() const;

	//-----------------------------------------------------------------------
	// Summary: This member function sets the custom height of the message bar.
...
protected:
	int m_nCustomHeight;                // Custom height value. If 0, height value provided be paint manager is used.
