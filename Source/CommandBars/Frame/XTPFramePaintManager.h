...
public:
	...
	// Returns:
	//     Returns either a valid frame shadow pointer created by XTPFrameShadowManager()->EnableShadow
	//     or NULL if frame has no shadow.
	...
	//-----------------------------------------------------------------------
	virtual void OnShadowedFrameActiveStateChanged(
		BOOL bActive,
		CWnd* pFrame,
