// XTPCustomizePageToolbars.h : interface for the CXTPCustomizeToolbarsPage class.
//
...
//{{AFX_CODEJOCK_PRIVATE
class _XTP_EXT_CLASS CXTPCustomizeToolbarsPageCheckListBox : public CCheckListBox
{
public:
