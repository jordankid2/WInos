...
{
	m_clrBorder.SetStandardValue(XTPIniColor(_T("CommandBars.ProgressBar"), _T("Border"), RGB(188,188,188)));
	m_clrBar   .SetStandardValue(XTPIniColor(_T("CommandBars.ProgressBar"), _T("Bar"),    RGB(  6,176, 37)));
	m_clrBack  .SetStandardValue(XTPIniColor(_T("CommandBars.ProgressBar"), _T("Back"),   RGB(230,230,230)));
}
