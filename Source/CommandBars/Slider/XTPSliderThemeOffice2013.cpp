...
void CXTPSliderThemeOffice2013::RefreshMetrics()
{
	...
	m_clrSlider   .SetStandardValue(XTPIniColor(_T("CommandBars.Slider"), _T("Slider"),    RGB(171, 171, 171)));
	m_clrScrollBar.SetStandardValue(XTPIniColor(_T("CommandBars.Slider"), _T("ScrollBar"), RGB(255, 255, 255)));
	m_clrHighlight.SetStandardValue(XTPIniColor(_T("CommandBars.Slider"), _T("Highlight"), RGB( 62, 109, 181)));
}
