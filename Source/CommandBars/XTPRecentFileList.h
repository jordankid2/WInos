...
{
	DECLARE_DYNAMIC(CXTPRecentFileListItem);
...
{
	DECLARE_DYNAMIC(CXTPRecentFileList)
...
public:
	...
	//     lpszAppID - Specifies Application User Model ID for the application.
	//-----------------------------------------------------------------------
	virtual void Add(LPCTSTR lpszPathName);

	using CRecentFileList::Add;
