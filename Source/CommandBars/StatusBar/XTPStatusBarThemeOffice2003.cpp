...
void CXTPStatusBarThemeOffice2003::RefreshMetrics()
{
	...
	m_clrBackground = XTPColorManager()->LightColor(::GetXtremeColor(COLOR_3DFACE), ::GetXtremeColor(COLOR_WINDOW), 70);
	...
	case xtpSystemThemeAero:
		m_clrBackground = RGB(211, 211, 211);
		break;
	case xtpSystemThemeSilver:
		m_clrBackground = RGB(236, 234, 218);
		break;
