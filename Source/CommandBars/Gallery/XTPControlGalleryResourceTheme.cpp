// XTPControlGalleryResourceTheme.cpp : implementation of the CXTPControlGalleryResourceTheme class.
//
...
void CXTPControlGalleryResourceTheme::RefreshMetrics()
{
	...
	m_cyPopupUp = XTP_DPI_Y(21);
	m_cyPopupDown = XTP_DPI_Y(19);
...
void CXTPControlGalleryResourceTheme::DrawPopupScrollBar(CDC* pDC, CXTPControlGallery* pGallery)
{
	...
	CRect rcScroll(rcControl.right - XTP_DPI_X(15), rcControl.top, rcControl.right, rcControl.bottom);
