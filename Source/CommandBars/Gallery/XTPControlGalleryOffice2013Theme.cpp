...
void CXTPControlGalleryOffice2013Theme::RefreshMetrics()
{
	...
	m_clrScrollTriangle         = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollTriangle"),          RGB(119,119,119));
	m_clrScrollTriangleHot      = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollTriangleHighlight"), RGB(68,68,68));
	m_clrScrollTrianglePressed  = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollTrianglePushed"),    RGB(0,0,0));
	m_clrScrollTriangleDisabled = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollTriangleDisabled"),  RGB(198,198,198));
	m_clrScrollBorderNormal     = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollBorder"),            RGB(171,171,171));
	m_clrScrollBorderHot        = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollBorderHighlight"),   RGB(163,189,227));
	m_clrScrollBorderDisabled   = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollBorderDisabled"),    RGB(225,225,225));
	m_clrScrollFillHot          = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollBackHighlight"),     RGB(213,225,242));
	m_clrScrollFillPressed      = XTPIniColor(_T("CommandBars.Gallery"), _T("ScrollBackPushed"),        RGB(163,189,227));
}
...
void CXTPControlGalleryOffice2013Theme::DrawScrollButton(CDC* pDC, const CRect &rc, int type, CXTPControlGallery* pGallery)
{
	...
	COLORREF clrBorder = (bPartSelected || bPartPressed) ? m_clrScrollBorderHot: m_clrScrollBorderNormal;
	...
	COLORREF clrTriangle = bPartSelected ? m_clrScrollTriangleHot: bPartPressed ? m_clrScrollTrianglePressed: bPartEnabled ? m_clrScrollTriangle: m_clrScrollTriangleDisabled;
	...
	switch (type)
	{
		...
		{
			XTPDrawHelpers()->SolidRectangle(pDC, CRect(
				CPoint(pt.x - n3x, pt.y - n2y),
...
void CXTPControlGalleryOffice2013Theme::FillControl(CDC* pDC, CXTPControlGallery* pGallery, CRect rcControl)
{
