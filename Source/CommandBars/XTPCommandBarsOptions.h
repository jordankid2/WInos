...
#if !defined(__XTPCOMMANDBARSOPTIONS_H__)
#define __XTPCOMMANDBARSOPTIONS_H__
//}}AFX_CODEJOCK_PRIVATE
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Overrides default DPI scalling settings for command bar components.
	// Parameters:
	//      bScaleGalleryItems - TRUE to enable gallery items scaling (default), or FALSE to disable.
	//      bScaleToolbarIcons - TRUE to enable toolbar icon scaling (default), or FALSE to disable.
	// See also:
	//      GetGalleryItemsScalling, GetToolbarsIconsScalling
	//-----------------------------------------------------------------------
	void SetDPIScallingOptions(BOOL bScaleGalleryItems, BOOL bScaleToolbarIcons = TRUE);

	//-----------------------------------------------------------------------
	// Summary:
	//      Obtains current state of gallery item DPI scaling flag, which is TRUE by default.
	// Returns:
	//      Current gallery item DPI scaling flag value.
	// See also:
	//      GetToolbarsIconsScalling, SetDPIScallingOptions
	//-----------------------------------------------------------------------
	BOOL GetGalleryItemsScalling() const;

	//-----------------------------------------------------------------------
	// Summary:
	//      Obtains current state of toolbar icon DPI scaling flag, which is TRUE by default.
	// Returns:
	//      Current toolbar icon DPI scaling flag value.
	// See also:
	//      GetGalleryItemsScalling, SetDPIScallingOptions
	//-----------------------------------------------------------------------
...
public:
	...
	afx_msg int  OleGetIconWidth(BOOL bLargeIcons);
	afx_msg int  OleGetIconHeight(BOOL bLargeIcons);
	afx_msg void OleSetPopupIconSize(long cx, long cy);
	afx_msg int  OleGetPopupIconWidth();
	afx_msg int  OleGetPopupIconHeight();
	...
	afx_msg BOOL OleIsDPIScallingEnabled();
	afx_msg COLORREF OleGetVSStateColor();
	afx_msg void OleSetVSStateColor(COLORREF clr);
...
#endif // !defined(__XTPCOMMANDBARSOPTIONS_H__)
