// XTPCommandBarsVisualStudio2008Theme.h
//
...
#if !defined(__XTPCOMMANDBARSVISUALSTUDIO2008THEME_H__)
#define __XTPCOMMANDBARSVISUALSTUDIO2008THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
public:
	...
	virtual void DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected, BOOL bPressed, BOOL bEnabled, BOOL bChecked, BOOL bPopuped, XTPBarType barType, XTPBarPosition barPosition, int nID); // <combine CXTPVisualStudio2008Theme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL @BOOL@XTPBarType@XTPBarPosition>
...
#endif // !defined(__XTPCOMMANDBARSVISUALSTUDIO2008THEME_H__)
