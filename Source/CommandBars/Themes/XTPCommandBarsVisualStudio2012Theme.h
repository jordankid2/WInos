...
public:
	...
	virtual void DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected, BOOL bPressed, BOOL bEnabled, BOOL bChecked, BOOL bPopuped, XTPBarType barType, XTPBarPosition barPosition, int nID); // <combine CXTPCommandBarsVisualStudio2012Theme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL @BOOL@XTPBarType@XTPBarPosition>
	...
	virtual void DrawExpandGlyph(CDC* pDC, CXTPControl* pButton, COLORREF clr, BOOL bVertical); // <combine CXTPCommandBarsVisualStudio2012Theme::DrawExpandGlyph@CDC*@CXTPControl*@CPoint@CPoint@CPoint@COLORREF>
	virtual void DrawHiddenGlyph(CDC* pDC, CXTPControl* pButton, COLORREF clr, BOOL bVertical); // <combine CXTPCommandBarsVisualStudio2012Theme::DrawExpandGlyph@CDC*@CXTPControl*@CPoint@CPoint@CPoint@COLORREF>
...
protected:
	...
	static void AFX_CDECL FillRect(CDC* pDC, CRect rc, BOOL bCheckMark, COLORREF clrFore, COLORREF clrBack);
