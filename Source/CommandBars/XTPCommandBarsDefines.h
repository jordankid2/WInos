...
//
// <KEYWORDS xtpThemeOfficeXP, xtpThemeOffice2000, xtpThemeOffice2003, xtpThemeNativeWinXP, xtpThemeVisualStudio2005, xtpThemeCustom>
//-----------------------------------------------------------------------
enum XTPPaintTheme
{
...
//
// <KEYWORDS xtpFlagAlignTop, xtpFlagAlignBottom, xtpFlagAlignLeft, xtpFlagAlignRight, xtpFlagAlignAny, xtpFlagFloating, xtpFlagHideWrap, xtpFlagStretched, xtpFlagNoBorders, xtpFlagStretchedShared, xtpFlagSmartLayout>
//-----------------------------------------------------------------------
enum XTPToolBarFlags
{
	...
	xtpFlagNoBorders       = 0x000080,  // Bar has no borders, this will cause CXTPPaintManager::IsFlatToolBar() to return TRUE.
