...
BOOL AFX_CDECL XTPHeapSetCompatibilityInformation(HANDLE hHeapHandle, PVOID pHeapInformation, ULONG_PTR nHeapInformationLength)
{
#ifdef _WIN32_WCE
	...
	if (NULL != hKernel)
	{
		PFNHEAPSETINFORMATION pfHeapSetInformation = XTPToFunctionPtr<PFNHEAPSETINFORMATION>(::GetProcAddress(hKernel, "HeapSetInformation"));
