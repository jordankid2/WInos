...
//-----------------------------------------------------------------------
// Summary:
//    Used by paint manager to retreive color settings from the loaded
//    resource INI file.
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// Summary:
//    Used by paint manager to retreive the curren state color settings 
...
//===========================================================================
// Summary:
//     The CXTPScrollBarThemeOffice2013 class is used to enable a Gallery Office 2013 style theme for Command Bars.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//    Destructor, handles any clean up / deallocation necessary.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	virtual void GetScrollBarColors(XTP_SCROLLBARDRAWCOLORS& sbc, int nHitSelected, int nHitPressed, BOOL bEnabled);
