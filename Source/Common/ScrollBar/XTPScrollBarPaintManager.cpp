...
void CXTPScrollBarPaintManager::DrawArrowGlyph(CDC *pDC, CRect rcArrow, XTPArrowGlyph glyph, BOOL bEnabled, COLORREF clrText)
{
	...
	if (XTP_DPI_Y(6) <= nHeight)
	{
		...
		switch (glyph)
		{
		case xtpArrowGlyphLeft:
			nSymbol = xtpPrimitiveSymbolPlayLeft;
			break;
		case xtpArrowGlyphRight:
			nSymbol = xtpPrimitiveSymbolPlayRight;
			break;
		case xtpArrowGlyphUp:
			nSymbol = xtpPrimitiveSymbolPlayUp;
			break;
		case xtpArrowGlyphDown:
			nSymbol = xtpPrimitiveSymbolPlayDown;
			break;
		}
...
void CXTPScrollBarPaintManager::DrawBackground(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsV* pMetrics)
{
...
void CXTPScrollBarPaintManager::DrawButtons(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsV* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawArrows(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsV* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawTracker(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsV* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawThumbButton(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsV* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawBackground(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsH* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawButtons(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsH* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawArrows(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsH* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawTracker(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsH* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
...
void CXTPScrollBarPaintManager::DrawThumbButton(CDC *pDC, CXTPScrollBase *pScroll, XTPScrollMetricsH* pMetrics)
{
	UNREFERENCED_PARAMETER(pDC);
	UNREFERENCED_PARAMETER(pScroll);
	UNREFERENCED_PARAMETER(pMetrics);
