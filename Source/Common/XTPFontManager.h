...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontItalic, m_xtpFontItalic, GetItalicFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontItalicBold, m_xtpFontItalicBold, GetItalicBoldFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontVertical, m_xtpFontVertical, GetVerticalFontHandle);
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED(CFont, m_fontVerticalBold, m_xtpFontVerticalBold, GetVerticalBoldFontHandle);
};
