...
//         each other.
//-----------------------------------------------------------------
#if (defined(SCHEMA_STRINGS)) || (!defined(TMSCHEMA_H) && !defined(__VSSYM32_H__))
//-----------------------------------------------------------------
#define TMSCHEMA_H
//-----------------------------------------------------------------
#include "SchemaDef.h"
...
BEGIN_TM_CLASS_PARTS(MENU)
	...
	TM_PART(7, MP, BARBACKGROUND)
	TM_PART(8, MP, BARITEM)
	TM_PART(9, MP, POPUPBACKGROUND)
	TM_PART(10, MP, POPUPBORDERS)
	TM_PART(11, MP, POPUPCHECK)
	TM_PART(12, MP, POPUPCHECKBACKGROUND)
	TM_PART(13, MP, POPUPGUTTER)
	TM_PART(14, MP, POPUPITEM)
	TM_PART(15, MP, POPUPSEPARATOR)
	TM_PART(16, MP, POPUPSUBMENU)
	TM_PART(17, MP, SYSTEMCLOSE)
	TM_PART(18, MP, SYSTEMMAXIMIZE)
	TM_PART(19, MP, SYSTEMMINIMIZE)
	TM_PART(20, MP, SYSTEMRESTORE)
END_TM_CLASS_PARTS()
...
BEGIN_TM_PART_STATES(BARBACKGROUND)
	TM_STATE(1, MB, ACTIVE)
	TM_STATE(2, MB, INACTIVE)
END_TM_PART_STATES()


BEGIN_TM_PART_STATES(POPUPCHECK)
	TM_STATE(1, MC, CHECKMARKNORMAL)
	TM_STATE(2, MC, CHECKMARKDISABLED)
	TM_STATE(3, MC, BULLETNORMAL)
	TM_STATE(4, MC, BULLETDISABLED)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(POPUPCHECKBACKGROUND)
	TM_STATE(1, MCB, DISABLED)
	TM_STATE(2, MCB, NORMAL)
	TM_STATE(3, MCB, BITMAP)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(POPUPITEM)
	TM_STATE(1, MPI, NORMAL)
	TM_STATE(2, MPI, HOT)
	TM_STATE(3, MPI, DISABLED)
	TM_STATE(4, MPI, DISABLEDHOT)
END_TM_PART_STATES()


BEGIN_TM_PART_STATES(POPUPSUBMENU)
	TM_STATE(1, MSM, NORMAL)
	TM_STATE(2, MSM, DISABLED)
END_TM_PART_STATES()
