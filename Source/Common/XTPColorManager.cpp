...
//#define UNIQUEVALUE "8C4C8-49910-D8DFC-10000-72CB5"
...
{
	if (nIndex > XPCOLOR_LAST) return static_cast<COLORREF>(nIndex);
...
BEGIN_DISPATCH_MAP(CXTPColorManager, CXTPCmdTarget)
	...
	DISP_FUNCTION_ID(CXTPColorManager, "GetCurrentSystemTheme", 2, GetCurrentSystemTheme, VT_I4, VTS_NONE)
	DISP_PROPERTY_NOTIFY_ID(CXTPColorManager, "SystemTheme", 3, m_systemTheme, OleRefreshColors, VT_I4)
	DISP_PROPERTY_NOTIFY_ID(CXTPColorManager, "EnableLunaBlueForRoyaleTheme", 4, m_bEnableLunaBlueForRoyaleTheme, OleRefreshColors, VT_BOOL)
END_DISPATCH_MAP()
