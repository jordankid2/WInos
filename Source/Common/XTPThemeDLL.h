...
private:
	...
	//-----------------------------------------------------------------------
	// Summary:  Internal function used to load Codejock theme DLLs.
	// Input:    hModule     - Reference to CXTPModuleHandle object containing the 
	//                         handle of the loaded theme DLL.
	//           lpszDLLPath - Path where theme DLLs are located.
	//           lpszDllName - Name of the theme DLL to load.
	// Returns:  TRUE if the theme DLL was successfull loaded, otherwise FALSE.
	//-----------------------------------------------------------------------
