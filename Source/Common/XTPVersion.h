...
#define _XTPLIB_VERSION_                    MAKELONG(5, 18)

// Xtreme Toolkit Pro Major version number
#define _XTPLIB_VERSION_MAJOR               18

// Xtreme Toolkit Pro Minor version number
#define _XTPLIB_VERSION_MINOR               5
...
#define _XTPLIB_VERSION_PREFIX              1850
...
#define _XTP_COPYRIGHT_INFO _T("Copyright \xA9 1998-2018 Codejock Software")
