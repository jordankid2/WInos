...
AFX_INLINE CXTPTypeId::CXTPTypeId(DWORD_PTR id) : m_id(id) {
}

AFX_INLINE CXTPTypeId::CXTPTypeId(const CXTPTypeId& rhs) : m_id(rhs.m_id) {
}
...
protected:
	...
	struct DerivedList
	{
		DerivedList(CXTPTypeId derivedTypeId,
