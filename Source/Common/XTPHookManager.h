...
public:
	...
	//     nMessage - Specifies the message to be sent. For windows hooks it contains the hook code value.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called after a message has been processed by default window procedure.
	//     Never called for windows hooks.
	// Parameters:
	...
	//     OnHookMessage
	//-----------------------------------------------------------------------
	virtual int OnPostHookMessage(HWND hWnd, UINT nMessage, WPARAM& wParam, LPARAM& lParam, LRESULT& lResult);
