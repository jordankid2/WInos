...
public:
	...
	void DrawImage(CDC* pDC, const CRect& rcDest, CRect rcSrc, CRect rcSizingMargins); // <combine CXTPResourceImage::DrawImage@CDC*@const CRect&@CRect>
	void DrawImage(CDC* pDC, const CRect& rcDest, CRect rcSrc, const CRect& rcSizingMargins, COLORREF clrTransparent); // <combine CXTPResourceImage::DrawImage@CDC*@const CRect&@CRect>
	void DrawImage(CDC* pDC, const CRect& rcDest, CRect rcSrc, const CRect& rcSizingMargins, COLORREF clrTransparent, DWORD dwFlags); // <combine CXTPResourceImage::DrawImage@CDC*@const CRect&@CRect>
...
protected:
	...
	BOOL m_bImageOrientaionPreserved; // TRUE if image orientation is to be preserved for RTL or flipped drawing.
...
public:
	...
	BOOL SetHandle(HMODULE hResource, LPCTSTR lpszIniFileName = NULL, BOOL bFreeOnRelease = FALSE); // <combine CXTPResourceImages::SetHandle@LPCTSTR@LPCTSTR>
	BOOL SetHandle(HMODULE hResource, LPCTSTR lpszThemeFileName, LPCTSTR lpszAppFileName, BOOL bFreeOnRelease = FALSE); // <combine CXTPResourceImages::SetHandle@LPCTSTR@LPCTSTR>
...
protected:
	...
	BOOL m_bFreeOnRelease; // If TRUE, the module determined by m_hResource will be unloaded upon release.
...
// Office2016.dll
#define xtpIniOffice2016AccessBlack         _T("OFFICE2016ACCESSBLACK_INI")         // Specifies Office 2016 Access Black settings file.
#define xtpIniOffice2016AccessColorful      _T("OFFICE2016ACCESSCOLORFUL_INI")      // Specifies Office 2016 Access Colorful settings file.
#define xtpIniOffice2016AccessDarkGray      _T("OFFICE2016ACCESSDARKGRAY_INI")      // Specifies Office 2016 Access Dark Gray settings file. 
#define xtpIniOffice2016AccessWhite         _T("OFFICE2016ACCESSWHITE_INI")         // Specifies Office 2016 Access White settings file.
#define xtpIniOffice2016ExcelBlack          _T("OFFICE2016EXCELBLACK_INI")          // Specifies Office 2016 Excel Black settings file.
#define xtpIniOffice2016ExcelColorful       _T("OFFICE2016EXCELCOLORFUL_INI")       // Specifies Office 2016 Excel Colorful settings file.
#define xtpIniOffice2016ExcelDarkGray       _T("OFFICE2016EXCELDARKGRAY_INI")       // Specifies Office 2016 Excel Dark Gray settings file. 
#define xtpIniOffice2016ExcelWhite          _T("OFFICE2016EXCELWHITE_INI")          // Specifies Office 2016 Excel White settings file.
#define xtpIniOffice2016OneNoteBlack        _T("OFFICE2016ONENOTEBLACK_INI")        // Specifies Office 2016 OneNote Black settings file.
#define xtpIniOffice2016OneNoteColorful     _T("OFFICE2016ONENOTECOLORFUL_INI")     // Specifies Office 2016 OneNote Colorful settings file.
#define xtpIniOffice2016OneNoteDarkGray     _T("OFFICE2016ONENOTEDARKGRAY_INI")     // Specifies Office 2016 OneNote Dark Gray settings file. 
#define xtpIniOffice2016OneNoteWhite        _T("OFFICE2016ONENOTEWHITE_INI")        // Specifies Office 2016 OneNote White settings file.
#define xtpIniOffice2016OutlookBlack        _T("OFFICE2016OUTLOOKBLACK_INI")        // Specifies Office 2016 Outlook Black settings file.
#define xtpIniOffice2016OutlookColorful     _T("OFFICE2016OUTLOOKCOLORFUL_INI")     // Specifies Office 2016 Outlook Colorful settings file.
#define xtpIniOffice2016OutlookDarkGray     _T("OFFICE2016OUTLOOKDARKGRAY_INI")     // Specifies Office 2016 Outlook Dark Gray settings file. 
#define xtpIniOffice2016OutlookWhite        _T("OFFICE2016OUTLOOKWHITE_INI")        // Specifies Office 2016 Outlook White settings file.
#define xtpIniOffice2016PublisherBlack      _T("OFFICE2016PUBLISHERBLACK_INI")      // Specifies Office 2016 Publisher Black settings file.
#define xtpIniOffice2016PublisherColorful   _T("OFFICE2016PUBLISHERCOLORFUL_INI")   // Specifies Office 2016 Publisher Colorful settings file.
#define xtpIniOffice2016PublisherDarkGray   _T("OFFICE2016PUBLISHERDARKGRAY_INI")   // Specifies Office 2016 Publisher Dark Gray settings file. 
#define xtpIniOffice2016PublisherWhite      _T("OFFICE2016PUBLISHERWHITE_INI")      // Specifies Office 2016 Publisher White settings file.
#define xtpIniOffice2016PowerPointBlack     _T("OFFICE2016POWERPOINTBLACK_INI")     // Specifies Office 2016 PowerPoint Black settings file.
#define xtpIniOffice2016PowerPointColorful  _T("OFFICE2016POWERPOINTCOLORFUL_INI")  // Specifies Office 2016 PowerPoint Colorful settings file.
#define xtpIniOffice2016PowerPointDarkGray  _T("OFFICE2016POWERPOINTDARKGRAY_INI")  // Specifies Office 2016 PowerPoint Dark Gray settings file. 
#define xtpIniOffice2016PowerPointWhite     _T("OFFICE2016POWERPOINTWHITE_INI")     // Specifies Office 2016 PowerPoint White settings file.
#define xtpIniOffice2016WordBlack           _T("OFFICE2016WORDBLACK_INI")           // Specifies Office 2016 Word Black settings file.
#define xtpIniOffice2016WordColorful        _T("OFFICE2016WORDCOLORFUL_INI")        // Specifies Office 2016 Word Colorful settings file.
#define xtpIniOffice2016WordDarkGray        _T("OFFICE2016WORDDARKGRAY_INI")        // Specifies Office 2016 Word Dark Gray settings file. 
#define xtpIniOffice2016WordWhite           _T("OFFICE2016WORDWHITE_INI")           // Specifies Office 2016 Word White settings file.
