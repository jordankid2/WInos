...
public:
	...
	//     TRUE if the operation succeed and FALSE if operation failed.
	//-----------------------------------------------------------------------
	static bool AFX_CDECL Intersect(CXTPRectT& c, const CXTPRectT& a, const CXTPRectT& b)
	{
	...
	//-----------------------------------------------------------------------
	static bool AFX_CDECL Union(CXTPRectT& c, const CXTPRectT& a, const CXTPRectT& b)
	{
