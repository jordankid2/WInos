// XTPEnableAdvancedWarnings.h: Enables/Disabled advanced MSVC compiler 
...
// Advanced warning control is required only for compilation with /Wall switch.
		...
		#define XTP_BETWEEN_XTPENABLEADVANCEDWARNINGS_H_INCLUSIONS
			...
			// C4251: 'identifier' : class 'user-defined type' needs to have dll - interface to be used by clients of class 'user-defined type'
			...
			// C4371: layout of class may have changed from a previous version of the compiler due to better packing of member 'member'
			...
			#define XTP_ADVANCED_WARNING_CONTROL(action) \
				__pragma(warning(action :\
				4615 4616 4710 4514 4275 4820 4625 4626 5026 5027 4251 4555 \
				4623 4571 4371 5039 4768))
			...
			#define XTP_ADVANCED_WARNING_CONTROL(action) \
			__pragma(warning(action :\
				4061 4062 4191 4201 4242 4254 4255 4263 4264 4265 4266 4287 4289 \
				4296 4302 4350 4365 4412 4431 4514 4536 4545 4546 4547 4548 4549 \
				4555 4557 4571 4619 4623 4625 4626 4628 4640 4641 4668 4686 4692 \
				4710 4711 4738 4820 4826 4836 4837 4905 4906 4917 4928 4931 4946 \
				4962 4987 5026 5027 4710 4471 4458 5039 4768))
