...
public:
	...
	CXTPImageManagerIconHandle(HICON hIcon, BOOL bUseResources = TRUE, BOOL bSharedHandle = TRUE); // <combine CXTPImageManagerIconHandle::CXTPImageManagerIconHandle>
	CXTPImageManagerIconHandle(HBITMAP hBitmap, BOOL bSharedHandle = TRUE); // <combine CXTPImageManagerIconHandle::CXTPImageManagerIconHandle>
...
public:
	...
	BOOL CreateIconFromResource(
		...
		CSize szIcon,
		BOOL bGroupResource,
		XTPIconSizeMatching nSizeMatching = xtpIconSizeExact); // <combine CXTPImageManagerIconHandle::CreateIconFromResource@LPCTSTR@CSize@BOOL>
...
//Call this member function to scale image with depends on DPI settings
