...
#if !defined(__XTPPROPEXCHANGEARCHIVE_H__)
...
//{{AFX_CODEJOCK_PRIVATE
	...
	{
	public:
		CSelfArchive(CFile* pFile, UINT nMode, int nBufSize = 4096, void* lpBuf = NULL);
...
#endif // !defined(__XTPPROPEXCHANGEARCHIVE_H__)
