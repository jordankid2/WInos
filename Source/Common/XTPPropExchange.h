...
public:
	static CRuntimeClass* AFX_CDECL FindRuntimeClass(LPCSTR szClassName);
//}}AFX_CODEJOCK_PRIVATE
...
//     The property's value is read from or written to the variable referenced by nValue, as appropriate. If nDefault is specified, it will be used as the property's default value. This value is used if, for any reason, the serialization process fails. DPI version of the function stores the value as DPI independed value.
// Parameters:
//     pPX - Pointer to the CXTPPropExchange object (typically passed as a parameter to DoPropExchange).
//     pszPropName - The name of the property being exchanged.
//     nValue - Reference to the variable where the property is stored (typically a member variable of your class).
...
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_X_Int(CXTPPropExchange* pPX, LPCTSTR pszPropName, int& nValue); // <COMBINE PX_Int>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_X_Int(CXTPPropExchange* pPX, LPCTSTR pszPropName, int& nValue, int nDefault); // <COMBINE PX_Int>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_Y_Int(CXTPPropExchange* pPX, LPCTSTR pszPropName, int& nValue); // <COMBINE PX_Int>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_Y_Int(CXTPPropExchange* pPX, LPCTSTR pszPropName, int& nValue, int nDefault); // <COMBINE PX_Int>
...
//     The property's value is read from or written to the variable referenced by szValue, as appropriate. If szDefault is specified, it will be used as the property's default value. This value is used if, for any reason, the serialization process fails. DPI version of the function stores the value as DPI independed value.
// Parameters:
//     pPX - Pointer to the CXTPPropExchange object (typically passed as a parameter to DoPropExchange).
//     pszPropName - The name of the property being exchanged.
...
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_Size(CXTPPropExchange* pPX, LPCTSTR pszPropName, SIZE& szValue, SIZE szDefault); // <COMBINE PX_Size>

//---------------------------------------------------------------------------
// Summary:
//     Call this function within your class's DoPropExchange member function to serialize or initialize a property of type RECT.
//     The property's value is read from or written to the variable referenced by rcValue, as appropriate. If rcDefault is specified, it will be used as the property's default value. This value is used if, for any reason, the serialization process fails. DPI version of the function stores the value as DPI independed value.
// Parameters:
//     pPX - Pointer to the CXTPPropExchange object (typically passed as a parameter to DoPropExchange).
//     pszPropName - The name of the property being exchanged.
...
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_Rect(CXTPPropExchange* pPX, LPCTSTR pszPropName, RECT& rcValue, RECT rcDefault); // <COMBINE PX_Rect>
...
//     The property's value is read from or written to the variable referenced by ptValue, as appropriate. If ptDefault is specified, it will be used as the property's default value. This value is used if, for any reason, the serialization process fails. DPI version of the function stores the value as DPI independed value.
// Parameters:
//     pPX - Pointer to the CXTPPropExchange object (typically passed as a parameter to DoPropExchange).
//     pszPropName - The name of the property being exchanged.
...
_XTP_EXT_CLASS BOOL AFX_CDECL PX_DPI_Point(CXTPPropExchange* pPX, LPCTSTR pszPropName, POINT& ptValue, POINT ptDefault); // <COMBINE PX_Point>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_Point(CXTPPropExchange* pPX, LPCTSTR pszPropName, CXTPPoint3T<float>& ptValue, CXTPPoint3T<float> ptDefault); // <COMBINE PX_Point>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_Point(CXTPPropExchange* pPX, LPCTSTR pszPropName, CXTPPoint3T<double>& ptValue, CXTPPoint3T<double> ptDefault); // <COMBINE PX_Point>
_XTP_EXT_CLASS BOOL AFX_CDECL PX_Point(CXTPPropExchange* pPX, LPCTSTR pszPropName, CXTPPoint3T<int>& ptValue, CXTPPoint3T<int> ptDefault); // <COMBINE PX_Point>
...
#ifdef _XTP_ACTIVEX
//{{AFX_CODEJOCK_PRIVATE
extern CXTPPropExchange* AFX_CDECL PropExchangeFromControl(LPDISPATCH lpDispatch);
//}}AFX_CODEJOCK_PRIVATE
#endif
