...
public:
	...
	//     dx - Offset of the x-axis of the second image in relationship to the first image, in pixels.
	//     dy - Offset of the y-axis of the second image in relationship to the first image, in pixels.
	// Returns:
	//     Nonzero if successful; otherwise 0.
	//-----------------------------------------------------------------------
	BOOL Create(CXTPImageList& imagelist1, int nImage1, CXTPImageList& imagelist2, int nImage2, int dx, int dy);
	...
	// Returns:
	//     If successful, a handle to the image list represented by the CXTPImageList object; otherwise NULL.
	//-----------------------------------------------------------------------
	...
	//     uFlags - The bit flag value that specifies the type of copy operation to be made.
	// Returns:
	//     Nonzero if successful; otherwise zero.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     iDst - The zero-based index of the image to be used as the destination of the copy operation.
	//     pSrc - A pointer to a CXTPImageList object that is the target of the copy operation.
	//     iSrc - The zero-based index of the image to be used as the source of the copy operation.
	//     uFlags - The bit flag value that specifies the type of copy operation to be made.
	// Returns:
	//     Nonzero if successful; otherwise zero.
	...
	// Parameters:
	//     pimldp - A pointer to an IMAGELISTDRAWPARAMS structure that contains information about the draw operation.
	// Returns:
	...
	//     ptHotSpot - Coordinates of the starting drag position (typically, the cursor position). The coordinates are relative to the upper left corner of the image.
	// Returns:
	//     Nonzero if successful; otherwise 0.
	//-----------------------------------------------------------------------
	...
	const CImageList* GetNativeGdiObject() const;
