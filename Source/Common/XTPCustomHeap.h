...
//===========================================================================
_XTP_EXT_CLASS BOOL AFX_CDECL XTPHeapSetCompatibilityInformation(HANDLE hHeapHandle, 
	PVOID pHeapInformation, ULONG_PTR nHeapInformationLength);
...
//===========================================================================
_XTP_EXT_CLASS BOOL AFX_CDECL XTPHeapSetLowFragmentation(HANDLE hHeapHandle);
...
struct XTP_BATCHALLOC_OBJ_HEADER
{
	...
	static XTP_BATCHALLOC_OBJ_HEADER* AFX_CDECL GetHeader(void* pData)
	{
