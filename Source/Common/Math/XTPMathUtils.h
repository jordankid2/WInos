...
public:
	...
	//-----------------------------------------------------------------------
	static void AFX_CDECL ComputeTriangleNormal(
		double x1, double y1, double z1,
		double x2, double y2, double z2, 
		double x3, double y3, double z4,
	...
	//-----------------------------------------------------------------------
	static double AFX_CDECL GetSegmentLength(
		double x1, double y1,
		double x2, double y2);
	...
	//-----------------------------------------------------------------------
	static BOOL AFX_CDECL HitTestLineSegment(
		double x1, double y1,
		double x2, double y2,
	...
	//-----------------------------------------------------------------------
	static BOOL AFX_CDECL GetLinesIntersection(
	...
	//-----------------------------------------------------------------------
	static void AFX_CDECL ComputeVectorCrossProduct(
		double x1, double y1, double z1,
		double x2, double y2, double z2,
	...
	//-----------------------------------------------------------------------
	static double AFX_CDECL ComputeVectorDotProduct(
		double x1, double y1, double z1,
		double x2, double y2, double z2);
