...
///////////////////////////////////////////////////////////////////////////////
//
bool MovieMaker::Init(const TCHAR* newFileName, uint newWidth, uint newHeight, uint frameRate, const vector<string>& codecs, WORD TbiBitCount)
{
	biBitCount = TbiBitCount;
	//Test if init
	if (initSuccess)
	{
	...
	bitmapInfo.biBitCount = biBitCount;
