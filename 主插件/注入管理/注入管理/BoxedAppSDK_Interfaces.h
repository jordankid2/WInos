 ...
 */
/* Compiler settings for v:\builds\BoxedApp\files\3D9C2F7C\trunk\src\BoxedApp\src\BoxedAppSDK\BoxedAppSDK_Interfaces.idl:
...
/* interface __MIDL_itf_BoxedAppSDK_Interfaces_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_BoxedAppSDK_Interfaces_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_BoxedAppSDK_Interfaces_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IBxVirtualEnvironment;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE AddLayerEx( 
            /* [in] */ IUnknown *layer,
            /* [in] */ BxEnumApiLayerFlags flags) = 0;
    ...
    typedef struct IBxVirtualEnvironmentVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *AddLayerEx )( 
            IBxVirtualEnvironment * This,
            /* [in] */ IUnknown *layer,
            /* [in] */ BxEnumApiLayerFlags flags);
...
#define IBxVirtualEnvironment_AddLayerEx(This,layer,flags)	\
    (This)->lpVtbl -> AddLayerEx(This,layer,flags)
...
HRESULT STDMETHODCALLTYPE IBxVirtualEnvironment_AddLayer_Proxy( 
    IBxVirtualEnvironment * This,
    /* [in] */ IUnknown *layer);


void __RPC_STUB IBxVirtualEnvironment_AddLayer_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxVirtualEnvironment_AddLayerEx_Proxy( 
    IBxVirtualEnvironment * This,
    /* [in] */ IUnknown *layer,
    /* [in] */ BxEnumApiLayerFlags flags);


void __RPC_STUB IBxVirtualEnvironment_AddLayerEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxVirtualEnvironment_AddReadonlyLayer_Proxy( 
    IBxVirtualEnvironment * This,
    /* [in] */ IUnknown *readonlyLayer,
    /* [in] */ IUnknown *writableLayer);


void __RPC_STUB IBxVirtualEnvironment_AddReadonlyLayer_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxVirtualEnvironment_Start_Proxy( 
    IBxVirtualEnvironment * This);


void __RPC_STUB IBxVirtualEnvironment_Start_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxConfiguration_put_Isolation_Proxy( 
    IBxFileSandboxConfiguration * This,
    /* [in] */ LPCWSTR path,
    /* [in] */ BxIsolationMode isolationMode);


void __RPC_STUB IBxFileSandboxConfiguration_put_Isolation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxConfiguration_get_Isolation_Proxy( 
    IBxFileSandboxConfiguration * This,
    /* [in] */ LPCWSTR path,
    /* [retval][out] */ BxIsolationMode *isolationModePtr);


void __RPC_STUB IBxFileSandboxConfiguration_get_Isolation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxConfiguration_LoadFromFile_Proxy( 
    IBxFileSandboxConfiguration * This,
    /* [in] */ LPCWSTR path);


void __RPC_STUB IBxFileSandboxConfiguration_LoadFromFile_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxConfiguration_SaveToFile_Proxy( 
    IBxFileSandboxConfiguration * This,
    /* [in] */ LPCWSTR path);


void __RPC_STUB IBxFileSandboxConfiguration_SaveToFile_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryName_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BxEnumPredefinedDirectory dir_id,
    /* [retval][out] */ BSTR *pbstrName);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryName_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryId_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR bstrName,
    /* [retval][out] */ BxEnumPredefinedDirectory *pId);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryId_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryPathById_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BxEnumPredefinedDirectory dir_id,
    /* [retval][out] */ BSTR *pbstrPath);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryPathById_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryPathByName_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR bstrName,
    /* [retval][out] */ BSTR *pbstrPath);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPredefinedDirectoryPathByName_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPathVariabledForm_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR bstrPath,
    /* [retval][out] */ BSTR *pbstrVariabledForm);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPathVariabledForm_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetPathVariabledFormEx_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR bstrPath,
    /* [in] */ WCHAR chLeftBracket,
    /* [in] */ WCHAR chRightBracket,
...
void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetPathVariabledFormEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_ParsePath_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR bstrPath,
    /* [out] */ BSTR *bstrPredefinedDirectoryName,
    /* [out] */ BSTR *pbstrRelativePath);
...
void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_ParsePath_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxPredefinedDirectoriesInfoProvider_GetVariabledForm_Proxy( 
    IBxPredefinedDirectoriesInfoProvider * This,
    /* [in] */ BSTR str,
    /* [retval][out] */ BSTR *pbstrVariabledForm);


void __RPC_STUB IBxPredefinedDirectoriesInfoProvider_GetVariabledForm_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxMetaInformation_get_Base_Proxy( 
    IBxFileSandboxMetaInformation * This,
    /* [retval][out] */ BSTR *basePath);


void __RPC_STUB IBxFileSandboxMetaInformation_get_Base_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxMetaInformation_put_Deleted_Proxy( 
    IBxFileSandboxMetaInformation * This,
    /* [in] */ LPCWSTR relativeSandboxPath,
    /* [in] */ BOOL isDeleted);


void __RPC_STUB IBxFileSandboxMetaInformation_put_Deleted_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxFileSandboxMetaInformation_get_Deleted_Proxy( 
    IBxFileSandboxMetaInformation * This,
    /* [in] */ LPCWSTR relativeSandboxPath,
    /* [retval][out] */ BOOL *isDeleted);


void __RPC_STUB IBxFileSandboxMetaInformation_get_Deleted_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxWriteCopyModeManager_EnableWriteCopyMode_Proxy( 
    IBxWriteCopyModeManager * This,
    /* [in] */ BxWriteCopyModeScope scope,
    /* [in] */ BOOL enable);


void __RPC_STUB IBxWriteCopyModeManager_EnableWriteCopyMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IBxWriteCopyModeManager_IsWriteCopyModeEnabled_Proxy( 
    IBxWriteCopyModeManager * This,
    /* [retval][out] */ BOOL *enabled);


void __RPC_STUB IBxWriteCopyModeManager_IsWriteCopyModeEnabled_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
